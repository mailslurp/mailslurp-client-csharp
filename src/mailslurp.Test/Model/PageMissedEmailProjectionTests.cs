...
namespace mailslurp.Test
{
    ...
    public class PageMissedEmailProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageMissedEmailProjection
            //Assert.IsInstanceOfType<PageMissedEmailProjection> (instance, "variable 'instance' is a PageMissedEmailProjection");
        }

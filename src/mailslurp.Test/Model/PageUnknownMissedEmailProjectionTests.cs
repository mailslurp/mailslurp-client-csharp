...
namespace mailslurp.Test
{
    ...
    public class PageUnknownMissedEmailProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageUnknownMissedEmailProjection
            //Assert.IsInstanceOfType<PageUnknownMissedEmailProjection> (instance, "variable 'instance' is a PageUnknownMissedEmailProjection");
        }

...
namespace mailslurp.Test
{
    ...
    public class ValidateEmailAddressListOptionsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" ValidateEmailAddressListOptions
            //Assert.IsInstanceOfType<ValidateEmailAddressListOptions> (instance, "variable 'instance' is a ValidateEmailAddressListOptions");
        }

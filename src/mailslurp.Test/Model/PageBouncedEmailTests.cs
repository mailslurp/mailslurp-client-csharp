...
namespace mailslurp.Test
{
    ...
    public class PageBouncedEmailTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageBouncedEmail
            //Assert.IsInstanceOfType<PageBouncedEmail> (instance, "variable 'instance' is a PageBouncedEmail");
        }

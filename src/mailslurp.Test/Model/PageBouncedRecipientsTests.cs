...
namespace mailslurp.Test
{
    ...
    public class PageBouncedRecipientsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageBouncedRecipients
            //Assert.IsInstanceOfType<PageBouncedRecipients> (instance, "variable 'instance' is a PageBouncedRecipients");
        }

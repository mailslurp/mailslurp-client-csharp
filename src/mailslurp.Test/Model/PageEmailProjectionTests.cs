...
namespace mailslurp.Test
{
    ...
    public class PageEmailProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageEmailProjection
            //Assert.IsInstanceOfType<PageEmailProjection> (instance, "variable 'instance' is a PageEmailProjection");
        }

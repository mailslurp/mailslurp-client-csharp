...
namespace mailslurp.Test
{
    ...
    public class WaitForSmsConditionsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" WaitForSmsConditions
            //Assert.IsInstanceOfType<WaitForSmsConditions> (instance, "variable 'instance' is a WaitForSmsConditions");
        }

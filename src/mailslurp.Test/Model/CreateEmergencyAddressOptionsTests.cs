...
namespace mailslurp.Test
{
    ...
    public class CreateEmergencyAddressOptionsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" CreateEmergencyAddressOptions
            //Assert.IsInstanceOfType<CreateEmergencyAddressOptions> (instance, "variable 'instance' is a CreateEmergencyAddressOptions");
        }

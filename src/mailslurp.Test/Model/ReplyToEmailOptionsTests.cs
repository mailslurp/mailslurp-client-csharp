...
namespace mailslurp.Test
{
    ...
    public class ReplyToEmailOptionsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" ReplyToEmailOptions
            //Assert.IsInstanceOfType<ReplyToEmailOptions> (instance, "variable 'instance' is a ReplyToEmailOptions");
        }

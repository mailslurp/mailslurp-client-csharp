...
namespace mailslurp.Test
{
    ...
    public class PageWebhookProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageWebhookProjection
            //Assert.IsInstanceOfType<PageWebhookProjection> (instance, "variable 'instance' is a PageWebhookProjection");
        }

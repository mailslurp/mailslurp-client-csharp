...
namespace mailslurp.Test
{
    ...
    public class WebhookNewEmailPayloadTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" WebhookNewEmailPayload
            //Assert.IsInstanceOfType<WebhookNewEmailPayload> (instance, "variable 'instance' is a WebhookNewEmailPayload");
        }

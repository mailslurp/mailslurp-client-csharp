...
namespace mailslurp.Test
{
    ...
    public class PageInboxRulesetProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageInboxRulesetProjection
            //Assert.IsInstanceOfType<PageInboxRulesetProjection> (instance, "variable 'instance' is a PageInboxRulesetProjection");
        }

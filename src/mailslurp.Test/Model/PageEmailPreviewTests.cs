...
namespace mailslurp.Test
{
    ...
    public class PageEmailPreviewTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageEmailPreview
            //Assert.IsInstanceOfType<PageEmailPreview> (instance, "variable 'instance' is a PageEmailPreview");
        }

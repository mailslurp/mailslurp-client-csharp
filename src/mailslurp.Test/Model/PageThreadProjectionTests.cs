...
namespace mailslurp.Test
{
    ...
    public class PageThreadProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageThreadProjection
            //Assert.IsInstanceOfType<PageThreadProjection> (instance, "variable 'instance' is a PageThreadProjection");
        }

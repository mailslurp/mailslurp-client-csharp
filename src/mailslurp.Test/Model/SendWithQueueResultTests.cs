...
namespace mailslurp.Test
{
    ...
    public class SendWithQueueResultTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" SendWithQueueResult
            //Assert.IsInstanceOfType<SendWithQueueResult> (instance, "variable 'instance' is a SendWithQueueResult");
        }

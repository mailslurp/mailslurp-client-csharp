...
namespace mailslurp.Test
{
    ...
    public class PageInboxProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageInboxProjection
            //Assert.IsInstanceOfType<PageInboxProjection> (instance, "variable 'instance' is a PageInboxProjection");
        }

...
namespace mailslurp.Test
{
    ...
    public class SimpleSendEmailOptionsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" SimpleSendEmailOptions
            //Assert.IsInstanceOfType<SimpleSendEmailOptions> (instance, "variable 'instance' is a SimpleSendEmailOptions");
        }

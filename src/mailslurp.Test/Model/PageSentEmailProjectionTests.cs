...
namespace mailslurp.Test
{
    ...
    public class PageSentEmailProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageSentEmailProjection
            //Assert.IsInstanceOfType<PageSentEmailProjection> (instance, "variable 'instance' is a PageSentEmailProjection");
        }

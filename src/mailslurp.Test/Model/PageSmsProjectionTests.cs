...
namespace mailslurp.Test
{
    ...
    public class PageSmsProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageSmsProjection
            //Assert.IsInstanceOfType<PageSmsProjection> (instance, "variable 'instance' is a PageSmsProjection");
        }

...
namespace mailslurp.Test
{
    ...
    public class PageContactProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageContactProjection
            //Assert.IsInstanceOfType<PageContactProjection> (instance, "variable 'instance' is a PageContactProjection");
        }

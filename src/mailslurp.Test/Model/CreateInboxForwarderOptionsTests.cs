...
namespace mailslurp.Test
{
    ...
    public class CreateInboxForwarderOptionsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" CreateInboxForwarderOptions
            //Assert.IsInstanceOfType<CreateInboxForwarderOptions> (instance, "variable 'instance' is a CreateInboxForwarderOptions");
        }

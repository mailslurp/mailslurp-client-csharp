...
namespace mailslurp.Test
{
    ...
    public class ValidateEmailAddressListResultTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" ValidateEmailAddressListResult
            //Assert.IsInstanceOfType<ValidateEmailAddressListResult> (instance, "variable 'instance' is a ValidateEmailAddressListResult");
        }

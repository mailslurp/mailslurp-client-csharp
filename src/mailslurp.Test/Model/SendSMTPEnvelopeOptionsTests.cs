...
namespace mailslurp.Test
{
    ...
    public class SendSMTPEnvelopeOptionsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" SendSMTPEnvelopeOptions
            //Assert.IsInstanceOfType<SendSMTPEnvelopeOptions> (instance, "variable 'instance' is a SendSMTPEnvelopeOptions");
        }

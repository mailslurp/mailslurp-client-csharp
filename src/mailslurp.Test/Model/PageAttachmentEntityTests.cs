...
namespace mailslurp.Test
{
    ...
    public class PageAttachmentEntityTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageAttachmentEntity
            //Assert.IsInstanceOfType<PageAttachmentEntity> (instance, "variable 'instance' is a PageAttachmentEntity");
        }

...
namespace mailslurp.Test
{
    ...
    public class PageInboxRulesetDtoTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageInboxRulesetDto
            //Assert.IsInstanceOfType<PageInboxRulesetDto> (instance, "variable 'instance' is a PageInboxRulesetDto");
        }

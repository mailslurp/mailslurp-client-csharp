...
namespace mailslurp.Test
{
    ...
    public class PageGroupProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageGroupProjection
            //Assert.IsInstanceOfType<PageGroupProjection> (instance, "variable 'instance' is a PageGroupProjection");
        }

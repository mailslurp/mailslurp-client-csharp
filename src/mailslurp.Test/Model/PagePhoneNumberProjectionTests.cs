...
namespace mailslurp.Test
{
    ...
    public class PagePhoneNumberProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PagePhoneNumberProjection
            //Assert.IsInstanceOfType<PagePhoneNumberProjection> (instance, "variable 'instance' is a PagePhoneNumberProjection");
        }

...
namespace mailslurp.Test
{
    ...
    public class PageTemplateProjectionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageTemplateProjection
            //Assert.IsInstanceOfType<PageTemplateProjection> (instance, "variable 'instance' is a PageTemplateProjection");
        }

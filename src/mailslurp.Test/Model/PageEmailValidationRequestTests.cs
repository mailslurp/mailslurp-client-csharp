...
namespace mailslurp.Test
{
    ...
    public class PageEmailValidationRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageEmailValidationRequest
            //Assert.IsInstanceOfType<PageEmailValidationRequest> (instance, "variable 'instance' is a PageEmailValidationRequest");
        }

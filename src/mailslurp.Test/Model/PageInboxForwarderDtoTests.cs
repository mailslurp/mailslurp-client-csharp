...
namespace mailslurp.Test
{
    ...
    public class PageInboxForwarderDtoTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" PageInboxForwarderDto
            //Assert.IsInstanceOfType<PageInboxForwarderDto> (instance, "variable 'instance' is a PageInboxForwarderDto");
        }

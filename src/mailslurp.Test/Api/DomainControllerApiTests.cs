...
namespace mailslurp.Test.Api
{
    ...
    public class DomainControllerApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GetAvailableDomainRegions
        /// </summary>
        [Fact]
        public void GetAvailableDomainRegionsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string inboxType = null;
            //var response = instance.GetAvailableDomainRegions(inboxType);
            //Assert.IsType<DomainRegionGroupsDto>(response);
        }

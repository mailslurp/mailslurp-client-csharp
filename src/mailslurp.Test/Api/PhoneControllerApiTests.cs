...
namespace mailslurp.Test.Api
{
    ...
    public class PhoneControllerApiTests : IDisposable
    {
        ...
        public void GetPhoneNumbersTest()
        {
            ...
            //bool? favourite = null;
            //var response = instance.GetPhoneNumbers(phoneCountry, lineType, carrierName, mobileCountryCode, mobileNetworkCode, providerLabel, page, size, sort, since, before, search, include, favourite);

...
namespace mailslurp.Test
{
    ...
    public class InboxControllerApiTests : IDisposable
    {
        ...
        public void CreateInboxTest()
        {
            ...
            //var response = instance.CreateInbox(description, emailAddress, expiresAt, favourite, name, tags);
        ...
        public void GetEmailsTest()
        {
            ...
            //DateTime? since = null;
            //string sort = null;
            //var response = instance.GetEmails(inboxId, limit, minCount, retryTimeout, since, sort);
        ...
        public void SendEmailAndConfirmTest()
        {
            ...
            //Assert.IsType<SentEmail> (response, "response is SentEmail");
        }

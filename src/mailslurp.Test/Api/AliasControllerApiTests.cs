...
namespace mailslurp.Test
{
    ...
    public class AliasControllerApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GetAliasVerification
        /// </summary>
        [Fact]
        public void GetAliasVerificationTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid aliasId = null;
            //string emailAddress = null;
            //string verificationToken = null;
            //var response = instance.GetAliasVerification(aliasId, emailAddress, verificationToken);
            //Assert.IsType<AliasVerificationResult> (response, "response is AliasVerificationResult");
        }

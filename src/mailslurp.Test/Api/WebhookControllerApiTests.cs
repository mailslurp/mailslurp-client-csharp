...
namespace mailslurp.Test
{
    ...
    public class WebhookControllerApiTests : IDisposable
    {
        ...
        public void GetTestWebhookPayloadBounceTest()
        {
            ...
            //Assert.IsType<WebhookBouncePayload> (response, "response is WebhookBouncePayload");
        }
        ...
        public void GetTestWebhookPayloadBounceRecipientTest()
        {
            ...
            //Assert.IsType<WebhookBounceRecipientPayload> (response, "response is WebhookBounceRecipientPayload");
        }
        ...
        public void GetWebhookResultsUnseenErrorCountTest()
        {
            ...
            //Assert.IsType<UnseenErrorCountDto> (response, "response is UnseenErrorCountDto");
        }
        ...
        public void VerifyWebhookSignatureTest()
        {
            ...
            //Assert.IsType<VerifyWebhookSignatureResults> (response, "response is VerifyWebhookSignatureResults");
        }

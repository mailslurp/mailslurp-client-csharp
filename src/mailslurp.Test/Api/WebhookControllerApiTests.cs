...
namespace mailslurp.Test.Api
{
    ...
    public class WebhookControllerApiTests : IDisposable
    {
        ...
        public void GetAllWebhooksTest()
        {
            ...
            //string eventType = null;
            //string url = null;
            //var response = instance.GetAllWebhooks(page, size, sort, searchFilter, since, inboxId, aiTransformerId, phoneId, before, health, eventType, url);
            //Assert.IsType<PageWebhookProjection>(response);
        }
        ...
        public void GetInboxWebhooksPaginatedTest()
        {
            ...
            //string health = null;
            //string eventType = null;
            //var response = instance.GetInboxWebhooksPaginated(inboxId, page, size, sort, searchFilter, since, before, health, eventType);
            //Assert.IsType<PageWebhookProjection>(response);
        }
        ...
        public void GetPhoneNumberWebhooksPaginatedTest()
        {
            ...
            //string searchFilter = null;
            //string health = null;
            //var response = instance.GetPhoneNumberWebhooksPaginated(phoneId, page, size, sort, since, before, eventType, searchFilter, health);
            //Assert.IsType<PageWebhookProjection>(response);
        }

...
namespace mailslurp.Test.Api
{
    ...
    public class WebhookControllerApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test CreateWebhookForAITransformer
        /// </summary>
        [Fact]
        public void CreateWebhookForAITransformerTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid transformerId = null;
            //CreateWebhookOptions createWebhookOptions = null;
            //var response = instance.CreateWebhookForAITransformer(transformerId, createWebhookOptions);
            //Assert.IsType<WebhookDto>(response);
        }
        ...
        public void GetAllAccountWebhooksTest()
        {
            ...
            //var response = instance.GetAllAccountWebhooks(page, size, sort, since, before, eventType, health, searchFilter);
        ...
        /// </summary>
        [Fact]
        public void GetAllWebhookEndpointsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? page = null;
            //int? size = null;
            ...
            //string health = null;
            //string eventType = null;
            //var response = instance.GetAllWebhookEndpoints(page, size, sort, searchFilter, since, inboxId, phoneId, before, health, eventType);
            //Assert.IsType<PageWebhookEndpointProjection>(response);
        }
        ...
        public void GetAllWebhookResultsTest()
        {
            ...
            //Guid? emailId = null;
            //Guid? phoneId = null;
            //Guid? aiTransformerId = null;
            //var response = instance.GetAllWebhookResults(page, size, sort, searchFilter, since, before, unseenOnly, resultType, eventName, minStatusCode, maxStatusCode, inboxId, smsId, attachmentId, emailId, phoneId, aiTransformerId);
        ...
        public void GetAllWebhooksTest()
        {
            ...
            //bool? includeAccountWide = null;
            //var response = instance.GetAllWebhooks(page, size, sort, searchFilter, since, inboxId, aiTransformerId, phoneId, before, health, eventType, url, eventTypeSource, includeAccountWide);
            //Assert.IsType<PageWebhookProjection>(response);
        }
        ...
        public void GetInboxWebhooksPaginatedTest()
        {
            ...
            //string eventType = null;
            //bool? includeAccountWide = null;
            //var response = instance.GetInboxWebhooksPaginated(inboxId, page, size, sort, searchFilter, since, before, health, eventType, includeAccountWide);
            //Assert.IsType<PageWebhookProjection>(response);
        }
        ...
        public void GetJsonSchemaForWebhookEventTest()
        {
            ...
            //var response = instance.GetJsonSchemaForWebhookEvent(varEvent);
        ...
        public void GetPhoneNumberWebhooksPaginatedTest()
        {
            ...
            //string health = null;
            //bool? includeAccountWide = null;
            //var response = instance.GetPhoneNumberWebhooksPaginated(phoneId, page, size, sort, since, before, eventType, searchFilter, health, includeAccountWide);
            //Assert.IsType<PageWebhookProjection>(response);
        }
        ...
        /// <summary>
        /// Test GetTestWebhookPayloadNewAITransformResult
        /// </summary>
        [Fact]
        public void GetTestWebhookPayloadNewAITransformResultTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetTestWebhookPayloadNewAITransformResult();
            //Assert.IsType<WebhookNewAITransformResultPayload>(response);
        }
        ...
        public void GetWebhookResultsTest()
        {
            ...
            //Guid? phoneId = null;
            //Guid? aiTransformerId = null;
            //var response = instance.GetWebhookResults(webhookId, page, size, sort, searchFilter, since, before, unseenOnly, resultType, eventName, minStatusCode, maxStatusCode, inboxId, smsId, attachmentId, emailId, phoneId, aiTransformerId);
            //Assert.IsType<PageWebhookResult>(response);
        }
        ...
        public void GetWebhooksTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetWebhooks(inboxId, page, size, sort);
            //Assert.IsType<List<WebhookProjection>>(response);
        }
        ...
        public void UpdateWebhookTest()
        {
            ...
            //Guid? aiTransformerId = null;
            //Guid? phoneNumberId = null;
            //bool? overrideAuth = null;
            //var response = instance.UpdateWebhook(webhookId, createWebhookOptions, inboxId, aiTransformerId, phoneNumberId, overrideAuth);
            //Assert.IsType<WebhookDto>(response);
        }

...
namespace mailslurp.Test
{
    ...
    public class SmsControllerApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' SmsControllerApi
            //Assert.IsType(typeof(SmsControllerApi), instance, "instance is a SmsControllerApi");
        }
        ...
        public void GetSmsMessageTest()
        {
            ...
            //Assert.IsType<SmsMessage> (response, "response is SmsMessage");
        }
        ...
        public void GetSmsMessagesPaginatedTest()
        {
            ...
            //Assert.IsType<PageSmsProjection> (response, "response is PageSmsProjection");
        }

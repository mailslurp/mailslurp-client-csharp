...
namespace mailslurp.Test.Api
{
    ...
    public class UserControllerApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test CreateOrUpdateInboxRetentionPolicyForAccount
        /// </summary>
        [Fact]
        public void CreateOrUpdateInboxRetentionPolicyForAccountTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //CreateInboxRetentionPolicyForAccountOptions createInboxRetentionPolicyForAccountOptions = null;
            //var response = instance.CreateOrUpdateInboxRetentionPolicyForAccount(createInboxRetentionPolicyForAccountOptions);
            //Assert.IsType<InboxRetentionPolicyDto>(response);
        }

        /// <summary>
        /// Test DeleteInboxRetentionPolicyForAccount
        /// </summary>
        [Fact]
        public void DeleteInboxRetentionPolicyForAccountTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.DeleteInboxRetentionPolicyForAccount();
        ...
        /// <summary>
        /// Test GetInboxRetentionPolicyForAccount
        /// </summary>
        [Fact]
        public void GetInboxRetentionPolicyForAccountTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetInboxRetentionPolicyForAccount();
            //Assert.IsType<InboxRetentionPolicyOptionalDto>(response);
        }

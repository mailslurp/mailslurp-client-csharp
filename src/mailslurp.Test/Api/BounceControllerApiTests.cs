...
namespace mailslurp.Test.Api
{
    ...
    public class BounceControllerApiTests : IDisposable
    {
        ...
        /// </summary>
        [Fact]
        public void GetReputationItemsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? page = null;
            //int? size = null;
            ...
            //DateTime? since = null;
            //DateTime? before = null;
            //var response = instance.GetReputationItems(page, size, sort, since, before);
            //Assert.IsType<PageReputationItems>(response);
        }

        /// <summary>
        /// Test GetTenantReputationFindings
        /// </summary>
        [Fact]
        public void GetTenantReputationFindingsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string accountRegion = null;
            //var response = instance.GetTenantReputationFindings(accountRegion);
            //Assert.IsType<TenantReputationFindingsDto>(response);
        }

        /// <summary>
        /// Test GetTenantReputationStatusSummary
        /// </summary>
        [Fact]
        public void GetTenantReputationStatusSummaryTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string accountRegion = null;
            //var response = instance.GetTenantReputationStatusSummary(accountRegion);
            //Assert.IsType<TenantReputationStatusSummaryDto>(response);
        }
    }
}

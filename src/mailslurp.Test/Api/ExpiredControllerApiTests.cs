...
namespace mailslurp.Test
{
    ...
    public class ExpiredControllerApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' ExpiredControllerApi
            //Assert.IsType(typeof(ExpiredControllerApi), instance, "instance is a ExpiredControllerApi");
        }
        ...
        public void GetExpirationDefaultsTest()
        {
            ...
            //Assert.IsType<ExpirationDefaults> (response, "response is ExpirationDefaults");
        }

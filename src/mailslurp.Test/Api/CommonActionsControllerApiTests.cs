...
namespace mailslurp.Test
{
    ...
    public class CommonActionsControllerApiTests : IDisposable
    {
        ...
        public void CreateNewEmailAddressTest()
        {
            ...
            //var response = instance.CreateNewEmailAddress(expiresAt, expiresIn, useDomainPool);
        ...
        public void CreateNewEmailAddress1Test()
        {
            ...
            //long? expiresIn = null;
            //bool? useDomainPool = null;
            //var response = instance.CreateNewEmailAddress1(expiresAt, expiresIn, useDomainPool);
            //Assert.IsType<Inbox> (response, "response is Inbox");
        }

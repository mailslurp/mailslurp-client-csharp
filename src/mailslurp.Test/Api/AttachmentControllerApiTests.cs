...
namespace mailslurp.Test.Api
{
    ...
    public class AttachmentControllerApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ExtractAttachmentText
        /// </summary>
        [Fact]
        public void ExtractAttachmentTextTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string attachmentId = null;
            //ExtractAttachmentTextOptions extractAttachmentTextOptions = null;
            //var response = instance.ExtractAttachmentText(attachmentId, extractAttachmentTextOptions);
            //Assert.IsType<ExtractAttachmentTextResult>(response);
        }
        ...
        public void GetAttachmentsTest()
        {
            ...
            //var response = instance.GetAttachments(page, size, sort, fileNameFilter, since, before, inboxId, emailId, sentEmailId, include);
        ...
        public void UploadMultipartFormTest()
        {
            ...
            //var response = instance.UploadMultipartForm(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest);
            //Assert.IsType<List<string>>(response);
        }
    }
}

...
namespace mailslurp.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "OpenAPI-Generator/7.0.7/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/7.0.7/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 67c9a1eda264be4cfe0bb2c76151f0aadf0862bc\n";
            report += "    SDK Package Version: 7.0.7\n";

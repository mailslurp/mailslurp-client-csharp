...
To send attachments first upload them using the [AttachmentControllerApi](https://csharp.mailslurp.com/api/mailslurp.Api.AttachmentControllerApi.html).
...
Then use the returned attachment IDs in the [SendEmailOptions](https://csharp.mailslurp.com/api/mailslurp.Model.SendEmailOptions.html) of your email send call.

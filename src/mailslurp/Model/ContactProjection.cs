...
namespace mailslurp.Model
{
    ...
    public partial class ContactProjection : IValidatableObject
    {
        ...
        public ContactProjection(string emailAddress = default, List<string> emailAddresses = default, DateTime createdAt = default, string firstName = default, string lastName = default, string company = default, bool? optOut = default, Guid id = default, Guid? groupId = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class ContactProjection : IValidatableObject
    {
        ...
        public ContactProjection(Guid id = default, string emailAddress = default, DateTime createdAt = default, List<string> emailAddresses = default, string firstName = default, string lastName = default, string company = default, bool? optOut = default, Guid? groupId = default)
        {
            this.Id = id;

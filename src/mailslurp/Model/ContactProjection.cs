...
namespace mailslurp.Model
{
    ...
    public partial class ContactProjection : IValidatableObject
    {
        ...
        public ContactProjection(Guid id = default, Guid? groupId = default, string emailAddress = default, DateTime createdAt = default, List<string> emailAddresses = default, string firstName = default, string lastName = default, string company = default, bool? optOut = default)
        {
            this.Id = id;

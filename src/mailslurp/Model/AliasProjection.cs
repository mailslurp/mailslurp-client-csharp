...
namespace mailslurp.Model
{
    ...
    public partial class AliasProjection : IValidatableObject
    {
        ...
        public AliasProjection(string name = default, Guid id = default, Guid userId = default, string emailAddress = default, Guid inboxId = default, DateTime updatedAt = default, DateTime createdAt = default, bool useThreads = default)
        {
            this.Id = id;
            this.UserId = userId;

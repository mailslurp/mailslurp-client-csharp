...
namespace mailslurp.Model
{
    ...
    public partial class AliasProjection : IValidatableObject
    {
        ...
        public AliasProjection(DateTime updatedAt = default, Guid userId = default, string emailAddress = default, Guid inboxId = default, DateTime createdAt = default, bool useThreads = default, string name = default, Guid id = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class AliasProjection : IValidatableObject
    {
        ...
        public AliasProjection(Guid inboxId = default, Guid userId = default, string emailAddress = default, DateTime updatedAt = default, DateTime createdAt = default, bool useThreads = default, string name = default, Guid id = default)
        {

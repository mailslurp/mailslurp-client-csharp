...
namespace mailslurp.Model
{
    ...
    public partial class AliasProjection : IValidatableObject
    {
        ...
        public AliasProjection(Guid userId = default, Guid inboxId = default, string emailAddress = default, DateTime createdAt = default, DateTime updatedAt = default, bool useThreads = default, string name = default, Guid id = default)
        {
            this.UserId = userId;

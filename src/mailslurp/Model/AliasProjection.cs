...
namespace mailslurp.Model
{
    ...
    public partial class AliasProjection : IValidatableObject
    {
        ...
        public AliasProjection(string name = default, Guid id = default, string emailAddress = default, Guid userId = default, Guid inboxId = default, DateTime createdAt = default, DateTime updatedAt = default, bool useThreads = default)
        {
            this.Id = id;

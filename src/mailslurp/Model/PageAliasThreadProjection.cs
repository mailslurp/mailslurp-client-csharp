...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageAliasThreadProjection")]
    public partial class PageAliasThreadProjection : IValidatableObject
    {
        ...
        protected PageAliasThreadProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAliasThreadProjection" /> class.
        /// </summary>
        ...
        public PageAliasThreadProjection(List<AliasThreadProjection> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<AliasThreadProjection> Content { get; set; }

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageGuestPortalUsers")]
    public partial class PageGuestPortalUsers : IValidatableObject
    {
        ...
        protected PageGuestPortalUsers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageGuestPortalUsers" /> class.
        /// </summary>
        ...
        public PageGuestPortalUsers(List<GuestPortalUserProjection> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<GuestPortalUserProjection> Content { get; set; }

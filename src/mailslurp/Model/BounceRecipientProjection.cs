...
namespace mailslurp.Model
{
    ...
    public partial class BounceRecipientProjection : IValidatableObject
    {
        ...
        public BounceRecipientProjection(Guid? sentEmailId = default, DateTime createdAt = default, string recipient = default, string bounceType = default, string action = default, Guid id = default, string status = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class BounceRecipientProjection : IValidatableObject
    {
        ...
        public BounceRecipientProjection(Guid id = default, Guid? sentEmailId = default, DateTime createdAt = default, string recipient = default, string bounceType = default, string action = default, string status = default)
        {

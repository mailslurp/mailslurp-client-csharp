...
namespace mailslurp.Model
{
    ...
    /// </summary>
    public partial class GenerateDmarcRecordResults : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public GenerateDmarcRecordResults(string name, TypeEnum type, int ttl, string value)
        {
            Name = name;
            Type = type;
            Ttl = ttl;
    ...
    /// <summary>
    /// A Json converter for type <see cref="GenerateDmarcRecordResults" />
    /// </summary>
    public class GenerateDmarcRecordResultsJsonConverter : JsonConverter<GenerateDmarcRecordResults>
    {
        /// <summary>
        /// Deserializes json to <see cref="GenerateDmarcRecordResults" />
        /// </summary>
        ...
        public override GenerateDmarcRecordResults Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GenerateDmarcRecordResults.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<GenerateDmarcRecordResults.TypeEnum?>(GenerateDmarcRecordResults.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "ttl":
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class GenerateDmarcRecordResults.", nameof(name));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class GenerateDmarcRecordResults.", nameof(type));

            if (!ttl.IsSet)
                throw new ArgumentException("Property is required for class GenerateDmarcRecordResults.", nameof(ttl));

            if (!value.IsSet)
                throw new ArgumentException("Property is required for class GenerateDmarcRecordResults.", nameof(value));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class GenerateDmarcRecordResults.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class GenerateDmarcRecordResults.");

            if (ttl.IsSet && ttl.Value == null)
                throw new ArgumentNullException(nameof(ttl), "Property is not nullable for class GenerateDmarcRecordResults.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class GenerateDmarcRecordResults.");

            return new GenerateDmarcRecordResults(name.Value, type.Value.Value, ttl.Value.Value, value.Value);
        }

        /// <summary>
        /// Serializes a <see cref="GenerateDmarcRecordResults" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateDmarcRecordResults"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GenerateDmarcRecordResults generateDmarcRecordResults, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, generateDmarcRecordResults, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GenerateDmarcRecordResults" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateDmarcRecordResults"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GenerateDmarcRecordResults generateDmarcRecordResults, JsonSerializerOptions jsonSerializerOptions)
        {
            if (generateDmarcRecordResults.Name == null)
                throw new ArgumentNullException(nameof(generateDmarcRecordResults.Name), "Property is required for class GenerateDmarcRecordResults.");

            if (generateDmarcRecordResults.Value == null)
                throw new ArgumentNullException(nameof(generateDmarcRecordResults.Value), "Property is required for class GenerateDmarcRecordResults.");

            writer.WriteString("name", generateDmarcRecordResults.Name);

            var typeRawValue = GenerateDmarcRecordResults.TypeEnumToJsonValue(generateDmarcRecordResults.Type);
            writer.WriteString("type", typeRawValue);
            writer.WriteNumber("ttl", generateDmarcRecordResults.Ttl);

            writer.WriteString("value", generateDmarcRecordResults.Value);
        }
    }
}

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageEntityFavouriteItems")]
    public partial class PageEntityFavouriteItems : IValidatableObject
    {
        ...
        protected PageEntityFavouriteItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageEntityFavouriteItems" /> class.
        /// </summary>
        ...
        public PageEntityFavouriteItems(List<EntityFavouriteItemProjection> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<EntityFavouriteItemProjection> Content { get; set; }

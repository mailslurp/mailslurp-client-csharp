...
namespace mailslurp.Model
{
    ...
    public partial class InboxReplierEventProjection : IValidatableObject
    {
        ...
        public InboxReplierEventProjection(Guid? userId = default, Guid? emailId = default, Guid? inboxId = default, List<string> recipients = default, DateTime createdAt = default, Guid? sentId = default, Guid? replierId = default, string message = default, Guid? id = default, StatusEnum? status = default)
        {

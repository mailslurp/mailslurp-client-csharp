...
namespace mailslurp.Model
{
    ...
    public partial class InboxReplierEventProjection : IValidatableObject
    {
        ...
        public InboxReplierEventProjection(string message = default, Guid? id = default, StatusEnum? status = default, List<string> recipients = default, Guid? userId = default, Guid? emailId = default, Guid? inboxId = default, DateTime createdAt = default, Guid? sentId = default, Guid? replierId = default)
        {

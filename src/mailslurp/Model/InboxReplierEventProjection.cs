...
namespace mailslurp.Model
{
    ...
    public partial class InboxReplierEventProjection : IValidatableObject
    {
        ...
        public InboxReplierEventProjection(Guid? userId = default, Guid? emailId = default, Guid? inboxId = default, DateTime createdAt = default, List<string> recipients = default, Guid? sentId = default, Guid? replierId = default, string message = default, Guid? id = default, StatusEnum? status = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class InboxReplierEventProjection : IValidatableObject
    {
        ...
        public InboxReplierEventProjection(List<string> recipients = default, Guid? emailId = default, Guid? inboxId = default, Guid? userId = default, DateTime createdAt = default, Guid? sentId = default, Guid? replierId = default, string message = default, Guid? id = default, StatusEnum? status = default)
        {

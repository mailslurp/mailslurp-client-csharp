...
namespace mailslurp.Model
{
    ...
    public partial class ConnectorDto : IValidatableObject
    {
        ...
        public ConnectorDto(Guid id = default, string name = default, bool enabled = default, string emailAddress = default, Guid userId = default, Guid inboxId = default, DateTime createdAt = default)
        {
            this.Id = id;

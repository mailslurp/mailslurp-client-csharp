...
namespace mailslurp.Model
{
    ...
    public partial class CreateDomainOptions :  IEquatable<CreateDomainOptions>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Domain type to create. HTTP or SMTP domain. HTTP domain uses MailSlurps SES MX records. SMTP uses a custom SMTP server MX record</value>
        ...
        /// <param name="domainType">Domain type to create. HTTP or SMTP domain. HTTP domain uses MailSlurps SES MX records. SMTP uses a custom SMTP server MX record.</param>

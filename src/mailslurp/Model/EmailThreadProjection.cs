...
namespace mailslurp.Model
{
    ...
    public partial class EmailThreadProjection : IValidatableObject
    {
        ...
        public EmailThreadProjection(SenderProjection sender = default, EmailRecipientsProjection recipients = default, Guid userId = default, Guid inboxId = default, DateTime createdAt = default, DateTime updatedAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, bool hasAttachments = default, bool unread = default, int messageCount = default, string lastBodyExcerpt = default, string lastTextExcerpt = default, DateTime lastCreatedAt = default, string lastFrom = default, SenderProjection lastSender = default, string subject = default, Guid id = default, string from = default)
        {
            this.UserId = userId;

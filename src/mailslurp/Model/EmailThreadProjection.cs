...
namespace mailslurp.Model
{
    ...
    public partial class EmailThreadProjection : IValidatableObject
    {
        ...
        public EmailThreadProjection(string subject = default, Guid userId = default, Guid inboxId = default, SenderProjection sender = default, EmailRecipientsProjection recipients = default, DateTime updatedAt = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, bool hasAttachments = default, DateTime lastCreatedAt = default, string lastFrom = default, SenderProjection lastSender = default, bool unread = default, int messageCount = default, string lastBodyExcerpt = default, string lastTextExcerpt = default, Guid id = default, string from = default)
        {
            this.UserId = userId;

...
namespace mailslurp.Model
{
    ...
    public partial class EmailThreadProjection : IValidatableObject
    {
        ...
        public EmailThreadProjection(Guid id = default, string from = default, string subject = default, SenderProjection sender = default, EmailRecipientsProjection recipients = default, Guid userId = default, Guid inboxId = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, DateTime updatedAt = default, bool hasAttachments = default, bool unread = default, int messageCount = default, string lastBodyExcerpt = default, string lastTextExcerpt = default, DateTime lastCreatedAt = default, string lastFrom = default, SenderProjection lastSender = default)
        {
            this.Id = id;
            this.UserId = userId;

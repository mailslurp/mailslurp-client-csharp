...
namespace mailslurp.Model
{
    ...
    public partial class EmailThreadProjection : IValidatableObject
    {
        ...
        public EmailThreadProjection(string subject = default, DateTime updatedAt = default, Guid userId = default, Guid inboxId = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, SenderProjection sender = default, EmailRecipientsProjection recipients = default, bool hasAttachments = default, bool unread = default, int messageCount = default, string lastBodyExcerpt = default, string lastTextExcerpt = default, DateTime lastCreatedAt = default, string lastFrom = default, SenderProjection lastSender = default, Guid id = default, string from = default)
        {

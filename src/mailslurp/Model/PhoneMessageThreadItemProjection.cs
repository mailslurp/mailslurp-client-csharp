...
namespace mailslurp.Model
{
    ...
    public partial class PhoneMessageThreadItemProjection : IValidatableObject
    {
        ...
        public PhoneMessageThreadItemProjection(string body = default, Guid phoneNumberId = default, DateTime created = default, MessageDirectionEnum messageDirection = default, string toPhoneNumber = default, string fromPhoneNumber = default)
        {

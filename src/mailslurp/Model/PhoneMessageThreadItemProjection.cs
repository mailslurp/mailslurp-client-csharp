...
namespace mailslurp.Model
{
    ...
    public partial class PhoneMessageThreadItemProjection : IValidatableObject
    {
        ...
        public PhoneMessageThreadItemProjection(Guid id = default, string body = default, DateTime created = default, Guid phoneNumberId = default, MessageDirectionEnum messageDirection = default, string fromPhoneNumber = default, string toPhoneNumber = default)
        {
            this.Id = id;

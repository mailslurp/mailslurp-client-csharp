...
namespace mailslurp.Model
{
    ...
    public partial class PhoneMessageThreadItemProjection : IValidatableObject
    {
        ...
        public PhoneMessageThreadItemProjection(Guid id = default, string body = default, Guid phoneNumberId = default, DateTime created = default, MessageDirectionEnum messageDirection = default, string fromPhoneNumber = default, string toPhoneNumber = default)
        {
            this.Id = id;

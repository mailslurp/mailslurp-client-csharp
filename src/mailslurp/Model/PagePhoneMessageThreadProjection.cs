...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagePhoneMessageThreadProjection")]
    public partial class PagePhoneMessageThreadProjection : IValidatableObject
    {
        ...
        protected PagePhoneMessageThreadProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePhoneMessageThreadProjection" /> class.
        /// </summary>
        ...
        public PagePhoneMessageThreadProjection(List<PhoneMessageThreadProjection> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<PhoneMessageThreadProjection> Content { get; set; }

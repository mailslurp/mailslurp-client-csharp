...
namespace mailslurp.Model
{
    ...
    public partial class InboxForwarderDto : IValidatableObject
    {
        ...
        /// <param name="match">Pattern to apply to field.</param>
        ...
        public InboxForwarderDto(Guid id = default, Guid? inboxId = default, string name = default, FieldEnum? field = default, string match = default, List<string> forwardToRecipients = default, DateTime createdAt = default, ShouldEnum? should = default, InboxAutomationMatchOptions matchOptions = default, AttachmentTextExtractionMethodEnum? attachmentTextExtractionMethod = default)
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>Pattern to apply to field</value>

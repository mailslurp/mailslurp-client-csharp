...
namespace mailslurp.Model
{
    ...
    public partial class SentEmailProjection : IValidatableObject
    {
        ...
        public SentEmailProjection(string subject = default, Guid id = default, Guid userId = default, Guid inboxId = default, List<string> attachments = default, string from = default, Sender sender = default, EmailRecipients recipients = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, string messageId = default, string inReplyTo = default, bool virtualSend = default, string bodyExcerpt = default, string textExcerpt = default, string bodyMD5Hash = default, Guid? threadId = default)
        {
            this.Id = id;
            this.UserId = userId;

...
namespace mailslurp.Model
{
    ...
    public partial class SentEmailProjection : IValidatableObject
    {
        ...
        public SentEmailProjection(string subject = default, Guid id = default, string messageId = default, Guid userId = default, List<string> attachments = default, Guid inboxId = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, string from = default, Sender sender = default, EmailRecipients recipients = default, string inReplyTo = default, bool virtualSend = default, string bodyExcerpt = default, string textExcerpt = default, string bodyMD5Hash = default, Guid? threadId = default)
        {
            this.Id = id;
            this.UserId = userId;

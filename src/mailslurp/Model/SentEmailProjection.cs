...
namespace mailslurp.Model
{
    ...
    public partial class SentEmailProjection : IValidatableObject
    {
        ...
        public SentEmailProjection(Guid id = default, EmailRecipients recipients = default, string from = default, Sender sender = default, string subject = default, List<string> attachments = default, Guid inboxId = default, Guid userId = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, string messageId = default, string inReplyTo = default, string bodyExcerpt = default, string textExcerpt = default, string bodyMD5Hash = default, bool virtualSend = default, Guid? threadId = default)
        {
            this.Id = id;

...
namespace mailslurp.Model
{
    ...
    public partial class SentEmailProjection : IValidatableObject
    {
        ...
        public SentEmailProjection(Guid id = default, Guid? threadId = default, string from = default, string subject = default, Sender sender = default, EmailRecipients recipients = default, Guid userId = default, Guid inboxId = default, List<string> attachments = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, string messageId = default, string inReplyTo = default, bool virtualSend = default, string bodyExcerpt = default, string textExcerpt = default, string bodyMD5Hash = default)
        {
            this.Id = id;
            this.UserId = userId;

...
namespace mailslurp.Model
{
    ...
    public partial class ReplyToEmailOptions :  IEquatable<ReplyToEmailOptions>, IValidatableObject
    {
        ...
        public ReplyToEmailOptions(List<string> attachments = default(List<string>), string body = default(string), string charset = default(string), bool isHTML = default(bool), string replyTo = default(string), SendStrategyEnum? sendStrategy = default(SendStrategyEnum?), Guid template = default(Guid), Object templateVariables = default(Object))
        {

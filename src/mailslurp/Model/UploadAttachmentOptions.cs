...
namespace mailslurp.Model
{
    ...
    public partial class UploadAttachmentOptions :  IEquatable<UploadAttachmentOptions>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="base64Contents">Base64 encoded string of file contents. Typically this means reading the bytes or string content of a file and then converting that to a base64 encoded string..</param>

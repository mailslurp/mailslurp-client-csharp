...
namespace mailslurp.Model
{
    ...
    public partial class UploadAttachmentOptions : IValidatableObject
    {
        ...
        {
            // Base64Contents (string) minLength
            if (this.Base64Contents != null && this.Base64Contents.Length < 1)
            {
                yield return new ValidationResult("Invalid value for Base64Contents, length must be greater than 1.", new [] { "Base64Contents" });
            }

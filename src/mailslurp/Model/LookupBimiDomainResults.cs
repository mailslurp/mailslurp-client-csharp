...
namespace mailslurp.Model
{
    ...
    public partial class LookupBimiDomainResults : IValidatableObject
    {
        ...
        public LookupBimiDomainResults(bool valid = default, DNSLookupOptions query = default, List<DNSLookupResult> records = default, List<string> errors = default, List<string> warnings = default)
        {
            this.Valid = valid;

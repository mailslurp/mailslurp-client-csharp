...
namespace mailslurp.Model
{
    ...
    public partial class InboxPreview : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InboxPreview(Guid id, DateTime createdAt, bool favourite, bool teamAccess, bool virtualInbox, Option<Guid?> domainId = default, string emailAddress = default, Option<string> name = default, Option<List<string>> tags = default, Option<InboxTypeEnum?> inboxType = default, Option<DateTime?> expiresAt = default, Option<FunctionsAsEnum?> functionsAs = default, Guid? userId = default, Option<string> description = default, Option<AccountRegionEnum?> accountRegion = default)
        {
            Id = id;
            CreatedAt = createdAt;
            Favourite = favourite;
    ...
    /// <summary>
    /// A Json converter for type <see cref="InboxPreview" />
    /// </summary>
    public class InboxPreviewJsonConverter : JsonConverter<InboxPreview>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="InboxPreview" />
        /// </summary>
        ...
        public override InboxPreview Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InboxPreview.InboxTypeEnum?> inboxType = default;
            Option<DateTime?> expiresAt = default;
            Option<InboxPreview.FunctionsAsEnum?> functionsAs = default;
            Option<Guid?> userId = default;
            Option<string> description = default;
            Option<InboxPreview.AccountRegionEnum?> accountRegion = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "inboxType":
                            ...
                            if (inboxTypeRawValue != null)
                                inboxType = new Option<InboxPreview.InboxTypeEnum?>(InboxPreview.InboxTypeEnumFromStringOrDefault(inboxTypeRawValue));
                            break;
                        case "expiresAt":
                        ...
                        case "functionsAs":
                            ...
                            if (functionsAsRawValue != null)
                                functionsAs = new Option<InboxPreview.FunctionsAsEnum?>(InboxPreview.FunctionsAsEnumFromStringOrDefault(functionsAsRawValue));
                            break;
                        case "userId":
                        ...
                        case "accountRegion":
                            ...
                            if (accountRegionRawValue != null)
                                accountRegion = new Option<InboxPreview.AccountRegionEnum?>(InboxPreview.AccountRegionEnumFromStringOrDefault(accountRegionRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class InboxPreview.", nameof(id));

            if (!createdAt.IsSet)
                throw new ArgumentException("Property is required for class InboxPreview.", nameof(createdAt));

            if (!favourite.IsSet)
                throw new ArgumentException("Property is required for class InboxPreview.", nameof(favourite));

            if (!teamAccess.IsSet)
                throw new ArgumentException("Property is required for class InboxPreview.", nameof(teamAccess));

            if (!virtualInbox.IsSet)
                throw new ArgumentException("Property is required for class InboxPreview.", nameof(virtualInbox));

            if (!emailAddress.IsSet)
                throw new ArgumentException("Property is required for class InboxPreview.", nameof(emailAddress));

            if (!userId.IsSet)
                throw new ArgumentException("Property is required for class InboxPreview.", nameof(userId));

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class InboxPreview.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class InboxPreview.");

            if (favourite.IsSet && favourite.Value == null)
                throw new ArgumentNullException(nameof(favourite), "Property is not nullable for class InboxPreview.");

            if (teamAccess.IsSet && teamAccess.Value == null)
                throw new ArgumentNullException(nameof(teamAccess), "Property is not nullable for class InboxPreview.");

            if (virtualInbox.IsSet && virtualInbox.Value == null)
                throw new ArgumentNullException(nameof(virtualInbox), "Property is not nullable for class InboxPreview.");

            return new InboxPreview(id.Value.Value, createdAt.Value.Value, favourite.Value.Value, teamAccess.Value.Value, virtualInbox.Value.Value, domainId, emailAddress.Value, name, tags, inboxType, expiresAt, functionsAs, userId.Value, description, accountRegion);
        }

        /// <summary>
        /// Serializes a <see cref="InboxPreview" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inboxPreview"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InboxPreview inboxPreview, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inboxPreview, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InboxPreview" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inboxPreview"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InboxPreview inboxPreview, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("id", inboxPreview.Id);

            writer.WriteString("createdAt", inboxPreview.CreatedAt.ToString(CreatedAtFormat));

            writer.WriteBoolean("favourite", inboxPreview.Favourite);

            writer.WriteBoolean("teamAccess", inboxPreview.TeamAccess);

            writer.WriteBoolean("virtualInbox", inboxPreview.VirtualInbox);

            if (inboxPreview.DomainIdOption.IsSet)
                if (inboxPreview.DomainIdOption.Value != null)
                    writer.WriteString("domainId", inboxPreview.DomainIdOption.Value.Value);
                else
                    writer.WriteNull("domainId");

            if (inboxPreview.EmailAddress != null)
                writer.WriteString("emailAddress", inboxPreview.EmailAddress);
            else
                writer.WriteNull("emailAddress");

            if (inboxPreview.NameOption.IsSet)
                if (inboxPreview.NameOption.Value != null)
                    writer.WriteString("name", inboxPreview.Name);
                else
                    writer.WriteNull("name");

            if (inboxPreview.TagsOption.IsSet)
                if (inboxPreview.TagsOption.Value != null)
                {
                    writer.WritePropertyName("tags");
                    JsonSerializer.Serialize(writer, inboxPreview.Tags, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("tags");
            var inboxTypeRawValue = InboxPreview.InboxTypeEnumToJsonValue(inboxPreview.InboxTypeOption.Value.Value);
            if (inboxTypeRawValue != null)
                writer.WriteString("inboxType", inboxTypeRawValue);
            else
                writer.WriteNull("inboxType");

            if (inboxPreview.ExpiresAtOption.IsSet)
                if (inboxPreview.ExpiresAtOption.Value != null)
                    writer.WriteString("expiresAt", inboxPreview.ExpiresAtOption.Value.Value.ToString(ExpiresAtFormat));
                else
                    writer.WriteNull("expiresAt");

            var functionsAsRawValue = InboxPreview.FunctionsAsEnumToJsonValue(inboxPreview.FunctionsAsOption.Value.Value);
            if (functionsAsRawValue != null)
                writer.WriteString("functionsAs", functionsAsRawValue);
            else
                writer.WriteNull("functionsAs");

            if (inboxPreview.UserId != null)
                writer.WriteString("userId", inboxPreview.UserId.Value);
            else
                writer.WriteNull("userId");

            if (inboxPreview.DescriptionOption.IsSet)
                if (inboxPreview.DescriptionOption.Value != null)
                    writer.WriteString("description", inboxPreview.Description);
                else
                    writer.WriteNull("description");

            var accountRegionRawValue = InboxPreview.AccountRegionEnumToJsonValue(inboxPreview.AccountRegionOption.Value.Value);
            if (accountRegionRawValue != null)

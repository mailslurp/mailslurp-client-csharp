...
namespace mailslurp.Model
{
    ...
    public partial class EntityFavouriteItemProjection : IValidatableObject
    {
        ...
        public EntityFavouriteItemProjection(string name = default, Guid id = default, DateTime createdAt = default, EntityTypeEnum entityType = default, string description = default)
        {

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityFavouriteItemProjection")]
    public partial class EntityFavouriteItemProjection : IValidatableObject
    {
        ...
        protected EntityFavouriteItemProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityFavouriteItemProjection" /> class.
        /// </summary>
        ...
        public EntityFavouriteItemProjection(DateTime createdAt = default, EntityTypeEnum entityType = default, string name = default, Guid id = default, string description = default)
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for EntityFavouriteItemProjection and cannot be null");
            }
            this.Name = name;
            this.Id = id;

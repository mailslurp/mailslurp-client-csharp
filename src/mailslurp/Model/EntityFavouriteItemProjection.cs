...
namespace mailslurp.Model
{
    ...
    public partial class EntityFavouriteItemProjection : IValidatableObject
    {
        ...
        public EntityFavouriteItemProjection(string name = default, Guid id = default, string description = default, DateTime createdAt = default, EntityTypeEnum entityType = default)
        {

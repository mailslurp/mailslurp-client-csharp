...
namespace mailslurp.Model
{
    ...
    /// Last sender object
    /// </summary>
    [DataContract(Name = "SenderProjection")]
    public partial class SenderProjection : IValidatableObject
    {
        ...
        public SenderProjection(string emailAddress = default, string rawValue = default, string name = default)
        {
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for SenderProjection and cannot be null");
            }
            this.EmailAddress = emailAddress;
            // to ensure "rawValue" is required (not null)
            if (rawValue == null)
            {
                throw new ArgumentNullException("rawValue is a required property for SenderProjection and cannot be null");
            }

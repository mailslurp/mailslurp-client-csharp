...
namespace mailslurp.Model
{
    ...
    public partial class AITransformResultProjectionDto : IValidatableObject
    {
        ...
        public AITransformResultProjectionDto(Guid id = default, Guid aiTransformId = default, Guid? aiTransformMappingId = default, Guid userId = default, Object value = default, Guid? entityId = default, EntityTypeEnum? entityType = default, Guid? smsId = default, Guid? emailId = default, string attachmentId = default, DateTime createdAt = default)
        {
            this.Id = id;

...
namespace mailslurp.Model
{
    ...
    public partial class CreateInboxReplierOptions : IValidatableObject
    {
        ...
        {
            // Match (string) minLength
            if (this.Match != null && this.Match.Length < 1)
            {
                yield return new ValidationResult("Invalid value for Match, length must be greater than 1.", new [] { "Match" });
            }

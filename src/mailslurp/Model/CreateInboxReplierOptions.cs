...
namespace mailslurp.Model
{
    ...
    public partial class CreateInboxReplierOptions : IValidatableObject
    {
        ...
        public CreateInboxReplierOptions(Guid? inboxId = default, string name = default, FieldEnum? field = default, string match = default, string replyTo = default, string subject = default, string from = default, string charset = default, bool? ignoreReplyTo = default, bool? isHTML = default, string body = default, Guid? templateId = default, Dictionary<string, Object> templateVariables = default, ShouldEnum? should = default, InboxAutomationMatchOptions matchOptions = default)
        {

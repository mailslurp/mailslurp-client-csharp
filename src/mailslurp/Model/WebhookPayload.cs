...
namespace mailslurp.Model
{
    ...
    public partial class WebhookPayload :  IEquatable<WebhookPayload>, IValidatableObject
    {
        ...
        /// <param name="id">Idempotent message ID. Store this ID locally or in a database to prevent message duplication..</param>
        ...
        public WebhookPayload(List<AttachmentMetaData> attachmentMetaDatas = default(List<AttachmentMetaData>), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), DateTime createdAt = default(DateTime), Guid emailId = default(Guid), EventNameEnum? eventName = default(EventNameEnum?), string from = default(string), string id = default(string), Guid inboxId = default(Guid), string subject = default(string), List<string> to = default(List<string>), Guid webhookId = default(Guid), string webhookName = default(string))
        {

...
namespace mailslurp.Model
{
    ...
    public partial class DNSLookupResult :  IEquatable<DNSLookupResult>, IValidatableObject
    {
        ...
        public DNSLookupResult(string data = default(string), RecordTypeEnum recordType = default(RecordTypeEnum), long ttl = default(long), string value = default(string))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for DNSLookupResult and cannot be null");
            this.RecordType = recordType;
            this.Ttl = ttl;
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for DNSLookupResult and cannot be null");
        }

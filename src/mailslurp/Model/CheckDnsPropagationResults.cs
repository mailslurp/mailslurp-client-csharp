...
namespace mailslurp.Model
{
    ...
    public partial class CheckDnsPropagationResults : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckDnsPropagationResults" /> class.
        /// </summary>
        ...
        /// <param name="propagatedToAllResolvers">propagatedToAllResolvers (required).</param>
        /// <param name="respondingResolverCount">respondingResolverCount (required).</param>
        /// <param name="matchingResolverCount">matchingResolverCount (required).</param>
        /// <param name="resolverResults">resolverResults (required).</param>
        /// <param name="warnings">warnings (required).</param>
        /// <param name="errors">errors (required).</param>
        public CheckDnsPropagationResults(string host = default, RecordTypeEnum recordType = default, string expectedValue = default, bool propagatedToAllResolvers = default, int respondingResolverCount = default, int matchingResolverCount = default, List<DnsPropagationResolverResult> resolverResults = default, List<string> warnings = default, List<string> errors = default)
        {
            // to ensure "host" is required (not null)
            if (host == null)
            {
                throw new ArgumentNullException("host is a required property for CheckDnsPropagationResults and cannot be null");
            }
            this.Host = host;
            ...
            // to ensure "resolverResults" is required (not null)
            if (resolverResults == null)
            {
                throw new ArgumentNullException("resolverResults is a required property for CheckDnsPropagationResults and cannot be null");
            }
            this.ResolverResults = resolverResults;
            // to ensure "warnings" is required (not null)
            if (warnings == null)
            {
                throw new ArgumentNullException("warnings is a required property for CheckDnsPropagationResults and cannot be null");
            }
            this.Warnings = warnings;
            // to ensure "errors" is required (not null)
            if (errors == null)
            {
                throw new ArgumentNullException("errors is a required property for CheckDnsPropagationResults and cannot be null");
            }
            this.Errors = errors;
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PropagatedToAllResolvers: ").Append(PropagatedToAllResolvers).Append("\n");
            sb.Append("  RespondingResolverCount: ").Append(RespondingResolverCount).Append("\n");
            sb.Append("  MatchingResolverCount: ").Append(MatchingResolverCount).Append("\n");
            sb.Append("  ResolverResults: ").Append(ResolverResults).Append("\n");

...
namespace mailslurp.Model
{
    ...
    public partial class TrackingPixelProjection : IValidatableObject
    {
        ...
        public TrackingPixelProjection(Guid userId = default, Guid sentEmailId = default, Guid inboxId = default, DateTime createdAt = default, string recipient = default, bool seen = default, DateTime seenAt = default, string name = default, Guid id = default)
        {
            this.UserId = userId;

...
namespace mailslurp.Model
{
    ...
    public partial class TrackingPixelProjection : IValidatableObject
    {
        ...
        public TrackingPixelProjection(string name = default, Guid id = default, Guid userId = default, Guid inboxId = default, Guid sentEmailId = default, DateTime createdAt = default, string recipient = default, bool seen = default, DateTime seenAt = default)
        {
            this.Id = id;
            this.UserId = userId;

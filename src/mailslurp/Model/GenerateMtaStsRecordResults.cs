...
namespace mailslurp.Model
{
    ...
    public partial class GenerateMtaStsRecordResults : IValidatableObject
    {
        ...
        public GenerateMtaStsRecordResults(string name = default, TypeEnum type = default, int ttl = default, string value = default, string wellKnownValue = default, string wellKnownUrl = default)
        {

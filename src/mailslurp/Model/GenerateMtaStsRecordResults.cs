...
namespace mailslurp.Model
{
    ...
    /// </summary>
    public partial class GenerateMtaStsRecordResults : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="wellKnownUrl">wellKnownUrl</param>
        [JsonConstructor]
        public GenerateMtaStsRecordResults(string name, TypeEnum type, int ttl, string value, string wellKnownValue, string wellKnownUrl)
        {
            Name = name;
            Type = type;
            Ttl = ttl;
    ...
    /// <summary>
    /// A Json converter for type <see cref="GenerateMtaStsRecordResults" />
    /// </summary>
    public class GenerateMtaStsRecordResultsJsonConverter : JsonConverter<GenerateMtaStsRecordResults>
    {
        /// <summary>
        /// Deserializes json to <see cref="GenerateMtaStsRecordResults" />
        /// </summary>
        ...
        public override GenerateMtaStsRecordResults Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GenerateMtaStsRecordResults.TypeEnum?> type = default;
            Option<int?> ttl = default;
            Option<string> value = default;
            Option<string> wellKnownValue = default;
            Option<string> wellKnownUrl = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<GenerateMtaStsRecordResults.TypeEnum?>(GenerateMtaStsRecordResults.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "ttl":
                        ...
                        case "wellKnownValue":
                            ...
                            break;
                        case "wellKnownUrl":
                            wellKnownUrl = new Option<string>(utf8JsonReader.GetString());
                            break;
                        default:
                            break;
                    }
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class GenerateMtaStsRecordResults.", nameof(name));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class GenerateMtaStsRecordResults.", nameof(type));

            if (!ttl.IsSet)
                throw new ArgumentException("Property is required for class GenerateMtaStsRecordResults.", nameof(ttl));

            if (!value.IsSet)
                throw new ArgumentException("Property is required for class GenerateMtaStsRecordResults.", nameof(value));

            if (!wellKnownValue.IsSet)
                throw new ArgumentException("Property is required for class GenerateMtaStsRecordResults.", nameof(wellKnownValue));

            if (!wellKnownUrl.IsSet)
                throw new ArgumentException("Property is required for class GenerateMtaStsRecordResults.", nameof(wellKnownUrl));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class GenerateMtaStsRecordResults.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class GenerateMtaStsRecordResults.");

            if (ttl.IsSet && ttl.Value == null)
                throw new ArgumentNullException(nameof(ttl), "Property is not nullable for class GenerateMtaStsRecordResults.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class GenerateMtaStsRecordResults.");

            if (wellKnownValue.IsSet && wellKnownValue.Value == null)
                throw new ArgumentNullException(nameof(wellKnownValue), "Property is not nullable for class GenerateMtaStsRecordResults.");

            if (wellKnownUrl.IsSet && wellKnownUrl.Value == null)
                throw new ArgumentNullException(nameof(wellKnownUrl), "Property is not nullable for class GenerateMtaStsRecordResults.");

            return new GenerateMtaStsRecordResults(name.Value, type.Value.Value, ttl.Value.Value, value.Value, wellKnownValue.Value, wellKnownUrl.Value);
        }

        /// <summary>
        /// Serializes a <see cref="GenerateMtaStsRecordResults" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateMtaStsRecordResults"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GenerateMtaStsRecordResults generateMtaStsRecordResults, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, generateMtaStsRecordResults, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GenerateMtaStsRecordResults" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateMtaStsRecordResults"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GenerateMtaStsRecordResults generateMtaStsRecordResults, JsonSerializerOptions jsonSerializerOptions)
        {
            if (generateMtaStsRecordResults.Name == null)
                throw new ArgumentNullException(nameof(generateMtaStsRecordResults.Name), "Property is required for class GenerateMtaStsRecordResults.");

            if (generateMtaStsRecordResults.Value == null)
                throw new ArgumentNullException(nameof(generateMtaStsRecordResults.Value), "Property is required for class GenerateMtaStsRecordResults.");

            if (generateMtaStsRecordResults.WellKnownValue == null)
                throw new ArgumentNullException(nameof(generateMtaStsRecordResults.WellKnownValue), "Property is required for class GenerateMtaStsRecordResults.");

            if (generateMtaStsRecordResults.WellKnownUrl == null)
                throw new ArgumentNullException(nameof(generateMtaStsRecordResults.WellKnownUrl), "Property is required for class GenerateMtaStsRecordResults.");

            writer.WriteString("name", generateMtaStsRecordResults.Name);

            var typeRawValue = GenerateMtaStsRecordResults.TypeEnumToJsonValue(generateMtaStsRecordResults.Type);
            writer.WriteString("type", typeRawValue);
            writer.WriteNumber("ttl", generateMtaStsRecordResults.Ttl);

            writer.WriteString("value", generateMtaStsRecordResults.Value);

            writer.WriteString("wellKnownValue", generateMtaStsRecordResults.WellKnownValue);

            writer.WriteString("wellKnownUrl", generateMtaStsRecordResults.WellKnownUrl);
        }
    }
}

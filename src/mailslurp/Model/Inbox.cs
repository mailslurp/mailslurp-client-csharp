...
namespace mailslurp.Model
{
    ...
    public partial class Inbox :  IEquatable<Inbox>, IValidatableObject
    {
        ...
        /// <param name="name">Name of the inbox. Displayed in the dashboard for easier search.</param>
        /// <param name="readOnly">Is the inbox readOnly for the caller. Read only means can not be deleted or modified..</param>
        ...
        /// <param name="teamAccess">Does inbox permit team access for organization team members. If so team users can use inbox and emails associated with it..</param>
        /// <param name="userId">ID of user that inbox belongs to.</param>
        public Inbox(DateTime createdAt = default(DateTime), string description = default(string), string emailAddress = default(string), string expiresAt = default(string), bool favourite = default(bool), Guid id = default(Guid), string name = default(string), bool readOnly = default(bool), List<string> tags = default(List<string>), bool teamAccess = default(bool), Guid userId = default(Guid))
        {
        ...
        /// </summary>
        /// <value>Name of the inbox. Displayed in the dashboard for easier search</value>
        ...
        /// </summary>
        /// <value>Is the inbox readOnly for the caller. Read only means can not be deleted or modified.</value>
        ...
        /// </summary>
        /// <value>Does inbox permit team access for organization team members. If so team users can use inbox and emails associated with it.</value>

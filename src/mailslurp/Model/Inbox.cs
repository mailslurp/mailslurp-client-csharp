...
namespace mailslurp.Model
{
    ...
    public partial class Inbox :  IEquatable<Inbox>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="createdAt">When was the inbox created. Time stamps are in ISO DateTime Format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSXXX&#x60; e.g. &#x60;2000-10-31T01:30:00.000-05:00&#x60;..</param>
        /// <param name="description">Optional description of an inbox for labelling purposes.</param>
        /// <param name="emailAddress">The inbox&#39;s email address. Send an email to this address and the inbox will receive and store it for you. To retrieve the email use the Inbox and Email Controller endpoints with the inbox ID..</param>
        ...
        /// <param name="id">ID of the inbox. The ID is a UUID-V4 string. See the emailAddress property for the email address..</param>
        ...
        /// </summary>
        /// <value>When was the inbox created. Time stamps are in ISO DateTime Format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSXXX&#x60; e.g. &#x60;2000-10-31T01:30:00.000-05:00&#x60;.</value>
        ...
        /// </summary>
        /// <value>The inbox&#39;s email address. Send an email to this address and the inbox will receive and store it for you. To retrieve the email use the Inbox and Email Controller endpoints with the inbox ID.</value>
        ...
        /// </summary>
        /// <value>ID of the inbox. The ID is a UUID-V4 string. See the emailAddress property for the email address.</value>

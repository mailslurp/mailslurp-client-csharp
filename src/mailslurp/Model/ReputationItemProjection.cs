...
namespace mailslurp.Model
{
    ...
    public partial class ReputationItemProjection : IValidatableObject
    {
        ...
        public ReputationItemProjection(Guid id = default, SeverityEnum severity = default, string source = default, DateTime createdAt = default, string recipient = default, ReputationTypeEnum reputationType = default)
        {
            this.Id = id;

...
namespace mailslurp.Model
{
    ...
    public partial class ReputationItemProjection : IValidatableObject
    {
        ...
        public ReputationItemProjection(Guid id = default, SeverityEnum severity = default, DateTime createdAt = default, string recipient = default, ReputationTypeEnum reputationType = default, string source = default)
        {
            this.Id = id;

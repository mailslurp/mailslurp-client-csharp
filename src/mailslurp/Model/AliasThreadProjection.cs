...
namespace mailslurp.Model
{
    ...
    public partial class AliasThreadProjection : IValidatableObject
    {
        ...
        public AliasThreadProjection(string subject = default, DateTime updatedAt = default, Guid userId = default, Guid inboxId = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, Guid aliasId = default, string name = default, Guid id = default)
        {

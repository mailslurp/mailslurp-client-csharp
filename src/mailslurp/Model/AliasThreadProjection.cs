...
namespace mailslurp.Model
{
    ...
    public partial class AliasThreadProjection : IValidatableObject
    {
        ...
        public AliasThreadProjection(string name = default, Guid id = default, string subject = default, Guid userId = default, Guid inboxId = default, DateTime updatedAt = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, Guid aliasId = default)
        {
            this.Id = id;
            this.UserId = userId;

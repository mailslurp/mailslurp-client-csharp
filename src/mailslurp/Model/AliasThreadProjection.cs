...
namespace mailslurp.Model
{
    ...
    public partial class AliasThreadProjection : IValidatableObject
    {
        ...
        public AliasThreadProjection(Guid userId = default, Guid inboxId = default, DateTime updatedAt = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, Guid aliasId = default, string subject = default, string name = default, Guid id = default)
        {
            this.UserId = userId;

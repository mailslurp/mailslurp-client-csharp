...
namespace mailslurp.Model
{
    ...
    public partial class LookupDmarcDomainResults : IValidatableObject
    {
        ...
        public LookupDmarcDomainResults(bool valid = default, DNSLookupOptions query = default, List<DNSLookupResult> records = default, List<string> errors = default, List<string> warnings = default)
        {
            this.Valid = valid;

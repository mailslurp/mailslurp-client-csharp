...
namespace mailslurp.Model
{
    ...
    public partial class PageWebhookResult : IValidatableObject
    {
        ...
        public PageWebhookResult(List<WebhookResultDto> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {

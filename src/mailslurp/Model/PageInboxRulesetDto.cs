...
namespace mailslurp.Model
{
    ...
    public partial class PageInboxRulesetDto : IValidatableObject
    {
        ...
        public PageInboxRulesetDto(List<InboxRulesetDto> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageOptInIdentityProjection")]
    public partial class PageOptInIdentityProjection : IValidatableObject
    {
        ...
        protected PageOptInIdentityProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageOptInIdentityProjection" /> class.
        /// </summary>
        ...
        public PageOptInIdentityProjection(List<OptInIdentityProjection> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<OptInIdentityProjection> Content { get; set; }

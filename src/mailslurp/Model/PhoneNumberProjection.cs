...
namespace mailslurp.Model
{
    ...
    public partial class PhoneNumberProjection : IValidatableObject
    {
        ...
        public PhoneNumberProjection(Guid userId = default, DateTime createdAt = default, PhoneCountryEnum phoneCountry = default, string phoneNumber = default, string name = default, Guid id = default)
        {
            this.UserId = userId;

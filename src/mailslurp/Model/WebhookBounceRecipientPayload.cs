...
namespace mailslurp.Model
{
    ...
    public partial class WebhookBounceRecipientPayload : IValidatableObject
    {
        ...
        /// <param name="recipient">Email address that caused a bounce. Make note of the address and try not to message it again to preserve your reputation.</param>
        /// <param name="webhookName">Name of the webhook being triggered</param>
        [JsonConstructor]
        public WebhookBounceRecipientPayload(string messageId, Guid webhookId, EventNameEnum eventName, string recipient, Option<string> webhookName = default)
        {
            MessageId = messageId;
            WebhookId = webhookId;
            EventName = eventName;
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookBounceRecipientPayload" />
    /// </summary>
    public class WebhookBounceRecipientPayloadJsonConverter : JsonConverter<WebhookBounceRecipientPayload>
    {
        /// <summary>
        /// Deserializes json to <see cref="WebhookBounceRecipientPayload" />
        /// </summary>
        ...
        public override WebhookBounceRecipientPayload Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WebhookBounceRecipientPayload.EventNameEnum?> eventName = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "eventName":
                            ...
                            if (eventNameRawValue != null)
                                eventName = new Option<WebhookBounceRecipientPayload.EventNameEnum?>(WebhookBounceRecipientPayload.EventNameEnumFromStringOrDefault(eventNameRawValue));
                            break;
                        case "recipient":
            ...
            if (!messageId.IsSet)
                throw new ArgumentException("Property is required for class WebhookBounceRecipientPayload.", nameof(messageId));

            if (!webhookId.IsSet)
                throw new ArgumentException("Property is required for class WebhookBounceRecipientPayload.", nameof(webhookId));

            if (!eventName.IsSet)
                throw new ArgumentException("Property is required for class WebhookBounceRecipientPayload.", nameof(eventName));

            if (!recipient.IsSet)
                throw new ArgumentException("Property is required for class WebhookBounceRecipientPayload.", nameof(recipient));

            if (messageId.IsSet && messageId.Value == null)
                throw new ArgumentNullException(nameof(messageId), "Property is not nullable for class WebhookBounceRecipientPayload.");

            if (webhookId.IsSet && webhookId.Value == null)
                throw new ArgumentNullException(nameof(webhookId), "Property is not nullable for class WebhookBounceRecipientPayload.");

            if (eventName.IsSet && eventName.Value == null)
                throw new ArgumentNullException(nameof(eventName), "Property is not nullable for class WebhookBounceRecipientPayload.");

            if (recipient.IsSet && recipient.Value == null)
                throw new ArgumentNullException(nameof(recipient), "Property is not nullable for class WebhookBounceRecipientPayload.");

            return new WebhookBounceRecipientPayload(messageId.Value, webhookId.Value.Value, eventName.Value.Value, recipient.Value, webhookName);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookBounceRecipientPayload" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookBounceRecipientPayload"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookBounceRecipientPayload webhookBounceRecipientPayload, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookBounceRecipientPayload, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookBounceRecipientPayload" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookBounceRecipientPayload"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookBounceRecipientPayload webhookBounceRecipientPayload, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookBounceRecipientPayload.MessageId == null)
                throw new ArgumentNullException(nameof(webhookBounceRecipientPayload.MessageId), "Property is required for class WebhookBounceRecipientPayload.");

            if (webhookBounceRecipientPayload.Recipient == null)
                throw new ArgumentNullException(nameof(webhookBounceRecipientPayload.Recipient), "Property is required for class WebhookBounceRecipientPayload.");

            writer.WriteString("messageId", webhookBounceRecipientPayload.MessageId);

            writer.WriteString("webhookId", webhookBounceRecipientPayload.WebhookId);

            var eventNameRawValue = WebhookBounceRecipientPayload.EventNameEnumToJsonValue(webhookBounceRecipientPayload.EventName);
            writer.WriteString("eventName", eventNameRawValue);
            writer.WriteString("recipient", webhookBounceRecipientPayload.Recipient);

            if (webhookBounceRecipientPayload.WebhookNameOption.IsSet)
                if (webhookBounceRecipientPayload.WebhookNameOption.Value != null)
                    writer.WriteString("webhookName", webhookBounceRecipientPayload.WebhookName);
                else

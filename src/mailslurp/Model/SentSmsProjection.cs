...
namespace mailslurp.Model
{
    ...
    public partial class SentSmsProjection : IValidatableObject
    {
        ...
        public SentSmsProjection(Guid id = default, string body = default, Guid userId = default, DateTime createdAt = default, Guid phoneNumber = default, string fromNumber = default, string toNumber = default, string replyToId = default)
        {
            this.Id = id;

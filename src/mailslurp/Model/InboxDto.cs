...
namespace mailslurp.Model
{
    ...
    public partial class InboxDto : IValidatableObject
    {
        ...
        public InboxDto(Guid id = default, Guid? userId = default, DateTime createdAt = default, string name = default, Guid? domainId = default, string description = default, string emailAddress = default, DateTime? expiresAt = default, bool favourite = default, List<string> tags = default, InboxTypeEnum? inboxType = default, bool readOnly = default, bool virtualInbox = default, FunctionsAsEnum? functionsAs = default, string localPart = default, string domain = default, AccountRegionEnum? accountRegion = default)
        {
            this.Id = id;
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for InboxDto and cannot be null");
            }
            this.UserId = userId;

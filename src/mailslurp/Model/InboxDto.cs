...
namespace mailslurp.Model
{
    ...
    /// </summary>
    public partial class InboxDto : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="localPart">Local part of email addresses before the @ symbol</param>
        /// <param name="domain">Domain name of the email address</param>
        /// <param name="accountRegion">Region of the inbox</param>
        [JsonConstructor]
        public InboxDto(Guid id, DateTime createdAt, string emailAddress, bool favourite, bool readOnly, bool virtualInbox, Guid? userId = default, Option<string> name = default, Option<Guid?> domainId = default, Option<string> description = default, Option<DateTime?> expiresAt = default, Option<List<string>> tags = default, Option<InboxTypeEnum?> inboxType = default, Option<FunctionsAsEnum?> functionsAs = default, Option<string> localPart = default, Option<string> domain = default, Option<AccountRegionEnum?> accountRegion = default)
        {
            Id = id;
            CreatedAt = createdAt;
        ...
        /// </summary>
        /// <value>Local part of email addresses before the @ symbol</value>
        [JsonPropertyName("localPart")]
        public string LocalPart { get { return this.LocalPartOption; } set { this.LocalPartOption = new Option<string>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InboxDto" />
    /// </summary>
    public class InboxDtoJsonConverter : JsonConverter<InboxDto>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="InboxDto" />
        /// </summary>
        ...
        public override InboxDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InboxDto.InboxTypeEnum?> inboxType = default;
            Option<InboxDto.FunctionsAsEnum?> functionsAs = default;
            Option<string> localPart = default;
            Option<string> domain = default;
            Option<InboxDto.AccountRegionEnum?> accountRegion = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "inboxType":
                            ...
                            if (inboxTypeRawValue != null)
                                inboxType = new Option<InboxDto.InboxTypeEnum?>(InboxDto.InboxTypeEnumFromStringOrDefault(inboxTypeRawValue));
                            break;
                        case "functionsAs":
                            string functionsAsRawValue = utf8JsonReader.GetString();
                            if (functionsAsRawValue != null)
                                functionsAs = new Option<InboxDto.FunctionsAsEnum?>(InboxDto.FunctionsAsEnumFromStringOrDefault(functionsAsRawValue));
                            break;
                        case "localPart":
                        ...
                        case "accountRegion":
                            ...
                            if (accountRegionRawValue != null)
                                accountRegion = new Option<InboxDto.AccountRegionEnum?>(InboxDto.AccountRegionEnumFromStringOrDefault(accountRegionRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class InboxDto.", nameof(id));

            if (!createdAt.IsSet)
                throw new ArgumentException("Property is required for class InboxDto.", nameof(createdAt));

            if (!emailAddress.IsSet)
                throw new ArgumentException("Property is required for class InboxDto.", nameof(emailAddress));

            if (!favourite.IsSet)
                throw new ArgumentException("Property is required for class InboxDto.", nameof(favourite));

            if (!readOnly.IsSet)
                throw new ArgumentException("Property is required for class InboxDto.", nameof(readOnly));

            if (!virtualInbox.IsSet)
                throw new ArgumentException("Property is required for class InboxDto.", nameof(virtualInbox));

            if (!userId.IsSet)
                throw new ArgumentException("Property is required for class InboxDto.", nameof(userId));

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class InboxDto.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class InboxDto.");

            if (emailAddress.IsSet && emailAddress.Value == null)
                throw new ArgumentNullException(nameof(emailAddress), "Property is not nullable for class InboxDto.");

            if (favourite.IsSet && favourite.Value == null)
                throw new ArgumentNullException(nameof(favourite), "Property is not nullable for class InboxDto.");

            if (readOnly.IsSet && readOnly.Value == null)
                throw new ArgumentNullException(nameof(readOnly), "Property is not nullable for class InboxDto.");

            if (virtualInbox.IsSet && virtualInbox.Value == null)
                throw new ArgumentNullException(nameof(virtualInbox), "Property is not nullable for class InboxDto.");

            return new InboxDto(id.Value.Value, createdAt.Value.Value, emailAddress.Value, favourite.Value.Value, readOnly.Value.Value, virtualInbox.Value.Value, userId.Value, name, domainId, description, expiresAt, tags, inboxType, functionsAs, localPart, domain, accountRegion);
        }

        /// <summary>
        /// Serializes a <see cref="InboxDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inboxDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InboxDto inboxDto, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inboxDto, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InboxDto" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inboxDto"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InboxDto inboxDto, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inboxDto.EmailAddress == null)
                throw new ArgumentNullException(nameof(inboxDto.EmailAddress), "Property is required for class InboxDto.");

            writer.WriteString("id", inboxDto.Id);

            writer.WriteString("createdAt", inboxDto.CreatedAt.ToString(CreatedAtFormat));

            writer.WriteString("emailAddress", inboxDto.EmailAddress);

            writer.WriteBoolean("favourite", inboxDto.Favourite);

            writer.WriteBoolean("readOnly", inboxDto.ReadOnly);

            writer.WriteBoolean("virtualInbox", inboxDto.VirtualInbox);

            if (inboxDto.UserId != null)
                writer.WriteString("userId", inboxDto.UserId.Value);
            else
                writer.WriteNull("userId");

            if (inboxDto.NameOption.IsSet)
                if (inboxDto.NameOption.Value != null)
                    writer.WriteString("name", inboxDto.Name);
                else
                    writer.WriteNull("name");

            if (inboxDto.DomainIdOption.IsSet)
                if (inboxDto.DomainIdOption.Value != null)
                    writer.WriteString("domainId", inboxDto.DomainIdOption.Value.Value);
                else
                    writer.WriteNull("domainId");

            if (inboxDto.DescriptionOption.IsSet)
                if (inboxDto.DescriptionOption.Value != null)
                    writer.WriteString("description", inboxDto.Description);
                else
                    writer.WriteNull("description");

            if (inboxDto.ExpiresAtOption.IsSet)
                if (inboxDto.ExpiresAtOption.Value != null)
                    writer.WriteString("expiresAt", inboxDto.ExpiresAtOption.Value.Value.ToString(ExpiresAtFormat));
                else
                    writer.WriteNull("expiresAt");

            if (inboxDto.TagsOption.IsSet)
                if (inboxDto.TagsOption.Value != null)
                {
                    writer.WritePropertyName("tags");
                    JsonSerializer.Serialize(writer, inboxDto.Tags, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("tags");
            var inboxTypeRawValue = InboxDto.InboxTypeEnumToJsonValue(inboxDto.InboxTypeOption.Value.Value);
            if (inboxTypeRawValue != null)
                writer.WriteString("inboxType", inboxTypeRawValue);
            else
                writer.WriteNull("inboxType");

            var functionsAsRawValue = InboxDto.FunctionsAsEnumToJsonValue(inboxDto.FunctionsAsOption.Value.Value);
            if (functionsAsRawValue != null)
                writer.WriteString("functionsAs", functionsAsRawValue);
            else
                writer.WriteNull("functionsAs");

            if (inboxDto.LocalPartOption.IsSet)
                if (inboxDto.LocalPartOption.Value != null)
                    writer.WriteString("localPart", inboxDto.LocalPart);
                else
                    writer.WriteNull("localPart");

            if (inboxDto.DomainOption.IsSet)
                if (inboxDto.DomainOption.Value != null)
                    writer.WriteString("domain", inboxDto.Domain);
                else
                    writer.WriteNull("domain");

            var accountRegionRawValue = InboxDto.AccountRegionEnumToJsonValue(inboxDto.AccountRegionOption.Value.Value);
            if (accountRegionRawValue != null)

...
namespace mailslurp.Model
{
    ...
    public partial class BounceProjection : IValidatableObject
    {
        ...
        public BounceProjection(string sender = default, DateTime createdAt = default, string bounceType = default, string bounceMta = default, string subject = default, Guid id = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class BounceProjection : IValidatableObject
    {
        ...
        public BounceProjection(Guid id = default, string subject = default, string sender = default, DateTime createdAt = default, string bounceType = default, string bounceMta = default)
        {

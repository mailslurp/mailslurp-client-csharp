...
namespace mailslurp.Model
{
    ...
    public partial class BounceProjection : IValidatableObject
    {
        ...
        public BounceProjection(string subject = default, DateTime createdAt = default, string bounceType = default, string sender = default, string bounceMta = default, Guid id = default)
        {

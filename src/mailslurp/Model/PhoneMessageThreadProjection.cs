...
namespace mailslurp.Model
{
    ...
    public partial class PhoneMessageThreadProjection : IValidatableObject
    {
        ...
        public PhoneMessageThreadProjection(string otherPhoneNumber = default, LastMessageDirectionEnum lastMessageDirection = default, string lastBody = default, DateTime lastCreated = default, string phoneNumber = default, Guid phoneNumberId = default)
        {

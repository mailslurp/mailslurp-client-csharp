...
namespace mailslurp.Model
{
    ...
    public partial class SearchInboxesOptions : IValidatableObject
    {
        ...
        /// <param name="search">Optionally filter by search words partial matching name and email address.</param>
        ...
        public SearchInboxesOptions(int? pageIndex = default, int? pageSize = default, SortDirectionEnum? sortDirection = default, bool? favourite = default, string search = default, string tag = default, DateTime? since = default, DateTime? before = default, InboxTypeEnum? inboxType = default, InboxFunctionEnum? inboxFunction = default, Guid? domainId = default)
        {
        ...
        /// </summary>
        /// <value>Optionally filter by search words partial matching name and email address</value>

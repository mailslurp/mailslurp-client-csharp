...
namespace mailslurp.Model
{
    ...
    public partial class CreateWebhookOptions : IValidatableObject
    {
        ...
        public CreateWebhookOptions(string url = default, BasicAuthOptions basicAuth = default, string name = default, EventNameEnum? eventName = default, WebhookHeaders includeHeaders = default, string requestBodyTemplate = default, bool? useStaticIpRange = false, bool? ignoreInsecureSslCertificates = default, List<string> tags = default)
        {

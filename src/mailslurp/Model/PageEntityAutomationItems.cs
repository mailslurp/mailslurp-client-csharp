...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageEntityAutomationItems")]
    public partial class PageEntityAutomationItems : IValidatableObject
    {
        ...
        protected PageEntityAutomationItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageEntityAutomationItems" /> class.
        /// </summary>
        ...
        public PageEntityAutomationItems(List<EntityAutomationItemProjection> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<EntityAutomationItemProjection> Content { get; set; }

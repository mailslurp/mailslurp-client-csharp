...
namespace mailslurp.Model
{
    ...
    public partial class SendEmailOptions : IValidatableObject
    {
        ...
        public SendEmailOptions(List<Guid?> toContacts = default, Guid? toGroup = default, List<string> to = default, string from = default, string fromName = default, List<string> cc = default, List<string> bcc = default, string subject = default, string replyTo = default, Dictionary<string, string> customHeaders = default, string body = default, bool? html = default, bool? isHTML = default, string charset = default, List<string> attachments = default, Dictionary<string, Object> templateVariables = default, Guid? template = default, SendStrategyEnum? sendStrategy = default, bool? useInboxName = default, bool? addTrackingPixel = default, bool? filterBouncedRecipients = default, ValidateEmailAddressesEnum? validateEmailAddresses = default, bool? ignoreEmptyRecipients = default, bool? isXAmpHtml = default, List<SendEmailBodyPart> bodyParts = default)
        {

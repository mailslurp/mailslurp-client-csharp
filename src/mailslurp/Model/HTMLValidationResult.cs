...
namespace mailslurp.Model
{
    ...
    public partial class HTMLValidationResult : IValidatableObject
    {
        ...
        public HTMLValidationResult(bool isValid = default, List<ValidationMessage> infos = default, List<ValidationMessage> errors = default, List<ValidationMessage> warnings = default)
        {

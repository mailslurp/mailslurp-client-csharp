...
namespace mailslurp.Model
{
    ...
    public partial class SmsProjection : IValidatableObject
    {
        ...
        public SmsProjection(Guid id = default, string body = default, Guid userId = default, DateTime createdAt = default, Guid phoneNumber = default, string fromNumber = default, bool read = default)
        {
            this.Id = id;

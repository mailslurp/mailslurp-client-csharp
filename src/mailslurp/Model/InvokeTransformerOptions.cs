...
namespace mailslurp.Model
{
    ...
    public partial class InvokeTransformerOptions : IValidatableObject
    {
        ...
        public InvokeTransformerOptions(Guid aiTransformId = default, Guid aiTransformMappingId = default, string rawInput = default, string entityId = default, EntityTypeEnum? entityType = default, List<string> rawConditions = default, List<string> rawInstructions = default, StructuredOutputSchema rawOutputSchema = default, ContentSelectorEnum? contentSelector = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "aiTransformId", EmitDefaultValue = false)]
        public Guid AiTransformId { get; set; }

        /// <summary>
        /// Gets or Sets AiTransformMappingId
        /// </summary>
        [DataMember(Name = "aiTransformMappingId", EmitDefaultValue = false)]
        public Guid AiTransformMappingId { get; set; }

        /// <summary>
        /// Gets or Sets RawInput
        /// </summary>
        [DataMember(Name = "rawInput", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "rawConditions", EmitDefaultValue = false)]
        public List<string> RawConditions { get; set; }

        /// <summary>
        /// Gets or Sets RawInstructions
        /// </summary>
        [DataMember(Name = "rawInstructions", EmitDefaultValue = false)]

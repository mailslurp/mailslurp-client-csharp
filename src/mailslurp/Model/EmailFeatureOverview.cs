...
namespace mailslurp.Model
{
    ...
    public partial class EmailFeatureOverview : IValidatableObject
    {
        ...
        public EmailFeatureOverview(FeatureEnum feature = default, string title = default, string description = default, CategoryEnum? category = default, string notes = default, Dictionary<string, string> notesNumbers = default, List<EmailFeatureFamilyStatistics> featureStatistics = default, List<StatusesEnum> statuses = default)
        {

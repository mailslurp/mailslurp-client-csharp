...
namespace mailslurp.Model
{
    ...
    public partial class EmailValidationRequestDto : IValidatableObject
    {
        ...
        public EmailValidationRequestDto(Guid id = default, Guid userId = default, string emailAddress = default, bool isValid = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
            this.Id = id;
            this.UserId = userId;

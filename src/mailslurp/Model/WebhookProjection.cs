...
namespace mailslurp.Model
{
    ...
    public partial class WebhookProjection : IValidatableObject
    {
        ...
        public WebhookProjection(string name = default, Guid id = default, string url = default, string password = default, string username = default, Guid userId = default, Guid inboxId = default, EventNameEnum? eventName = default, DateTime updatedAt = default, DateTime createdAt = default, HealthStatusEnum? healthStatus = default, Guid aiTransformerId = default, Guid aiTransformId = default, Guid phoneNumberId = default)
        {
            this.Id = id;

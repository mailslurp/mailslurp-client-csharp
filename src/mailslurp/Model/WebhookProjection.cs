...
namespace mailslurp.Model
{
    ...
    public partial class WebhookProjection : IValidatableObject
    {
        ...
        public WebhookProjection(string url = default, string password = default, string username = default, DateTime updatedAt = default, Guid userId = default, Guid inboxId = default, EventNameEnum? eventName = default, DateTime createdAt = default, Guid aiTransformId = default, HealthStatusEnum? healthStatus = default, Guid aiTransformerId = default, Guid phoneNumberId = default, string name = default, Guid id = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class WebhookProjection : IValidatableObject
    {
        ...
        public WebhookProjection(string url = default, string password = default, string username = default, Guid userId = default, Guid inboxId = default, EventNameEnum? eventName = default, DateTime createdAt = default, DateTime updatedAt = default, HealthStatusEnum? healthStatus = default, Guid aiTransformerId = default, Guid aiTransformId = default, Guid phoneNumberId = default, string name = default, Guid id = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "aiTransformerId", EmitDefaultValue = false)]

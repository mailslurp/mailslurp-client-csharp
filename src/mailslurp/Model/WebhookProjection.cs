...
namespace mailslurp.Model
{
    ...
    public partial class WebhookProjection : IValidatableObject
    {
        ...
        public WebhookProjection(string url = default, string password = default, string username = default, Guid inboxId = default, Guid userId = default, EventNameEnum? eventName = default, DateTime updatedAt = default, DateTime createdAt = default, Guid aiTransformId = default, HealthStatusEnum? healthStatus = default, Guid phoneNumberId = default, string name = default, Guid id = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class ScheduledJobDto : IValidatableObject
    {
        ...
        public ScheduledJobDto(Guid id = default, Guid userId = default, Guid inboxId = default, string jobId = default, string groupId = default, string triggerId = default, StatusEnum status = default, DateTime sendAtTimestamp = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
            this.Id = id;
            this.UserId = userId;

...
namespace mailslurp.Model
{
    ...
    public partial class AttachmentProjection : IValidatableObject
    {
        ...
        public AttachmentProjection(DateTime updatedAt = default, string contentId = default, Guid userId = default, Guid inboxId = default, DateTime createdAt = default, string attachmentId = default, string name = default, Guid id = default, long? contentLength = default, string contentType = default)
        {

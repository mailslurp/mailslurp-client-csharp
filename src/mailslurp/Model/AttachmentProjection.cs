...
namespace mailslurp.Model
{
    ...
    public partial class AttachmentProjection : IValidatableObject
    {
        ...
        public AttachmentProjection(Guid inboxId = default, Guid userId = default, DateTime updatedAt = default, DateTime createdAt = default, string contentId = default, string attachmentId = default, string name = default, Guid id = default, long? contentLength = default, string contentType = default)
        {
            this.UserId = userId;

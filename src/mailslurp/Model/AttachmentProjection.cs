...
namespace mailslurp.Model
{
    ...
    public partial class AttachmentProjection : IValidatableObject
    {
        ...
        public AttachmentProjection(string name = default, Guid id = default, long? contentLength = default, Guid userId = default, Guid inboxId = default, DateTime updatedAt = default, DateTime createdAt = default, string contentId = default, string attachmentId = default, string contentType = default)
        {
            this.Id = id;
            this.UserId = userId;

...
namespace mailslurp.Model
{
    ...
    public partial class AttachmentProjection : IValidatableObject
    {
        ...
        public AttachmentProjection(Guid userId = default, Guid inboxId = default, DateTime createdAt = default, DateTime updatedAt = default, string contentId = default, string attachmentId = default, string name = default, Guid id = default, long? contentLength = default, string contentType = default)
        {
            this.UserId = userId;

...
namespace mailslurp.Model
{
    ...
    public partial class InboxProjection :  IEquatable<InboxProjection>, IValidatableObject
    {
        ...
        public InboxProjection(DateTime createdAt = default(DateTime), string emailAddress = default(string), bool favourite = default(bool), Guid id = default(Guid), string name = default(string), List<string> tags = default(List<string>), bool teamAccess = default(bool))
        {

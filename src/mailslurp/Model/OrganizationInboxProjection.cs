...
namespace mailslurp.Model
{
    ...
    public partial class OrganizationInboxProjection : IValidatableObject
    {
        ...
        public OrganizationInboxProjection(Guid id = default, Guid? domainId = default, DateTime createdAt = default, string name = default, string emailAddress = default, bool favourite = default, List<string> tags = default, bool teamAccess = default, InboxTypeEnum? inboxType = default, bool readOnly = default, bool virtualInbox = default, FunctionsAsEnum? functionsAs = default, Guid userId = default, string description = default, DateTime? expiresAt = default, AccountRegionEnum? accountRegion = default)
        {
            this.Id = id;
            ...
            {
                throw new ArgumentNullException("emailAddress is a required property for OrganizationInboxProjection and cannot be null");
            }

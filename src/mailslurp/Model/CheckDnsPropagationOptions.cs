...
namespace mailslurp.Model
{
    ...
    public partial class CheckDnsPropagationOptions : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckDnsPropagationOptions" /> class.
        /// </summary>
        ...
        public CheckDnsPropagationOptions(string host = default, RecordTypeEnum recordType = default, string expectedValue = default, string captchaToken = default)
        {
            // to ensure "host" is required (not null)
            if (host == null)
            {
                throw new ArgumentNullException("host is a required property for CheckDnsPropagationOptions and cannot be null");
            }
            this.Host = host;

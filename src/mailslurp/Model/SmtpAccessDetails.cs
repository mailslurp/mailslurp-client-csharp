...
namespace mailslurp.Model
{
    ...
    public partial class SmtpAccessDetails : IValidatableObject
    {
        ...
        public SmtpAccessDetails(string secureSmtpServerHost = default, int secureSmtpServerPort = default, string secureSmtpUsername = default, string secureSmtpPassword = default, string smtpServerHost = default, int smtpServerPort = default, string smtpUsername = default, string smtpPassword = default, string mailFromDomain = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class PageBouncedEmail : IValidatableObject
    {
        ...
        public PageBouncedEmail(List<BounceProjection> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int size = default, int number = default, int numberOfElements = default, SortObject sort = default, bool first = default, bool empty = default)
        {

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageEntityEventItems")]
    public partial class PageEntityEventItems : IValidatableObject
    {
        ...
        protected PageEntityEventItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageEntityEventItems" /> class.
        /// </summary>
        ...
        public PageEntityEventItems(List<EntityEventItemProjection> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<EntityEventItemProjection> Content { get; set; }

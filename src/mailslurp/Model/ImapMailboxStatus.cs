...
namespace mailslurp.Model
{
    ...
    public partial class ImapMailboxStatus : IValidatableObject
    {
        ...
        public ImapMailboxStatus(string name = default, bool readOnly = default, Object items = default, List<string> flags = default, List<string> permanentFlags = default, long unseenSeqNum = default, int messages = default, int recent = default, int unseen = default, long uidNext = default, int uidValidity = default, int? appendLimit = default)
        {

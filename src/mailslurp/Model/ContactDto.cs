...
namespace mailslurp.Model
{
    ...
    public partial class ContactDto :  IEquatable<ContactDto>
    {
        ...
        public ContactDto(string company = default(string), List<string> emailAddresses = default(List<string>), string firstName = default(string), Guid id = default(Guid), string lastName = default(string), JsonNode metaData = default(JsonNode), bool optOut = default(bool), List<string> tags = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("emailAddresses is a required property for ContactDto and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ContactDto and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (tags == null)
            {
                throw new InvalidDataException("tags is a required property for ContactDto and cannot be null");
            }
            else
            {
                this.Tags = tags;

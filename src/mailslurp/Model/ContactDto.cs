...
namespace mailslurp.Model
{
    ...
    public partial class ContactDto :  IEquatable<ContactDto>, IValidatableObject
    {
        ...
        public ContactDto(string company = default(string), DateTime createdAt = default(DateTime), List<string> emailAddresses = default(List<string>), string firstName = default(string), Guid groupId = default(Guid), Guid id = default(Guid), string lastName = default(string), Object metaData = default(Object), bool optOut = default(bool), List<string> tags = default(List<string>))
        {

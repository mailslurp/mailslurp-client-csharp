...
namespace mailslurp.Model
{
    ...
    public partial class OptInSendingConsentDto : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="OptInSendingConsentDto" /> class.
        /// </summary>
        /// <param name="verificationCodeSent">verificationCodeSent (required).</param>
        /// <param name="userHasConsented">userHasConsented (required).</param>
        /// <param name="canSend">canSend (required).</param>
        public OptInSendingConsentDto(bool verificationCodeSent = default, bool userHasConsented = default, bool canSend = default)
        {

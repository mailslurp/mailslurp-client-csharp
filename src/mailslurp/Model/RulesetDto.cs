...
namespace mailslurp.Model
{
    ...
    public partial class RulesetDto : IValidatableObject
    {
        /// <summary>
        /// Defines Scope
        /// </summary>
        ...
        public enum ScopeEnum
        {
            ...
            /// <summary>
            /// Enum RECEIVINGSMS for value: RECEIVING_SMS
            /// </summary>
            [EnumMember(Value = "RECEIVING_SMS")]
            RECEIVINGSMS = 3,

            /// <summary>
            /// Enum SENDINGSMS for value: SENDING_SMS
            /// </summary>
            [EnumMember(Value = "SENDING_SMS")]
            SENDINGSMS = 4
        }
        ...
        public enum ActionEnum
        {
            ...
            /// <summary>
            /// Enum BOUNCESOFT for value: BOUNCE_SOFT
            /// </summary>
            [EnumMember(Value = "BOUNCE_SOFT")]
            BOUNCESOFT = 4,

            /// <summary>
            /// Enum BOUNCEHARD for value: BOUNCE_HARD
            /// </summary>
            [EnumMember(Value = "BOUNCE_HARD")]
            BOUNCEHARD = 5
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RulesetDto" /> class.
        /// </summary>
        ...
        public RulesetDto(Guid id = default, Guid? inboxId = default, Guid? phoneId = default, ScopeEnum scope = default, ActionEnum action = default, string target = default, HandlerEnum handler = default, DateTime createdAt = default)
        {
            this.Id = id;
            this.Scope = scope;
            this.Action = action;
            ...
            if (target == null)
            {
                throw new ArgumentNullException("target is a required property for RulesetDto and cannot be null");
            }
            this.Target = target;

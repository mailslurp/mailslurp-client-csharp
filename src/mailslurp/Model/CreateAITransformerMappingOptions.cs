...
namespace mailslurp.Model
{
    ...
    public partial class CreateAITransformerMappingOptions : IValidatableObject
    {
        ...
        public CreateAITransformerMappingOptions(string name = default, Guid aiTransformId = default, Guid? entityId = default, EntityTypeEnum entityType = default, ContentSelectorEnum? contentSelector = default, TriggerSelectorEnum? triggerSelector = default, bool? spreadRootArray = default, AIMappingMatchOptions matchOptions = default)
        {

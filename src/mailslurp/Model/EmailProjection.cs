...
namespace mailslurp.Model
{
    ...
    public partial class EmailProjection : IValidatableObject
    {
        ...
        public EmailProjection(string subject = default, Guid inboxId = default, List<string> attachments = default, Sender sender = default, EmailRecipients recipients = default, long? sizeBytes = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, string messageId = default, Guid? domainId = default, bool? favourite = default, Guid? plusAddress = default, long? imapUid = default, string inReplyTo = default, bool read = default, string bodyExcerpt = default, string textExcerpt = default, List<string> bodyPartContentTypes = default, string bodyMD5Hash = default, bool teamAccess = default, Guid id = default, Guid? threadId = default, string from = default)
        {

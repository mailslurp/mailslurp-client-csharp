...
namespace mailslurp.Model
{
    ...
    public partial class EmailProjection : IValidatableObject
    {
        ...
        /// <param name="imapUid">imapUid.</param>
        ...
        public EmailProjection(Guid id = default, Guid? threadId = default, string from = default, string subject = default, Sender sender = default, EmailRecipients recipients = default, Guid inboxId = default, List<string> attachments = default, long? sizeBytes = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, string messageId = default, bool? favourite = default, Guid? domainId = default, Guid? plusAddress = default, long? imapUid = default, string inReplyTo = default, bool read = default, string bodyExcerpt = default, string textExcerpt = default, List<string> bodyPartContentTypes = default, string bodyMD5Hash = default, bool teamAccess = default)
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets ImapUid
        /// </summary>
        [DataMember(Name = "imapUid", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ImapUid: ").Append(ImapUid).Append("\n");

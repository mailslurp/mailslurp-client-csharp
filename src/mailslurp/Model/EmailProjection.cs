...
namespace mailslurp.Model
{
    ...
    public partial class EmailProjection : IValidatableObject
    {
        ...
        public EmailProjection(string subject = default, long? sizeBytes = default, string messageId = default, bool? favourite = default, Guid? domainId = default, List<string> attachments = default, Guid inboxId = default, DateTime createdAt = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, Sender sender = default, EmailRecipients recipients = default, Guid? plusAddress = default, long? imapUid = default, string inReplyTo = default, bool read = default, string bodyExcerpt = default, string textExcerpt = default, List<string> bodyPartContentTypes = default, string bodyMD5Hash = default, bool teamAccess = default, Guid id = default, Guid? threadId = default, string from = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class PageDeliveryStatus : IValidatableObject
    {
        ...
        public PageDeliveryStatus(List<DeliveryStatusDto> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int size = default, int number = default, int numberOfElements = default, SortObject sort = default, bool first = default, bool empty = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class PageDeliveryStatus : IValidatableObject
    {
        ...
        public PageDeliveryStatus(List<DeliveryStatusDto> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {

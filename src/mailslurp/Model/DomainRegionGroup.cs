...
namespace mailslurp.Model
{
    ...
    public partial class DomainRegionGroup : IValidatableObject
    {
        /// <summary>
        /// Defines Label
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainRegionGroup" /> class.
        /// </summary>
        ...
        public DomainRegionGroup(LabelEnum label = default, List<DomainRegionInformation> domains = default)
        {
            this.Label = label;
            // to ensure "domains" is required (not null)
            if (domains == null)
            {
                throw new ArgumentNullException("domains is a required property for DomainRegionGroup and cannot be null");
            }

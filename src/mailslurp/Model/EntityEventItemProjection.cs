...
namespace mailslurp.Model
{
    ...
    public partial class EntityEventItemProjection : IValidatableObject
    {
        ...
        public EntityEventItemProjection(Guid phoneId = default, Guid inboxId = default, EventTypeEnum eventType = default, Guid id = default, SeverityEnum severity = default)
        {

...
namespace mailslurp.Model
{
    ...
    public partial class EntityEventItemProjection : IValidatableObject
    {
        ...
        public EntityEventItemProjection(Guid id = default, SeverityEnum severity = default, EventTypeEnum eventType = default, Guid inboxId = default, Guid phoneId = default)
        {
            this.Id = id;

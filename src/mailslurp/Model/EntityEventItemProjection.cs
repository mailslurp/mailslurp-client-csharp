...
namespace mailslurp.Model
{
    ...
    public partial class EntityEventItemProjection : IValidatableObject
    {
        ...
        public EntityEventItemProjection(Guid inboxId = default, EventTypeEnum eventType = default, Guid phoneId = default, Guid id = default, SeverityEnum severity = default)
        {

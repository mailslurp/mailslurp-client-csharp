...
namespace mailslurp.Model
{
    ...
    /// RecipientProjection
    /// </summary>
    [DataContract(Name = "RecipientProjection")]
    public partial class RecipientProjection : IValidatableObject
    {
        ...
        public RecipientProjection(string emailAddress = default, string rawValue = default, string name = default)
        {
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for RecipientProjection and cannot be null");
            }
            this.EmailAddress = emailAddress;
            // to ensure "rawValue" is required (not null)
            if (rawValue == null)
            {
                throw new ArgumentNullException("rawValue is a required property for RecipientProjection and cannot be null");
            }

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageConnectorEvents")]
    public partial class PageConnectorEvents : IValidatableObject
    {
        ...
        public PageConnectorEvents(List<ConnectorEventProjection> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<ConnectorEventProjection> Content { get; set; }

...
namespace mailslurp.Model
{
    ...
    public partial class ForwardEmailOptions :  IEquatable<ForwardEmailOptions>, IValidatableObject
    {
        ...
        public ForwardEmailOptions(List<string> bcc = default(List<string>), List<string> cc = default(List<string>), string subject = default(string), List<string> to = default(List<string>))
        {
            this.Bcc = bcc;
            this.Cc = cc;

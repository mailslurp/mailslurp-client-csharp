...
namespace mailslurp.Model
{
    ...
    /// </summary>
    public partial class GenerateBimiRecordResults : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public GenerateBimiRecordResults(string name, TypeEnum type, int ttl, string value)
        {
            Name = name;
            Type = type;
            Ttl = ttl;
    ...
    /// <summary>
    /// A Json converter for type <see cref="GenerateBimiRecordResults" />
    /// </summary>
    public class GenerateBimiRecordResultsJsonConverter : JsonConverter<GenerateBimiRecordResults>
    {
        /// <summary>
        /// Deserializes json to <see cref="GenerateBimiRecordResults" />
        /// </summary>
        ...
        public override GenerateBimiRecordResults Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GenerateBimiRecordResults.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<GenerateBimiRecordResults.TypeEnum?>(GenerateBimiRecordResults.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "ttl":
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class GenerateBimiRecordResults.", nameof(name));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class GenerateBimiRecordResults.", nameof(type));

            if (!ttl.IsSet)
                throw new ArgumentException("Property is required for class GenerateBimiRecordResults.", nameof(ttl));

            if (!value.IsSet)
                throw new ArgumentException("Property is required for class GenerateBimiRecordResults.", nameof(value));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class GenerateBimiRecordResults.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class GenerateBimiRecordResults.");

            if (ttl.IsSet && ttl.Value == null)
                throw new ArgumentNullException(nameof(ttl), "Property is not nullable for class GenerateBimiRecordResults.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class GenerateBimiRecordResults.");

            return new GenerateBimiRecordResults(name.Value, type.Value.Value, ttl.Value.Value, value.Value);
        }

        /// <summary>
        /// Serializes a <see cref="GenerateBimiRecordResults" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateBimiRecordResults"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GenerateBimiRecordResults generateBimiRecordResults, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, generateBimiRecordResults, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GenerateBimiRecordResults" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateBimiRecordResults"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GenerateBimiRecordResults generateBimiRecordResults, JsonSerializerOptions jsonSerializerOptions)
        {
            if (generateBimiRecordResults.Name == null)
                throw new ArgumentNullException(nameof(generateBimiRecordResults.Name), "Property is required for class GenerateBimiRecordResults.");

            if (generateBimiRecordResults.Value == null)
                throw new ArgumentNullException(nameof(generateBimiRecordResults.Value), "Property is required for class GenerateBimiRecordResults.");

            writer.WriteString("name", generateBimiRecordResults.Name);

            var typeRawValue = GenerateBimiRecordResults.TypeEnumToJsonValue(generateBimiRecordResults.Type);
            writer.WriteString("type", typeRawValue);
            writer.WriteNumber("ttl", generateBimiRecordResults.Ttl);

            writer.WriteString("value", generateBimiRecordResults.Value);
        }
    }
}

...
namespace mailslurp.Model
{
    ...
    public partial class PageConnector : IValidatableObject
    {
        ...
        public PageConnector(List<ConnectorProjection> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int size = default, int number = default, bool first = default, int numberOfElements = default, SortObject sort = default, bool empty = default)
        {

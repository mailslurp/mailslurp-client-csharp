...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagePlusAddressProjection")]
    public partial class PagePlusAddressProjection : IValidatableObject
    {
        ...
        protected PagePlusAddressProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePlusAddressProjection" /> class.
        /// </summary>
        ...
        public PagePlusAddressProjection(List<PlusAddressProjection> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<PlusAddressProjection> Content { get; set; }

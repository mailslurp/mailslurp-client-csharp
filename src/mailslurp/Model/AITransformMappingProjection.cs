...
namespace mailslurp.Model
{
    ...
    public partial class AITransformMappingProjection : IValidatableObject
    {
        ...
        public AITransformMappingProjection(Guid userId = default, Guid aiTransformId = default, Guid entityId = default, EntityTypeEnum entityType = default, ContentSelectorEnum? contentSelector = default, TriggerSelectorEnum? triggerSelector = default, string name = default, Guid id = default)
        {
            this.UserId = userId;

...
namespace mailslurp.Model
{
    ...
    public partial class AITransformMappingProjection : IValidatableObject
    {
        ...
        public AITransformMappingProjection(Guid userId = default, DateTime createdAt = default, EntityTypeEnum entityType = default, Guid aiTransformId = default, Guid entityId = default, ContentSelectorEnum? contentSelector = default, TriggerSelectorEnum? triggerSelector = default, string name = default, Guid id = default)
        {
            this.UserId = userId;

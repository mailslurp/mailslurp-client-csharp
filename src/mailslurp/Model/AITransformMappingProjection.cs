...
namespace mailslurp.Model
{
    ...
    public partial class AITransformMappingProjection : IValidatableObject
    {
        ...
        public AITransformMappingProjection(string name = default, Guid id = default, Guid userId = default, DateTime createdAt = default, EntityTypeEnum entityType = default, Guid aiTransformId = default, Guid entityId = default, ContentSelectorEnum? contentSelector = default, TriggerSelectorEnum? triggerSelector = default)
        {
            this.Id = id;
            this.UserId = userId;

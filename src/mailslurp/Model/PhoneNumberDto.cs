...
namespace mailslurp.Model
{
    ...
    public partial class PhoneNumberDto : IValidatableObject
    {
        ...
        public PhoneNumberDto(Guid id = default, string name = default, string description = default, List<string> tags = default, Guid userId = default, Guid complianceAddress = default, Guid emergencyAddress = default, string phoneNumber = default, PhoneCountryEnum phoneCountry = default, Guid phonePlan = default, DateTime createdAt = default, DateTime updatedAt = default, bool favourite = default, PhoneVariantEnum? phoneVariant = default, string lineType = default, string carrierName = default, string mobileCountryCode = default, string mobileNetworkCode = default, string providerLabel = default)
        {
            this.Id = id;
            // to ensure "tags" is required (not null)
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for PhoneNumberDto and cannot be null");
            }
            this.Tags = tags;
            this.UserId = userId;

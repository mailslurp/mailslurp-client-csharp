...
namespace mailslurp.Model
{
    ...
    public partial class AITransformMappingDto : IValidatableObject
    {
        ...
        public AITransformMappingDto(Guid id = default, Guid aiTransformId = default, AIMappingMatchOptions matchOptions = default, Guid userId = default, string name = default, Guid entityId = default, EntityTypeEnum entityType = default, DateTime createdAt = default)
        {
            this.Id = id;

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageInboxTags")]
    public partial class PageInboxTags : IValidatableObject
    {
        ...
        public PageInboxTags(List<string> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {

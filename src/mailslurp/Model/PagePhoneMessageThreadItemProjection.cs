...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagePhoneMessageThreadItemProjection")]
    public partial class PagePhoneMessageThreadItemProjection : IValidatableObject
    {
        ...
        protected PagePhoneMessageThreadItemProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePhoneMessageThreadItemProjection" /> class.
        /// </summary>
        ...
        public PagePhoneMessageThreadItemProjection(List<PhoneMessageThreadItemProjection> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<PhoneMessageThreadItemProjection> Content { get; set; }

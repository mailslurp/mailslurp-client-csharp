...
namespace mailslurp.Model
{
    ...
    public partial class InboxForwarderEventProjection : IValidatableObject
    {
        ...
        public InboxForwarderEventProjection(Guid? userId = default, Guid? emailId = default, Guid? inboxId = default, DateTime createdAt = default, Guid? sentId = default, Guid? forwarderId = default, string message = default, Guid? id = default, StatusEnum? status = default)
        {

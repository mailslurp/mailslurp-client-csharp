...
namespace mailslurp.Model
{
    ...
    public partial class InboxForwarderEventProjection : IValidatableObject
    {
        ...
        public InboxForwarderEventProjection(Guid? emailId = default, Guid? inboxId = default, Guid? userId = default, DateTime createdAt = default, Guid? sentId = default, Guid? forwarderId = default, string message = default, Guid? id = default, StatusEnum? status = default)
        {

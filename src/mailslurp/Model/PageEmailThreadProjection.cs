...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageEmailThreadProjection")]
    public partial class PageEmailThreadProjection : IValidatableObject
    {
        ...
        protected PageEmailThreadProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageEmailThreadProjection" /> class.
        /// </summary>
        ...
        public PageEmailThreadProjection(List<EmailThreadProjection> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<EmailThreadProjection> Content { get; set; }

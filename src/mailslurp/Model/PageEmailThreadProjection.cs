...
namespace mailslurp.Model
{
    ...
    public partial class PageEmailThreadProjection : IValidatableObject
    {
        ...
        public PageEmailThreadProjection(List<EmailThreadProjection> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {

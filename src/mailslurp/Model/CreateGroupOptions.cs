...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateGroupOptions :  IEquatable<CreateGroupOptions>
    {
        /// <summary>
        ...
        public CreateGroupOptions(string name = default(string), string description = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateGroupOptions and cannot be null");
            }
            else
            {
                this.Name = name;

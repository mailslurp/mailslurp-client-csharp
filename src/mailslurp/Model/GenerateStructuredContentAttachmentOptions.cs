...
namespace mailslurp.Model
{
    ...
    public partial class GenerateStructuredContentAttachmentOptions : IValidatableObject
    {
        ...
        public GenerateStructuredContentAttachmentOptions(string attachmentId = default, string instructions = default, StructuredOutputSchema outputSchema = default)
        {
            ...
            {
                throw new ArgumentNullException("outputSchema is a required property for GenerateStructuredContentAttachmentOptions and cannot be null");
            }

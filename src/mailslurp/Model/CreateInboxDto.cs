...
namespace mailslurp.Model
{
    ...
    public partial class CreateInboxDto :  IEquatable<CreateInboxDto>, IValidatableObject
    {
        ...
        public CreateInboxDto(string description = default(string), string emailAddress = default(string), DateTime expiresAt = default(DateTime), bool favourite = default(bool), string name = default(string), List<string> tags = default(List<string>), bool useDomainPool = default(bool))
        {

...
namespace mailslurp.Model
{
    ...
    public partial class PageAttachmentEntity : IValidatableObject
    {
        ...
        public PageAttachmentEntity(List<AttachmentProjection> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, SortObject sort = default, bool first = default, int size = default, int number = default, bool empty = default)
        {

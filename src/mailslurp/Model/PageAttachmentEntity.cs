...
namespace mailslurp.Model
{
    ...
    public partial class PageAttachmentEntity :  IEquatable<PageAttachmentEntity>, IValidatableObject
    {
        ...
        public List<AttachmentEntity> Content { get; set; }

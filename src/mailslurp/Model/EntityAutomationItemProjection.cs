...
namespace mailslurp.Model
{
    ...
    public partial class EntityAutomationItemProjection : IValidatableObject
    {
        ...
        public EntityAutomationItemProjection(Guid inboxId = default, string action = default, Guid phoneId = default, AutomationTypeEnum automationType = default, string name = default, Guid id = default)
        {

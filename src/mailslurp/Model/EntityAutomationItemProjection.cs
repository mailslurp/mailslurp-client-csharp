...
namespace mailslurp.Model
{
    ...
    public partial class EntityAutomationItemProjection : IValidatableObject
    {
        ...
        public EntityAutomationItemProjection(Guid phoneId = default, Guid inboxId = default, string action = default, AutomationTypeEnum automationType = default, string name = default, Guid id = default)
        {

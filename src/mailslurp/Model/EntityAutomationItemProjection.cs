...
namespace mailslurp.Model
{
    ...
    public partial class EntityAutomationItemProjection : IValidatableObject
    {
        ...
        public EntityAutomationItemProjection(string name = default, Guid id = default, Guid inboxId = default, Guid phoneId = default, string action = default, AutomationTypeEnum automationType = default)
        {
            this.Id = id;

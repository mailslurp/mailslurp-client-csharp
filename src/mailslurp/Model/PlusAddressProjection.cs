...
namespace mailslurp.Model
{
    ...
    public partial class PlusAddressProjection : IValidatableObject
    {
        ...
        public PlusAddressProjection(Guid id = default, Guid userId = default, Guid inboxId = default, DateTime updatedAt = default, DateTime createdAt = default, string plusAddress = default, string fullAddress = default)
        {
            this.Id = id;
            this.UserId = userId;

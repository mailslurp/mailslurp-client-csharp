...
namespace mailslurp.Model
{
    ...
    public partial class PlusAddressProjection : IValidatableObject
    {
        ...
        public PlusAddressProjection(Guid userId = default, Guid inboxId = default, DateTime createdAt = default, DateTime updatedAt = default, string plusAddress = default, string fullAddress = default, Guid id = default)
        {
            this.UserId = userId;

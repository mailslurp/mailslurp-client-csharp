...
namespace mailslurp.Model
{
    ...
    public partial class PlusAddressProjection : IValidatableObject
    {
        ...
        public PlusAddressProjection(DateTime updatedAt = default, Guid userId = default, Guid inboxId = default, DateTime createdAt = default, string plusAddress = default, string fullAddress = default, Guid id = default)
        {

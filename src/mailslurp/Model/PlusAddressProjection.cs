...
namespace mailslurp.Model
{
    ...
    public partial class PlusAddressProjection : IValidatableObject
    {
        ...
        public PlusAddressProjection(Guid inboxId = default, Guid userId = default, DateTime updatedAt = default, DateTime createdAt = default, string plusAddress = default, string fullAddress = default, Guid id = default)
        {

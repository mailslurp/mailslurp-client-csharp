...
namespace mailslurp.Model
{
    ...
    public partial class ConnectorEventProjection : IValidatableObject
    {
        ...
        public ConnectorEventProjection(string message = default, Guid id = default, long size = default, EventTypeEnum eventType = default, DateTime createdAt = default, Guid connectorId = default, bool seen = default, StatusEnum status = default)
        {
            this.Size = size;

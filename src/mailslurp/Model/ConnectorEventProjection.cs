...
namespace mailslurp.Model
{
    ...
    public partial class ConnectorEventProjection : IValidatableObject
    {
        ...
        public ConnectorEventProjection(DateTime createdAt = default, EventTypeEnum eventType = default, Guid connectorId = default, bool seen = default, string message = default, Guid id = default, long size = default, StatusEnum status = default)
        {

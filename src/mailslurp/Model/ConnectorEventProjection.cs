...
namespace mailslurp.Model
{
    ...
    public partial class ConnectorEventProjection : IValidatableObject
    {
        ...
        public ConnectorEventProjection(string message = default, Guid id = default, long size = default, StatusEnum status = default, EventTypeEnum eventType = default, DateTime createdAt = default, Guid connectorId = default, bool seen = default)
        {
            this.Size = size;
            this.Status = status;

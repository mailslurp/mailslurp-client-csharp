...
namespace mailslurp.Model
{
    ...
    public partial class PageExpiredInboxRecordProjection : IValidatableObject
    {
        ...
        public PageExpiredInboxRecordProjection(List<ExpiredInboxRecordProjection> content = default, PageableObject pageable = default, int totalPages = default, long totalElements = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {

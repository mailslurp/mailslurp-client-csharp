...
namespace mailslurp.Model
{
    ...
    public partial class DomainDto :  IEquatable<DomainDto>, IValidatableObject
    {
        ...
        /// <param name="dkimTokens">DNS records for DKIM approval.</param>
        ...
        /// <param name="verificationToken">A TXT record that you must place in the DNS settings of the domain to complete domain verification.</param>
        public DomainDto(DateTime createdAt = default(DateTime), List<string> dkimTokens = default(List<string>), string domain = default(string), Guid id = default(Guid), bool isVerified = default(bool), DateTime updatedAt = default(DateTime), Guid userId = default(Guid), string verificationToken = default(string))
        {
        ...
        /// </summary>
        /// <value>DNS records for DKIM approval</value>
        ...
        /// </summary>
        /// <value>A TXT record that you must place in the DNS settings of the domain to complete domain verification</value>

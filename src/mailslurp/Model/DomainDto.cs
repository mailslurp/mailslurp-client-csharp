...
namespace mailslurp.Model
{
    ...
    public partial class DomainDto :  IEquatable<DomainDto>, IValidatableObject
    {
        ...
        public DomainDto(DateTime createdAt = default(DateTime), List<string> dkimTokens = default(List<string>), string domain = default(string), List<DomainNameRecord> domainNameRecords = default(List<DomainNameRecord>), Guid id = default(Guid), bool isVerified = default(bool), DateTime updatedAt = default(DateTime), Guid userId = default(Guid), string verificationToken = default(string))
        {

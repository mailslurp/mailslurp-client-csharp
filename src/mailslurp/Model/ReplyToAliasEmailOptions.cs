...
namespace mailslurp.Model
{
    ...
    public partial class ReplyToAliasEmailOptions : IValidatableObject
    {
        ...
        public ReplyToAliasEmailOptions(string body = default, bool isHTML = default, string charset = default, List<string> attachments = default, Dictionary<string, Object> templateVariables = default, Guid? template = default, SendStrategyEnum? sendStrategy = default, Dictionary<string, string> customHeaders = default, bool? useInboxName = default, bool html = default)
        {

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageAITransformResultProjection")]
    public partial class PageAITransformResultProjection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAITransformResultProjection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PageAITransformResultProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAITransformResultProjection" /> class.
        /// </summary>
        ...
        public PageAITransformResultProjection(List<AITransformResultProjectionDto> content = default, PageableObject pageable = default, List<string> columns = default, int totalPages = default, long totalElements = default, bool last = default, int size = default, int number = default, bool first = default, int numberOfElements = default, SortObject sort = default, bool empty = default)
        {
            // to ensure "columns" is required (not null)
            if (columns == null)
            {
                throw new ArgumentNullException("columns is a required property for PageAITransformResultProjection and cannot be null");
            }
        ...
        public List<AITransformResultProjectionDto> Content { get; set; }

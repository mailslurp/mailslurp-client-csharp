...
namespace mailslurp.Model
{
    ...
    public partial class PageAITransformResultProjection : IValidatableObject
    {
        ...
        public PageAITransformResultProjection(List<AITransformResultProjectionDto> content = default, PageableObject pageable = default, List<string> columns = default, int totalPages = default, long totalElements = default, bool last = default, int size = default, int number = default, int numberOfElements = default, SortObject sort = default, bool first = default, bool empty = default)
        {

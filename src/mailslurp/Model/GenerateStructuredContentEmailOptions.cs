...
namespace mailslurp.Model
{
    ...
    public partial class GenerateStructuredContentEmailOptions : IValidatableObject
    {
        ...
        /// <param name="outputSchema">outputSchema (required).</param>
        public GenerateStructuredContentEmailOptions(Guid emailId = default, ContentSelectorEnum? contentSelector = default, string instructions = default, StructuredOutputSchema outputSchema = default)
        {
            this.EmailId = emailId;
            // to ensure "outputSchema" is required (not null)
            if (outputSchema == null)
            {
                throw new ArgumentNullException("outputSchema is a required property for GenerateStructuredContentEmailOptions and cannot be null");
            }

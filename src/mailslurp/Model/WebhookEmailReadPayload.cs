...
namespace mailslurp.Model
{
    ...
    public partial class WebhookEmailReadPayload : IValidatableObject
    {
        ...
        public WebhookEmailReadPayload(string messageId = default, Guid webhookId = default, EventNameEnum eventName = default, string webhookName = default, Guid emailId = default, Guid inboxId = default, bool emailIsRead = default, DateTime createdAt = default)
        {

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    public partial class WebhookEmailReadPayload : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public WebhookEmailReadPayload(string messageId, Guid webhookId, EventNameEnum eventName, Guid emailId, Guid inboxId, bool emailIsRead, DateTime createdAt, Option<string> webhookName = default)
        {
            MessageId = messageId;
            WebhookId = webhookId;
            EventName = eventName;
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookEmailReadPayload" />
    /// </summary>
    public class WebhookEmailReadPayloadJsonConverter : JsonConverter<WebhookEmailReadPayload>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="WebhookEmailReadPayload" />
        /// </summary>
        ...
        public override WebhookEmailReadPayload Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WebhookEmailReadPayload.EventNameEnum?> eventName = default;
            Option<Guid?> emailId = default;
            Option<Guid?> inboxId = default;
            Option<bool?> emailIsRead = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "eventName":
                            ...
                            if (eventNameRawValue != null)
                                eventName = new Option<WebhookEmailReadPayload.EventNameEnum?>(WebhookEmailReadPayload.EventNameEnumFromStringOrDefault(eventNameRawValue));
                            break;
                        case "emailId":
                        ...
                        case "inboxId":
                            ...
                            break;
                        case "emailIsRead":
                            emailIsRead = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        case "createdAt":
            ...
            if (!messageId.IsSet)
                throw new ArgumentException("Property is required for class WebhookEmailReadPayload.", nameof(messageId));

            if (!webhookId.IsSet)
                throw new ArgumentException("Property is required for class WebhookEmailReadPayload.", nameof(webhookId));

            if (!eventName.IsSet)
                throw new ArgumentException("Property is required for class WebhookEmailReadPayload.", nameof(eventName));

            if (!emailId.IsSet)
                throw new ArgumentException("Property is required for class WebhookEmailReadPayload.", nameof(emailId));

            if (!inboxId.IsSet)
                throw new ArgumentException("Property is required for class WebhookEmailReadPayload.", nameof(inboxId));

            if (!emailIsRead.IsSet)
                throw new ArgumentException("Property is required for class WebhookEmailReadPayload.", nameof(emailIsRead));

            if (!createdAt.IsSet)
                throw new ArgumentException("Property is required for class WebhookEmailReadPayload.", nameof(createdAt));

            if (messageId.IsSet && messageId.Value == null)
                throw new ArgumentNullException(nameof(messageId), "Property is not nullable for class WebhookEmailReadPayload.");

            if (webhookId.IsSet && webhookId.Value == null)
                throw new ArgumentNullException(nameof(webhookId), "Property is not nullable for class WebhookEmailReadPayload.");

            if (eventName.IsSet && eventName.Value == null)
                throw new ArgumentNullException(nameof(eventName), "Property is not nullable for class WebhookEmailReadPayload.");

            if (emailId.IsSet && emailId.Value == null)
                throw new ArgumentNullException(nameof(emailId), "Property is not nullable for class WebhookEmailReadPayload.");

            if (inboxId.IsSet && inboxId.Value == null)
                throw new ArgumentNullException(nameof(inboxId), "Property is not nullable for class WebhookEmailReadPayload.");

            if (emailIsRead.IsSet && emailIsRead.Value == null)
                throw new ArgumentNullException(nameof(emailIsRead), "Property is not nullable for class WebhookEmailReadPayload.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class WebhookEmailReadPayload.");

            return new WebhookEmailReadPayload(messageId.Value, webhookId.Value.Value, eventName.Value.Value, emailId.Value.Value, inboxId.Value.Value, emailIsRead.Value.Value, createdAt.Value.Value, webhookName);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookEmailReadPayload" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEmailReadPayload"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookEmailReadPayload webhookEmailReadPayload, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookEmailReadPayload, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookEmailReadPayload" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEmailReadPayload"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookEmailReadPayload webhookEmailReadPayload, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookEmailReadPayload.MessageId == null)
                throw new ArgumentNullException(nameof(webhookEmailReadPayload.MessageId), "Property is required for class WebhookEmailReadPayload.");

            writer.WriteString("messageId", webhookEmailReadPayload.MessageId);

            writer.WriteString("webhookId", webhookEmailReadPayload.WebhookId);

            var eventNameRawValue = WebhookEmailReadPayload.EventNameEnumToJsonValue(webhookEmailReadPayload.EventName);
            writer.WriteString("eventName", eventNameRawValue);
            writer.WriteString("emailId", webhookEmailReadPayload.EmailId);

            writer.WriteString("inboxId", webhookEmailReadPayload.InboxId);

            writer.WriteBoolean("emailIsRead", webhookEmailReadPayload.EmailIsRead);

            writer.WriteString("createdAt", webhookEmailReadPayload.CreatedAt.ToString(CreatedAtFormat));

            if (webhookEmailReadPayload.WebhookNameOption.IsSet)
                if (webhookEmailReadPayload.WebhookNameOption.Value != null)
                    writer.WriteString("webhookName", webhookEmailReadPayload.WebhookName);
                else

...
namespace mailslurp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageSentSmsProjection")]
    public partial class PageSentSmsProjection : IValidatableObject
    {
        ...
        protected PageSentSmsProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageSentSmsProjection" /> class.
        /// </summary>
        ...
        public PageSentSmsProjection(List<SentSmsProjection> content = default, PageableObject pageable = default, long totalElements = default, int totalPages = default, bool last = default, int numberOfElements = default, bool first = default, int size = default, int number = default, SortObject sort = default, bool empty = default)
        {
        ...
        public List<SentSmsProjection> Content { get; set; }

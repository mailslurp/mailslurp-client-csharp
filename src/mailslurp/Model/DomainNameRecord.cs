...
namespace mailslurp.Model
{
    ...
    public partial class DomainNameRecord : IValidatableObject
    {
        ...
        public DomainNameRecord(LabelEnum label = default, bool required = default, RecordTypeEnum recordType = default, string name = default, List<string> recordEntries = default, long ttl = default, List<string> alternativeRecordEntries = default)
        {
            this.Label = label;

...
namespace mailslurp.Model
{
    ...
    public partial class WebhookResultDto : IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets AiTransformerId
        /// </summary>
        [DataMember(Name = "aiTransformerId", EmitDefaultValue = true)]
        public Guid? AiTransformerId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AiTransformerId: ").Append(AiTransformerId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }

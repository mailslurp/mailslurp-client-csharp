...
namespace mailslurp.Api
{
    ...
    public partial class EmailVerificationControllerApi : IEmailVerificationControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<PageEmailValidationRequest> localVarResponse = await GetValidationRequestsWithHttpInfoAsync(page, size, sort, searchFilter, since, before, isValid, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<ValidateEmailAddressListResult> localVarResponse = await ValidateEmailAddressListWithHttpInfoAsync(validateEmailAddressListOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

...
namespace mailslurp.Api
{
    ...
    public partial class ApiUserControllerApi : IApiUserControllerApi
    {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of string</returns>
        public mailslurp.Client.ApiResponse<string> GetJsonPropertyAsStringWithHttpInfo(string property, Object body)
        {
        ...
        {
            mailslurp.Client.ApiResponse<string> localVarResponse = await GetJsonPropertyAsStringWithHttpInfoAsync(property, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<string>> GetJsonPropertyAsStringWithHttpInfoAsync(string property, Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'property' is set
            if (property == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'property' when calling ApiUserControllerApi->GetJsonPropertyAsString");

...
namespace mailslurp.Api
{
    ...
    public partial class WaitForControllerApi : IWaitForControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<List<EmailPreview>> localVarResponse = await WaitForWithHttpInfoAsync(waitForConditions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;EmailPreview&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<EmailPreview>>> WaitForWithHttpInfoAsync(WaitForConditions waitForConditions, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'waitForConditions' is set
            if (waitForConditions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'waitForConditions' when calling WaitForControllerApi->WaitFor");
        ...
        {
            mailslurp.Client.ApiResponse<List<EmailPreview>> localVarResponse = await WaitForEmailCountWithHttpInfoAsync(inboxId, count, timeout, unreadOnly, before, since, sort, delay, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<Email> localVarResponse = await WaitForLatestEmailWithHttpInfoAsync(inboxId, timeout, unreadOnly, before, since, sort, delay, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="waitForSingleSmsOptions"></param>
        /// <returns>ApiResponse of SmsDto</returns>
        public mailslurp.Client.ApiResponse<SmsDto> WaitForLatestSmsWithHttpInfo(WaitForSingleSmsOptions waitForSingleSmsOptions)
        {
        ...
        {
            mailslurp.Client.ApiResponse<SmsDto> localVarResponse = await WaitForLatestSmsWithHttpInfoAsync(waitForSingleSmsOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SmsDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<SmsDto>> WaitForLatestSmsWithHttpInfoAsync(WaitForSingleSmsOptions waitForSingleSmsOptions, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'waitForSingleSmsOptions' is set
            if (waitForSingleSmsOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'waitForSingleSmsOptions' when calling WaitForControllerApi->WaitForLatestSms");
        ...
        public async System.Threading.Tasks.Task<List<EmailPreview>> WaitForMatchingEmailsAsync(Guid inboxId, int count, MatchOptions matchOptions, DateTime? before = default(DateTime?), DateTime? since = default(DateTime?), string sort = default(string), long? delay = default(long?), long? timeout = default(long?), bool? unreadOnly = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp.Client.ApiResponse<List<EmailPreview>> localVarResponse = await WaitForMatchingEmailsWithHttpInfoAsync(inboxId, count, matchOptions, before, since, sort, delay, timeout, unreadOnly, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<Email> localVarResponse = await WaitForMatchingFirstEmailWithHttpInfoAsync(inboxId, matchOptions, timeout, unreadOnly, since, before, sort, delay, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<Email> localVarResponse = await WaitForNthEmailWithHttpInfoAsync(inboxId, index, timeout, unreadOnly, since, before, sort, delay, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="waitForSmsConditions"></param>
        /// <returns>ApiResponse of List&lt;SmsPreview&gt;</returns>
        public mailslurp.Client.ApiResponse<List<SmsPreview>> WaitForSmsWithHttpInfo(WaitForSmsConditions waitForSmsConditions)
        {
        ...
        {
            mailslurp.Client.ApiResponse<List<SmsPreview>> localVarResponse = await WaitForSmsWithHttpInfoAsync(waitForSmsConditions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;SmsPreview&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<SmsPreview>>> WaitForSmsWithHttpInfoAsync(WaitForSmsConditions waitForSmsConditions, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'waitForSmsConditions' is set
            if (waitForSmsConditions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'waitForSmsConditions' when calling WaitForControllerApi->WaitForSms");

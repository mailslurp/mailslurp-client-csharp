...
namespace mailslurp.Api
{
    ...
    public partial class WaitForControllerApi : IWaitForControllerApi
    {
        ...
        public mailslurp.Client.ApiResponse< List<EmailPreview> > WaitForEmailCountWithHttpInfo (int? count = default(int?), Guid? inboxId = default(Guid?), long? timeout = default(long?), bool? unreadOnly = default(bool?))
        {
            ...
            if (timeout != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "timeout", timeout))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            if (unreadOnly != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "unreadOnly", unreadOnly))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
        ...
        public mailslurp.Client.ApiResponse< Email > WaitForNthEmailWithHttpInfo (Guid? inboxId = default(Guid?), int? index = default(int?), long? timeout = default(long?), bool? unreadOnly = default(bool?))
        {
            ...
            if (index != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "index", index))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);

...
namespace mailslurp.Api
{
    ...
    public interface IWaitForControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<SmsPreview>> WaitForSmsAsync (WaitForSmsConditions waitForSmsConditions);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<SmsPreview>>> WaitForSmsAsyncWithHttpInfo (WaitForSmsConditions waitForSmsConditions);
    ...
    public partial class WaitForControllerApi : IWaitForControllerApi
    {
        ...
        /// <param name="waitForSmsConditions"></param>
        /// <returns>Task of List&lt;SmsPreview&gt;</returns>
        public async System.Threading.Tasks.Task<List<SmsPreview>> WaitForSmsAsync (WaitForSmsConditions waitForSmsConditions)
        {
             mailslurp.Client.ApiResponse<List<SmsPreview>> localVarResponse = await WaitForSmsAsyncWithHttpInfo(waitForSmsConditions);
             return localVarResponse.Data;
        ...
        /// <param name="waitForSmsConditions"></param>
        /// <returns>Task of ApiResponse (List&lt;SmsPreview&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<SmsPreview>>> WaitForSmsAsyncWithHttpInfo (WaitForSmsConditions waitForSmsConditions)
        {
            // verify the required parameter 'waitForSmsConditions' is set
            if (waitForSmsConditions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'waitForSmsConditions' when calling WaitForControllerApi->WaitForSms");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<SmsPreview>>("/waitForSms", localVarRequestOptions, this.Configuration);

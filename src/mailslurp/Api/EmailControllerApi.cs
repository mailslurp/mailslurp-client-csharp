...
namespace mailslurp.Api
{
    ...
    public interface IEmailControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<byte[]>> DownloadAttachmentAsync (Guid emailId, string attachmentId, string apiKey = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<byte[]>>> DownloadAttachmentAsyncWithHttpInfo (Guid emailId, string attachmentId, string apiKey = default(string));
        /// <summary>
        /// Get email attachment as base64 encoded string as an alternative to binary responses. Decode the &#x60;base64FileContents&#x60; as a &#x60;utf-8&#x60; encoded string or array of bytes depending on the &#x60;contentType&#x60;.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="emailId">ID of email</param>
        /// <returns>Task of List&lt;byte[]&gt;</returns>
        System.Threading.Tasks.Task<List<byte[]>> DownloadBodyBytesAsync (Guid emailId);
        ...
        /// <param name="emailId">ID of email</param>
        /// <returns>Task of ApiResponse (List&lt;byte[]&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<byte[]>>> DownloadBodyBytesAsyncWithHttpInfo (Guid emailId);
        /// <summary>
        /// Forward email to recipients
        /// </summary>
        /// <remarks>
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task SendEmailSourceOptionalAsync (SendEmailOptions sendEmailOptions, Guid? inboxId = default(Guid?), bool? useDomainPool = default(bool?));
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> SendEmailSourceOptionalAsyncWithHttpInfo (SendEmailOptions sendEmailOptions, Guid? inboxId = default(Guid?), bool? useDomainPool = default(bool?));
        /// <summary>
        /// Validate email HTML contents
        /// </summary>
        /// <remarks>
    ...
    public partial class EmailControllerApi : IEmailControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = DownloadAttachmentWithHttpInfo(emailId, attachmentId, apiKey);
        ...
        /// <param name="apiKey">Can pass apiKey in url for this request if you wish to download the file in a browser. Content type will be set to original content type of the attachment file. This is so that browsers can download the file correctly. (optional)</param>
        /// <returns>ApiResponse of List&lt;byte[]&gt;</returns>
        public mailslurp.Client.ApiResponse< List<byte[]> > DownloadAttachmentWithHttpInfo (Guid emailId, string attachmentId, string apiKey = default(string))
        {
        ...
        /// <param name="apiKey">Can pass apiKey in url for this request if you wish to download the file in a browser. Content type will be set to original content type of the attachment file. This is so that browsers can download the file correctly. (optional)</param>
        /// <returns>Task of List&lt;byte[]&gt;</returns>
        public async System.Threading.Tasks.Task<List<byte[]>> DownloadAttachmentAsync (Guid emailId, string attachmentId, string apiKey = default(string))
        {
             mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = await DownloadAttachmentAsyncWithHttpInfo(emailId, attachmentId, apiKey);
             return localVarResponse.Data;
        ...
        /// <param name="apiKey">Can pass apiKey in url for this request if you wish to download the file in a browser. Content type will be set to original content type of the attachment file. This is so that browsers can download the file correctly. (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;byte[]&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<byte[]>>> DownloadAttachmentAsyncWithHttpInfo (Guid emailId, string attachmentId, string apiKey = default(string))
        {
            // verify the required parameter 'attachmentId' is set
            if (attachmentId == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'attachmentId' when calling EmailControllerApi->DownloadAttachment");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<byte[]>>("/emails/{emailId}/attachments/{attachmentId}", localVarRequestOptions, this.Configuration);
        ...
        {
             mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = DownloadBodyBytesWithHttpInfo(emailId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="emailId">ID of email</param>
        /// <returns>ApiResponse of List&lt;byte[]&gt;</returns>
        public mailslurp.Client.ApiResponse< List<byte[]> > DownloadBodyBytesWithHttpInfo (Guid emailId)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="emailId">ID of email</param>
        /// <returns>Task of List&lt;byte[]&gt;</returns>
        public async System.Threading.Tasks.Task<List<byte[]>> DownloadBodyBytesAsync (Guid emailId)
        {
             mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = await DownloadBodyBytesAsyncWithHttpInfo(emailId);
             return localVarResponse.Data;
        ...
        /// <param name="emailId">ID of email</param>
        /// <returns>Task of ApiResponse (List&lt;byte[]&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<byte[]>>> DownloadBodyBytesAsyncWithHttpInfo (Guid emailId)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<byte[]>>("/emails/{emailId}/body-bytes", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public mailslurp.Client.ApiResponse<Object> SendEmailSourceOptionalWithHttpInfo (SendEmailOptions sendEmailOptions, Guid? inboxId = default(Guid?), bool? useDomainPool = default(bool?))
        {
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task SendEmailSourceOptionalAsync (SendEmailOptions sendEmailOptions, Guid? inboxId = default(Guid?), bool? useDomainPool = default(bool?))
        {
             await SendEmailSourceOptionalAsyncWithHttpInfo(sendEmailOptions, inboxId, useDomainPool);
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<Object>> SendEmailSourceOptionalAsyncWithHttpInfo (SendEmailOptions sendEmailOptions, Guid? inboxId = default(Guid?), bool? useDomainPool = default(bool?))
        {
            // verify the required parameter 'sendEmailOptions' is set
            if (sendEmailOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'sendEmailOptions' when calling EmailControllerApi->SendEmailSourceOptional");

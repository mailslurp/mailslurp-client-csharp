...
namespace mailslurp.Api
{
    ...
    public interface IEmailControllerApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="decodeHtmlEntities">Decode HTML entities</param>
        ...
        /// <param name="emailId">ID of email to fetch text for</param>
        /// <returns>ApiResponse of EmailTextLinesResult</returns>
        ApiResponse<EmailTextLinesResult> GetEmailTextLinesWithHttpInfo (bool decodeHtmlEntities, Guid emailId);
        /// <summary>
        /// Get all emails
        /// </summary>
        /// <remarks>
    ...
    public interface IEmailControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="emailId">ID of email to fetch text for</param>
        /// <returns>Task of EmailTextLinesResult</returns>
        System.Threading.Tasks.Task<EmailTextLinesResult> GetEmailTextLinesAsync (bool decodeHtmlEntities, Guid emailId);
        ...
        /// <param name="emailId">ID of email to fetch text for</param>
        /// <returns>Task of ApiResponse (EmailTextLinesResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<EmailTextLinesResult>> GetEmailTextLinesAsyncWithHttpInfo (bool decodeHtmlEntities, Guid emailId);
        /// <summary>
        /// Get all emails
        /// </summary>
        /// <remarks>
    ...
    public partial class EmailControllerApi : IEmailControllerApi
    {
        ...
        public mailslurp.Client.ApiResponse< EmailTextLinesResult > GetEmailHTMLQueryWithHttpInfo (Guid emailId, string htmlSelector)
        {
            ...
            localVarRequestOptions.PathParameters.Add("emailId", mailslurp.Client.ClientUtils.ParameterToString(emailId)); // path parameter
            localVarRequestOptions.PathParameters.Add("htmlSelector", mailslurp.Client.ClientUtils.ParameterToString(htmlSelector)); // path parameter
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post< EmailTextLinesResult >("/emails/{emailId}/html-query", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<EmailTextLinesResult>> GetEmailHTMLQueryAsyncWithHttpInfo (Guid emailId, string htmlSelector)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<EmailTextLinesResult>("/emails/{emailId}/html-query", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="emailId">ID of email to fetch text for</param>
        /// <returns>EmailTextLinesResult</returns>
        public EmailTextLinesResult GetEmailTextLines (bool decodeHtmlEntities, Guid emailId)
        {
             mailslurp.Client.ApiResponse<EmailTextLinesResult> localVarResponse = GetEmailTextLinesWithHttpInfo(decodeHtmlEntities, emailId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="emailId">ID of email to fetch text for</param>
        /// <returns>ApiResponse of EmailTextLinesResult</returns>
        public mailslurp.Client.ApiResponse< EmailTextLinesResult > GetEmailTextLinesWithHttpInfo (bool decodeHtmlEntities, Guid emailId)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
            ...
            localVarRequestOptions.PathParameters.Add("decodeHtmlEntities", mailslurp.Client.ClientUtils.ParameterToString(decodeHtmlEntities)); // path parameter
            localVarRequestOptions.PathParameters.Add("emailId", mailslurp.Client.ClientUtils.ParameterToString(emailId)); // path parameter
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post< EmailTextLinesResult >("/emails/{emailId}/text", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="emailId">ID of email to fetch text for</param>
        /// <returns>Task of EmailTextLinesResult</returns>
        public async System.Threading.Tasks.Task<EmailTextLinesResult> GetEmailTextLinesAsync (bool decodeHtmlEntities, Guid emailId)
        {
             mailslurp.Client.ApiResponse<EmailTextLinesResult> localVarResponse = await GetEmailTextLinesAsyncWithHttpInfo(decodeHtmlEntities, emailId);
             return localVarResponse.Data;
        ...
        /// <param name="emailId">ID of email to fetch text for</param>
        /// <returns>Task of ApiResponse (EmailTextLinesResult)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<EmailTextLinesResult>> GetEmailTextLinesAsyncWithHttpInfo (bool decodeHtmlEntities, Guid emailId)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<EmailTextLinesResult>("/emails/{emailId}/text", localVarRequestOptions, this.Configuration);

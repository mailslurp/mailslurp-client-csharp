...
namespace mailslurp.Api
{
    ...
    public interface IEmailControllerApiSync : IApiAccessor
    {
        ...
        ApiResponse<SentEmailDto> ReplyToEmail1WithHttpInfo (Guid emailId, ReplyToEmailOptions replyToEmailOptions);
        /// <summary>
        /// Validate email
        /// </summary>
        /// <remarks>
    ...
    public interface IEmailControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SentEmailDto> ReplyToEmail1Async (Guid emailId, ReplyToEmailOptions replyToEmailOptions);
        ...
        System.Threading.Tasks.Task<ApiResponse<SentEmailDto>> ReplyToEmail1AsyncWithHttpInfo (Guid emailId, ReplyToEmailOptions replyToEmailOptions);
        /// <summary>
        /// Validate email
        /// </summary>
        /// <remarks>
    ...
    public partial class EmailControllerApi : IEmailControllerApi
    {
        ...
        /// <param name="replyToEmailOptions">replyToEmailOptions</param>
        /// <returns>SentEmailDto</returns>
        public SentEmailDto ReplyToEmail1 (Guid emailId, ReplyToEmailOptions replyToEmailOptions)
        {
             mailslurp.Client.ApiResponse<SentEmailDto> localVarResponse = ReplyToEmail1WithHttpInfo(emailId, replyToEmailOptions);
             return localVarResponse.Data;
        }
        ...
        /// <param name="replyToEmailOptions">replyToEmailOptions</param>
        /// <returns>ApiResponse of SentEmailDto</returns>
        public mailslurp.Client.ApiResponse< SentEmailDto > ReplyToEmail1WithHttpInfo (Guid emailId, ReplyToEmailOptions replyToEmailOptions)
        {
            // verify the required parameter 'replyToEmailOptions' is set
            if (replyToEmailOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'replyToEmailOptions' when calling EmailControllerApi->ReplyToEmail1");
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ReplyToEmail1", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="replyToEmailOptions">replyToEmailOptions</param>
        /// <returns>Task of SentEmailDto</returns>
        public async System.Threading.Tasks.Task<SentEmailDto> ReplyToEmail1Async (Guid emailId, ReplyToEmailOptions replyToEmailOptions)
        {
             mailslurp.Client.ApiResponse<SentEmailDto> localVarResponse = await ReplyToEmail1AsyncWithHttpInfo(emailId, replyToEmailOptions);
             return localVarResponse.Data;
        ...
        /// <param name="replyToEmailOptions">replyToEmailOptions</param>
        /// <returns>Task of ApiResponse (SentEmailDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<SentEmailDto>> ReplyToEmail1AsyncWithHttpInfo (Guid emailId, ReplyToEmailOptions replyToEmailOptions)
        {
            // verify the required parameter 'replyToEmailOptions' is set
            if (replyToEmailOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'replyToEmailOptions' when calling EmailControllerApi->ReplyToEmail1");

...
namespace mailslurp.Api
{
    ...
    public interface IEmailControllerApiSync : IApiAccessor
    {
        ...
        /// <returns>EmailTextLinesResult</returns>
        EmailTextLinesResult GetEmailTextLines (Guid emailId, bool? decodeHtmlEntities = default(bool?));
        ...
        /// <param name="decodeHtmlEntities">Decode HTML entities (optional)</param>
        /// <returns>ApiResponse of EmailTextLinesResult</returns>
        ApiResponse<EmailTextLinesResult> GetEmailTextLinesWithHttpInfo (Guid emailId, bool? decodeHtmlEntities = default(bool?));
        /// <summary>
        /// Get all emails
        /// </summary>
        /// <remarks>
    ...
    public interface IEmailControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="decodeHtmlEntities">Decode HTML entities (optional)</param>
        /// <returns>Task of EmailTextLinesResult</returns>
        System.Threading.Tasks.Task<EmailTextLinesResult> GetEmailTextLinesAsync (Guid emailId, bool? decodeHtmlEntities = default(bool?));
        ...
        /// <param name="decodeHtmlEntities">Decode HTML entities (optional)</param>
        /// <returns>Task of ApiResponse (EmailTextLinesResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<EmailTextLinesResult>> GetEmailTextLinesAsyncWithHttpInfo (Guid emailId, bool? decodeHtmlEntities = default(bool?));
        /// <summary>
        /// Get all emails
        /// </summary>
        /// <remarks>
    ...
    public partial class EmailControllerApi : IEmailControllerApi
    {
        ...
        /// <param name="decodeHtmlEntities">Decode HTML entities (optional)</param>
        /// <returns>EmailTextLinesResult</returns>
        public EmailTextLinesResult GetEmailTextLines (Guid emailId, bool? decodeHtmlEntities = default(bool?))
        {
             mailslurp.Client.ApiResponse<EmailTextLinesResult> localVarResponse = GetEmailTextLinesWithHttpInfo(emailId, decodeHtmlEntities);
             return localVarResponse.Data;
        }
        ...
        /// <param name="decodeHtmlEntities">Decode HTML entities (optional)</param>
        /// <returns>ApiResponse of EmailTextLinesResult</returns>
        public mailslurp.Client.ApiResponse< EmailTextLinesResult > GetEmailTextLinesWithHttpInfo (Guid emailId, bool? decodeHtmlEntities = default(bool?))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="decodeHtmlEntities">Decode HTML entities (optional)</param>
        /// <returns>Task of EmailTextLinesResult</returns>
        public async System.Threading.Tasks.Task<EmailTextLinesResult> GetEmailTextLinesAsync (Guid emailId, bool? decodeHtmlEntities = default(bool?))
        {
             mailslurp.Client.ApiResponse<EmailTextLinesResult> localVarResponse = await GetEmailTextLinesAsyncWithHttpInfo(emailId, decodeHtmlEntities);
             return localVarResponse.Data;
        ...
        /// <param name="decodeHtmlEntities">Decode HTML entities (optional)</param>
        /// <returns>Task of ApiResponse (EmailTextLinesResult)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<EmailTextLinesResult>> GetEmailTextLinesAsyncWithHttpInfo (Guid emailId, bool? decodeHtmlEntities = default(bool?))
        {

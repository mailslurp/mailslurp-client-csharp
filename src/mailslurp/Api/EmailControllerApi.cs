...
namespace mailslurp.Api
{
    ...
    public interface IEmailControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task SendEmailSourceOptionalAsync (Guid inboxId, SendEmailOptions sendEmailOptions, bool? useDomainPool = default(bool?));
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> SendEmailSourceOptionalAsyncWithHttpInfo (Guid inboxId, SendEmailOptions sendEmailOptions, bool? useDomainPool = default(bool?));
        /// <summary>
        /// Validate email HTML contents
        /// </summary>
        /// <remarks>
    ...
    public partial class EmailControllerApi : IEmailControllerApi
    {
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public mailslurp.Client.ApiResponse<Object> SendEmailSourceOptionalWithHttpInfo (Guid inboxId, SendEmailOptions sendEmailOptions, bool? useDomainPool = default(bool?))
        {
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task SendEmailSourceOptionalAsync (Guid inboxId, SendEmailOptions sendEmailOptions, bool? useDomainPool = default(bool?))
        {
             await SendEmailSourceOptionalAsyncWithHttpInfo(inboxId, sendEmailOptions, useDomainPool);
        ...
        /// <param name="useDomainPool">Use domain pool. Optionally create inbox to send from using the mailslurp domain pool. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<Object>> SendEmailSourceOptionalAsyncWithHttpInfo (Guid inboxId, SendEmailOptions sendEmailOptions, bool? useDomainPool = default(bool?))
        {
            // verify the required parameter 'sendEmailOptions' is set
            if (sendEmailOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'sendEmailOptions' when calling EmailControllerApi->SendEmailSourceOptional");

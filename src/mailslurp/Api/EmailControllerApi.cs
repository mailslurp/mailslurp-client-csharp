...
namespace mailslurp.Api
{
    ...
    public partial class EmailControllerApi : IEmailControllerApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<Object>> SendEmailSourceOptionalWithHttpInfoAsync(Guid inboxId, SendEmailOptions sendEmailOptions, bool? useDomainPool = default(bool?), bool? virtualSend = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sendEmailOptions' is set
            if (sendEmailOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'sendEmailOptions' when calling EmailControllerApi->SendEmailSourceOptional");

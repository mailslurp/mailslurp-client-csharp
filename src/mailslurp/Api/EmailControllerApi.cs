...
namespace mailslurp.Api
{
    ...
    public interface IEmailControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="unreadOnly">Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly (optional, default to false)</param>
        /// <returns>Task of PageEmailProjection</returns>
        System.Threading.Tasks.Task<PageEmailProjection> GetOrganizationEmailsPaginatedAsync (List<Guid> inboxId = default(List<Guid>), int? page = default(int?), int? size = default(int?), string sort = default(string), bool? unreadOnly = default(bool?));
        ...
        /// <param name="unreadOnly">Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly (optional, default to false)</param>
        /// <returns>Task of ApiResponse (PageEmailProjection)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageEmailProjection>> GetOrganizationEmailsPaginatedAsyncWithHttpInfo (List<Guid> inboxId = default(List<Guid>), int? page = default(int?), int? size = default(int?), string sort = default(string), bool? unreadOnly = default(bool?));
        /// <summary>
        /// Get raw email string. Returns unparsed raw SMTP message with headers and body.
        /// </summary>
        /// <remarks>
    ...
    public partial class EmailControllerApi : IEmailControllerApi
    {
        ...
        /// <summary>
        /// Get all email attachment metadata. Metadata includes name and attachment size. Returns an array of attachment metadata such as name and content-type for a given email if present.
        /// </summary>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="emailId">ID of email</param>
        /// <returns>List&lt;AttachmentMetaData&gt;</returns>
        ...
        /// <summary>
        /// Get all emails in all inboxes. Email API list all. By default returns all emails across all inboxes sorted by ascending created at date. Responses are paginated. You can restrict results to a list of inbox IDs. You can also filter out read messages
        /// </summary>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inboxId">Optional inbox ids to filter by. Can be repeated. By default will use all inboxes belonging to your account. (optional)</param>
        /// <param name="page">Optional page index in email list pagination (optional, default to 0)</param>
        ...
        {
             mailslurp.Client.ApiResponse<PageEmailProjection> localVarResponse = GetOrganizationEmailsPaginatedWithHttpInfo(inboxId, page, size, sort, unreadOnly);
             return localVarResponse.Data;
        }
        ...
        /// <param name="unreadOnly">Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly (optional, default to false)</param>
        /// <returns>ApiResponse of PageEmailProjection</returns>
        public mailslurp.Client.ApiResponse< PageEmailProjection > GetOrganizationEmailsPaginatedWithHttpInfo (List<Guid> inboxId = default(List<Guid>), int? page = default(int?), int? size = default(int?), string sort = default(string), bool? unreadOnly = default(bool?))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="unreadOnly">Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly (optional, default to false)</param>
        /// <returns>Task of PageEmailProjection</returns>
        public async System.Threading.Tasks.Task<PageEmailProjection> GetOrganizationEmailsPaginatedAsync (List<Guid> inboxId = default(List<Guid>), int? page = default(int?), int? size = default(int?), string sort = default(string), bool? unreadOnly = default(bool?))
        {
             mailslurp.Client.ApiResponse<PageEmailProjection> localVarResponse = await GetOrganizationEmailsPaginatedAsyncWithHttpInfo(inboxId, page, size, sort, unreadOnly);
             return localVarResponse.Data;
        ...
        /// <param name="unreadOnly">Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly (optional, default to false)</param>
        /// <returns>Task of ApiResponse (PageEmailProjection)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<PageEmailProjection>> GetOrganizationEmailsPaginatedAsyncWithHttpInfo (List<Guid> inboxId = default(List<Guid>), int? page = default(int?), int? size = default(int?), string sort = default(string), bool? unreadOnly = default(bool?))
        {
        ...
        /// <summary>
        /// Validate email HTML contents Validate the HTML content of email if HTML is found. Considered valid if no HTML.
        /// </summary>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="emailId">ID of email</param>
        /// <returns>ValidationDto</returns>

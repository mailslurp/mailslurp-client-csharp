...
namespace mailslurp.Api
{
    ...
    public partial class BounceControllerApi : IBounceControllerApi
    {
        ...
        /// <param name="before">Filter by created at before the given timestamp (optional)</param>
        /// <returns>ApiResponse of PageComplaint</returns>
        public mailslurp.Client.ApiResponse<PageComplaint> GetComplaintsWithHttpInfo(int? page = default(int?), int? size = default(int?), string sort = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
            mailslurp.Client.ApiResponse<PageComplaint> localVarResponse = await GetComplaintsWithHttpInfoAsync(page, size, sort, since, before, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

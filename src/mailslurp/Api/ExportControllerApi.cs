...
namespace mailslurp.Api
{
    ...
    public interface IExportControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<List<byte[]>>> ExportEntitiesAsyncWithHttpInfo (string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?));
        /// <summary>
        /// Get export link
        /// </summary>
        /// <remarks>
    ...
    public partial class ExportControllerApi : IExportControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = await ExportEntitiesAsyncWithHttpInfo(exportType, apiKey, outputFormat, filter, listSeparatorToken, excludePreviouslyExported, createdEarliestTime, createdOldestTime);
             return localVarResponse.Data;

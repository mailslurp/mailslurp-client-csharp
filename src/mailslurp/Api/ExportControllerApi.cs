...
namespace mailslurp.Api
{
    ...
    public partial class ExportControllerApi : IExportControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = await ExportEntitiesWithHttpInfoAsync(exportType, apiKey, outputFormat, filter, listSeparatorToken, excludePreviouslyExported, createdEarliestTime, createdOldestTime, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

...
namespace mailslurp.Api
{
    ...
    public partial class ExportControllerApi : IExportControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = ExportEntitiesWithHttpInfo(exportType, apiKey, outputFormat, filter, listSeparatorToken, excludePreviouslyExported, createdEarliestTime, createdOldestTime);
        ...
        /// <param name="createdOldestTime"> (optional)</param>
        /// <returns>ApiResponse of List&lt;byte[]&gt;</returns>
        public mailslurp.Client.ApiResponse<List<byte[]>> ExportEntitiesWithHttpInfo(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?))
        {
        ...
        {
            mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = await ExportEntitiesWithHttpInfoAsync(exportType, apiKey, outputFormat, filter, listSeparatorToken, excludePreviouslyExported, createdEarliestTime, createdOldestTime, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;byte[]&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<byte[]>>> ExportEntitiesWithHttpInfoAsync(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'exportType' is set
            if (exportType == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'exportType' when calling ExportControllerApi->ExportEntities");
        ...
        {
            mailslurp.Client.ApiResponse<ExportLink> localVarResponse = await GetExportLinkWithHttpInfoAsync(exportType, exportOptions, apiKey, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ExportLink)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<ExportLink>> GetExportLinkWithHttpInfoAsync(string exportType, ExportOptions exportOptions, string apiKey = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'exportType' is set
            if (exportType == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'exportType' when calling ExportControllerApi->GetExportLink");

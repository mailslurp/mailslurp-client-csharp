...
namespace mailslurp.Api
{
    ...
    public partial class AttachmentControllerApi : IAttachmentControllerApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PageAttachmentEntity</returns>
        public mailslurp.Client.ApiResponse<PageAttachmentEntity> GetAttachmentsWithHttpInfo(int? page = default(int?), int? size = default(int?), string sort = default(string), string fileNameFilter = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?), int operationIndex = 0)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
            mailslurp.Client.ApiResponse<PageAttachmentEntity> localVarResponse = await GetAttachmentsWithHttpInfoAsync(page, size, sort, fileNameFilter, since, before, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<List<string>> localVarResponse = UploadAttachmentBytesWithHttpInfo(uploadAttachmentBytesRequest, contentType, filename);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public mailslurp.Client.ApiResponse<List<string>> UploadAttachmentBytesWithHttpInfo(UploadAttachmentBytesRequest uploadAttachmentBytesRequest, string contentType = default(string), string filename = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'uploadAttachmentBytesRequest' is set
            if (uploadAttachmentBytesRequest == null)
            {
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'uploadAttachmentBytesRequest' when calling AttachmentControllerApi->UploadAttachmentBytes");
            }
        ...
        {
            mailslurp.Client.ApiResponse<List<string>> localVarResponse = await UploadAttachmentBytesWithHttpInfoAsync(uploadAttachmentBytesRequest, contentType, filename, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<List<string>> localVarResponse = UploadMultipartFormWithHttpInfo(contentType, filename, xFilename, uploadMultipartFormRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public mailslurp.Client.ApiResponse<List<string>> UploadMultipartFormWithHttpInfo(string contentType = default(string), string filename = default(string), string xFilename = default(string), UploadMultipartFormRequest uploadMultipartFormRequest = default(UploadMultipartFormRequest), int operationIndex = 0)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        public async System.Threading.Tasks.Task<List<string>> UploadMultipartFormAsync(string contentType = default(string), string filename = default(string), string xFilename = default(string), UploadMultipartFormRequest uploadMultipartFormRequest = default(UploadMultipartFormRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp.Client.ApiResponse<List<string>> localVarResponse = await UploadMultipartFormWithHttpInfoAsync(contentType, filename, xFilename, uploadMultipartFormRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<string>>> UploadMultipartFormWithHttpInfoAsync(string contentType = default(string), string filename = default(string), string xFilename = default(string), UploadMultipartFormRequest uploadMultipartFormRequest = default(UploadMultipartFormRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {

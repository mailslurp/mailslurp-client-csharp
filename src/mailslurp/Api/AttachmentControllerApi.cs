...
namespace mailslurp.Api
{
    ...
    public interface IAttachmentControllerApiSync : IApiAccessor
    {
        ...
        /// <returns>List&lt;string&gt;</returns>
        List<string> UploadAttachmentBytes (string filename = default(string));
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        ApiResponse<List<string>> UploadAttachmentBytesWithHttpInfo (string filename = default(string));
        /// <summary>
    ...
    public interface IAttachmentControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>Task of List&lt;string&gt;</returns>
        System.Threading.Tasks.Task<List<string>> UploadAttachmentBytesAsync (string filename = default(string));
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<string>>> UploadAttachmentBytesAsyncWithHttpInfo (string filename = default(string));
        /// <summary>
        /// Upload an attachment for sending using Multipart Form
        /// </summary>
        /// <remarks>
    ...
    public partial class AttachmentControllerApi : IAttachmentControllerApi
    {
        ...
        /// <summary>
        /// Upload an attachment for sending using base64 file encoding When sending emails with attachments first upload each attachment with this endpoint. Record the returned attachment IDs. Then use these attachment IDs in the SendEmailOptions when sending an email. This means that attachments can easily be reused.
        /// </summary>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="uploadOptions">uploadOptions</param>
        /// <returns>List&lt;string&gt;</returns>
        ...
        /// <summary>
        /// Upload an attachment for sending using file byte stream input octet stream When sending emails with attachments first upload each attachment with this endpoint. Record the returned attachment IDs. Then use these attachment IDs in the SendEmailOptions when sending an email. This means that attachments can easily be reused.
        /// </summary>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>List&lt;string&gt;</returns>
        public List<string> UploadAttachmentBytes (string filename = default(string))
        {
             mailslurp.Client.ApiResponse<List<string>> localVarResponse = UploadAttachmentBytesWithHttpInfo(filename);
             return localVarResponse.Data;
        }
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public mailslurp.Client.ApiResponse< List<string> > UploadAttachmentBytesWithHttpInfo (string filename = default(string))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
            ...
            localVarRequestOptions.Data = filename;
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>Task of List&lt;string&gt;</returns>
        public async System.Threading.Tasks.Task<List<string>> UploadAttachmentBytesAsync (string filename = default(string))
        {
             mailslurp.Client.ApiResponse<List<string>> localVarResponse = await UploadAttachmentBytesAsyncWithHttpInfo(filename);
             return localVarResponse.Data;
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<string>>> UploadAttachmentBytesAsyncWithHttpInfo (string filename = default(string))
        {

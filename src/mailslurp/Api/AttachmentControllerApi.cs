...
namespace mailslurp.Api
{
    ...
    public interface IAttachmentControllerApiSync : IApiAccessor
    {
        ...
        /// <param name="importEmailIntoInboxMultipartRequest"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;string&gt;</returns>
        List<string> UploadMultipartForm(string contentId = default, string contentType = default, string filename = default, string contentTypeHeader = default, string xFilename = default, string xFilenameRaw = default, long? xFilesize = default, ImportEmailIntoInboxMultipartRequest importEmailIntoInboxMultipartRequest = default, int operationIndex = 0);
    ...
    public partial class AttachmentControllerApi : IAttachmentControllerApi
    {
        ...
        /// <summary>
        /// Extract text from an attachment Extract text content from an attachment using the requested method. &#x60;NATIVE&#x60; decoding supports text-like files, common Word and spreadsheet documents, and PDFs with embedded text.
        /// </summary>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="attachmentId">ID of attachment</param>
        /// <param name="extractAttachmentTextOptions"> (optional)</param>
        ...
        {
            mailslurp.Client.ApiResponse<List<string>> localVarResponse = UploadMultipartFormWithHttpInfo(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest);
            return localVarResponse.Data;
        }
        ...
        public mailslurp.Client.ApiResponse<List<string>> UploadMultipartFormWithHttpInfo(string contentId = default, string contentType = default, string filename = default, string contentTypeHeader = default, string xFilename = default, string xFilenameRaw = default, long? xFilesize = default, ImportEmailIntoInboxMultipartRequest importEmailIntoInboxMultipartRequest = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Data = importEmailIntoInboxMultipartRequest;
        ...
        public async System.Threading.Tasks.Task<List<string>> UploadMultipartFormAsync(string contentId = default, string contentType = default, string filename = default, string contentTypeHeader = default, string xFilename = default, string xFilenameRaw = default, long? xFilesize = default, ImportEmailIntoInboxMultipartRequest importEmailIntoInboxMultipartRequest = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            mailslurp.Client.ApiResponse<List<string>> localVarResponse = await UploadMultipartFormWithHttpInfoAsync(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

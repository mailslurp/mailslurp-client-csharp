...
namespace mailslurp.Api
{
    ...
    public interface IAttachmentControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageAttachmentEntity> GetAttachmentsAsync (int? page = default(int?), int? size = default(int?), string sort = default(string), string fileNameFilter = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?));
        ...
        System.Threading.Tasks.Task<ApiResponse<PageAttachmentEntity>> GetAttachmentsAsyncWithHttpInfo (int? page = default(int?), int? size = default(int?), string sort = default(string), string fileNameFilter = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?));
        /// <summary>
        /// Upload an attachment for sending using base64 file encoding. Returns an array whose first element is the ID of the uploaded attachment.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>Task of List&lt;string&gt;</returns>
        System.Threading.Tasks.Task<List<string>> UploadAttachmentBytesAsync (InlineObject1 inlineObject1, string contentType = default(string), string filename = default(string));
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<string>>> UploadAttachmentBytesAsyncWithHttpInfo (InlineObject1 inlineObject1, string contentType = default(string), string filename = default(string));
        /// <summary>
        /// Upload an attachment for sending using a Multipart Form request. Returns an array whose first element is the ID of the uploaded attachment.
        /// </summary>
        /// <remarks>
    ...
    public partial class AttachmentControllerApi : IAttachmentControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<PageAttachmentEntity> localVarResponse = GetAttachmentsWithHttpInfo(page, size, sort, fileNameFilter, since, before);
             return localVarResponse.Data;
        }
        ...
        /// <param name="before">Filter by created at before the given timestamp (optional)</param>
        /// <returns>ApiResponse of PageAttachmentEntity</returns>
        public mailslurp.Client.ApiResponse< PageAttachmentEntity > GetAttachmentsWithHttpInfo (int? page = default(int?), int? size = default(int?), string sort = default(string), string fileNameFilter = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="before">Filter by created at before the given timestamp (optional)</param>
        /// <returns>Task of PageAttachmentEntity</returns>
        public async System.Threading.Tasks.Task<PageAttachmentEntity> GetAttachmentsAsync (int? page = default(int?), int? size = default(int?), string sort = default(string), string fileNameFilter = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?))
        {
             mailslurp.Client.ApiResponse<PageAttachmentEntity> localVarResponse = await GetAttachmentsAsyncWithHttpInfo(page, size, sort, fileNameFilter, since, before);
             return localVarResponse.Data;
        ...
        /// <param name="before">Filter by created at before the given timestamp (optional)</param>
        /// <returns>Task of ApiResponse (PageAttachmentEntity)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<PageAttachmentEntity>> GetAttachmentsAsyncWithHttpInfo (int? page = default(int?), int? size = default(int?), string sort = default(string), string fileNameFilter = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?))
        {
        ...
        {
             mailslurp.Client.ApiResponse<List<string>> localVarResponse = UploadAttachmentBytesWithHttpInfo(inlineObject1, contentType, filename);
             return localVarResponse.Data;
        }
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public mailslurp.Client.ApiResponse< List<string> > UploadAttachmentBytesWithHttpInfo (InlineObject1 inlineObject1, string contentType = default(string), string filename = default(string))
        {
            // verify the required parameter 'inlineObject1' is set
            if (inlineObject1 == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'inlineObject1' when calling AttachmentControllerApi->UploadAttachmentBytes");
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>Task of List&lt;string&gt;</returns>
        public async System.Threading.Tasks.Task<List<string>> UploadAttachmentBytesAsync (InlineObject1 inlineObject1, string contentType = default(string), string filename = default(string))
        {
             mailslurp.Client.ApiResponse<List<string>> localVarResponse = await UploadAttachmentBytesAsyncWithHttpInfo(inlineObject1, contentType, filename);
             return localVarResponse.Data;
        ...
        /// <param name="filename">Optional filename to save upload with (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<string>>> UploadAttachmentBytesAsyncWithHttpInfo (InlineObject1 inlineObject1, string contentType = default(string), string filename = default(string))
        {
            // verify the required parameter 'inlineObject1' is set
            if (inlineObject1 == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'inlineObject1' when calling AttachmentControllerApi->UploadAttachmentBytes");

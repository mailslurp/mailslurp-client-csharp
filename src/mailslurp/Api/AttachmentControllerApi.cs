...
namespace mailslurp.Api
{
    ...
    public interface IAttachmentControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageAttachmentEntity> GetAttachmentsAsync (string fileNameFilter = default(string), int? page = default(int?), int? size = default(int?), string sort = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<PageAttachmentEntity>> GetAttachmentsAsyncWithHttpInfo (string fileNameFilter = default(string), int? page = default(int?), int? size = default(int?), string sort = default(string));
        /// <summary>
        /// Upload an attachment for sending using base64 file encoding. Returns an array whose first element is the ID of the uploaded attachment.
        /// </summary>
        /// <remarks>
    ...
    public partial class AttachmentControllerApi : IAttachmentControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<PageAttachmentEntity> localVarResponse = GetAttachmentsWithHttpInfo(fileNameFilter, page, size, sort);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageAttachmentEntity</returns>
        public mailslurp.Client.ApiResponse< PageAttachmentEntity > GetAttachmentsWithHttpInfo (string fileNameFilter = default(string), int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of PageAttachmentEntity</returns>
        public async System.Threading.Tasks.Task<PageAttachmentEntity> GetAttachmentsAsync (string fileNameFilter = default(string), int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
             mailslurp.Client.ApiResponse<PageAttachmentEntity> localVarResponse = await GetAttachmentsAsyncWithHttpInfo(fileNameFilter, page, size, sort);
             return localVarResponse.Data;
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of ApiResponse (PageAttachmentEntity)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<PageAttachmentEntity>> GetAttachmentsAsyncWithHttpInfo (string fileNameFilter = default(string), int? page = default(int?), int? size = default(int?), string sort = default(string))
        {

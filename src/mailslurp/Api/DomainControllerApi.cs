...
namespace mailslurp.Api
{
    ...
    public interface IDomainControllerApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DomainRegionGroupsDto</returns>
        DomainRegionGroupsDto GetAvailableDomainRegions(string inboxType = default, int operationIndex = 0);
        ...
        /// <param name="inboxType"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DomainRegionGroupsDto</returns>
        ApiResponse<DomainRegionGroupsDto> GetAvailableDomainRegionsWithHttpInfo(string inboxType = default, int operationIndex = 0);
        /// <summary>
    ...
    public interface IDomainControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DomainRegionGroupsDto</returns>
        System.Threading.Tasks.Task<DomainRegionGroupsDto> GetAvailableDomainRegionsAsync(string inboxType = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DomainRegionGroupsDto)</returns>
        System.Threading.Tasks.Task<ApiResponse<DomainRegionGroupsDto>> GetAvailableDomainRegionsWithHttpInfoAsync(string inboxType = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Get all usable domains
        /// </summary>
        /// <remarks>
    ...
    public partial class DomainControllerApi : IDomainControllerApi
    {
        ...
        /// <summary>
        /// Get all usable domains with account region status List all domains available for use with email address creation, including account-region and create/send enablement flags.
        /// </summary>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inboxType"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DomainRegionGroupsDto</returns>
        public DomainRegionGroupsDto GetAvailableDomainRegions(string inboxType = default, int operationIndex = 0)
        {
            mailslurp.Client.ApiResponse<DomainRegionGroupsDto> localVarResponse = GetAvailableDomainRegionsWithHttpInfo(inboxType);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DomainRegionGroupsDto</returns>
        public mailslurp.Client.ApiResponse<DomainRegionGroupsDto> GetAvailableDomainRegionsWithHttpInfo(string inboxType = default, int operationIndex = 0)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "DomainControllerApi.GetAvailableDomainRegions";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<DomainRegionGroupsDto>("/domains/available-domain-regions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetAvailableDomainRegions", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DomainRegionGroupsDto</returns>
        public async System.Threading.Tasks.Task<DomainRegionGroupsDto> GetAvailableDomainRegionsAsync(string inboxType = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            mailslurp.Client.ApiResponse<DomainRegionGroupsDto> localVarResponse = await GetAvailableDomainRegionsWithHttpInfoAsync(inboxType, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DomainRegionGroupsDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<DomainRegionGroupsDto>> GetAvailableDomainRegionsWithHttpInfoAsync(string inboxType = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<DomainRegionGroupsDto>("/domains/available-domain-regions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

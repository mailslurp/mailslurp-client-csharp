...
namespace mailslurp.Api
{
    ...
    public interface IDomainControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="updateDomainDto">updateDomainDto</param>
        /// <returns>Task of DomainDto</returns>
        System.Threading.Tasks.Task<DomainDto> UpdateDomainAsync (Guid id, UpdateDomainOptions updateDomainDto);
        ...
        /// <param name="updateDomainDto">updateDomainDto</param>
        /// <returns>Task of ApiResponse (DomainDto)</returns>
        System.Threading.Tasks.Task<ApiResponse<DomainDto>> UpdateDomainAsyncWithHttpInfo (Guid id, UpdateDomainOptions updateDomainDto);
    ...
    public partial class DomainControllerApi : IDomainControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<DomainDto> localVarResponse = UpdateDomainWithHttpInfo(id, updateDomainDto);
             return localVarResponse.Data;
        }
        ...
        /// <param name="updateDomainDto">updateDomainDto</param>
        /// <returns>ApiResponse of DomainDto</returns>
        public mailslurp.Client.ApiResponse< DomainDto > UpdateDomainWithHttpInfo (Guid id, UpdateDomainOptions updateDomainDto)
        {
            // verify the required parameter 'updateDomainDto' is set
            if (updateDomainDto == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'updateDomainDto' when calling DomainControllerApi->UpdateDomain");
        ...
        /// <param name="updateDomainDto">updateDomainDto</param>
        /// <returns>Task of DomainDto</returns>
        public async System.Threading.Tasks.Task<DomainDto> UpdateDomainAsync (Guid id, UpdateDomainOptions updateDomainDto)
        {
             mailslurp.Client.ApiResponse<DomainDto> localVarResponse = await UpdateDomainAsyncWithHttpInfo(id, updateDomainDto);
             return localVarResponse.Data;
        ...
        /// <param name="updateDomainDto">updateDomainDto</param>
        /// <returns>Task of ApiResponse (DomainDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<DomainDto>> UpdateDomainAsyncWithHttpInfo (Guid id, UpdateDomainOptions updateDomainDto)
        {
            // verify the required parameter 'updateDomainDto' is set
            if (updateDomainDto == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'updateDomainDto' when calling DomainControllerApi->UpdateDomain");

...
namespace mailslurp.Api
{
    ...
    public partial class TrackingControllerApi : ITrackingControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<TrackingPixelDto> localVarResponse = await CreateTrackingPixelWithHttpInfoAsync(createTrackingPixelOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TrackingPixelDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<TrackingPixelDto>> CreateTrackingPixelWithHttpInfoAsync(CreateTrackingPixelOptions createTrackingPixelOptions, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createTrackingPixelOptions' is set
            if (createTrackingPixelOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'createTrackingPixelOptions' when calling TrackingControllerApi->CreateTrackingPixel");
        ...
        {
            mailslurp.Client.ApiResponse<PageTrackingPixelProjection> localVarResponse = await GetAllTrackingPixelsWithHttpInfoAsync(page, size, sort, searchFilter, since, before, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<TrackingPixelDto> localVarResponse = await GetTrackingPixelWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TrackingPixelDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<TrackingPixelDto>> GetTrackingPixelWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {

...
namespace mailslurp.Api
{
    ...
    public partial class CommonActionsControllerApi : ICommonActionsControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<InboxDto> localVarResponse = CreateNewEmailAddressWithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress);
        ...
        {
            mailslurp.Client.ApiResponse<InboxDto> localVarResponse = await CreateNewEmailAddressWithHttpInfoAsync(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<InboxDto> localVarResponse = CreateRandomInboxWithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<InboxDto> localVarResponse = await CreateRandomInboxWithHttpInfoAsync(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

    ...
    public partial class CommonActionsControllerApi : ICommonActionsControllerApi
    {
        ...
        public ApiResponse<Object> SendEmailSimpleWithHttpInfo (SendEmailOptions sendEmailOptions)
        {
            ...
            if (sendEmailOptions == null)
                throw new ApiException(400, "Missing required parameter 'sendEmailOptions' when calling CommonActionsControllerApi->SendEmailSimple");
        ...
        public ApiResponse<List<EmailPreview>> WaitForMatchingEmailWithHttpInfo (MatchOptions matchOptions, int count = default(int), Guid inboxId = default(Guid), long timeout = default(long), bool unreadOnly = default(bool))
        {
            ...
            if (matchOptions == null)
                throw new ApiException(400, "Missing required parameter 'matchOptions' when calling CommonActionsControllerApi->WaitForMatchingEmail");

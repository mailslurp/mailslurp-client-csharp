...
namespace mailslurp.Api
{
    ...
    public interface ICommonActionsControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="favourite"> (optional)</param>
        /// <returns>Task of ApiResponse (InboxDto)</returns>
        System.Threading.Tasks.Task<ApiResponse<InboxDto>> CreateNewEmailAddress1AsyncWithHttpInfo (bool? allowTeamAccess = default(bool?), bool? useDomainPool = default(bool?), DateTime? expiresAt = default(DateTime?), long? expiresIn = default(long?), string emailAddress = default(string), string inboxType = default(string), string description = default(string), string name = default(string), List<string> tags = default(List<string>), bool? favourite = default(bool?));
        /// <summary>
        /// Delete inbox email address by inbox id
        /// </summary>
        /// <remarks>
    ...
    public partial class CommonActionsControllerApi : ICommonActionsControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<InboxDto> localVarResponse = CreateNewEmailAddress1WithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite);
             return localVarResponse.Data;
        }
        ...
        {
             mailslurp.Client.ApiResponse<InboxDto> localVarResponse = await CreateNewEmailAddress1AsyncWithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite);
             return localVarResponse.Data;

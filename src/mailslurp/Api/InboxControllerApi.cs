...
namespace mailslurp.Api
{
    ...
    public interface IInboxControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<List<EmailPreview>>> GetEmailsAsyncWithHttpInfo (Guid inboxId, int? aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit = default(int?), int? limit = default(int?), string sortTheResultsByReceivedDateAndDirectionASCOrDESC = default(string), long? retryTimeout = default(long?), long? delayTimeout = default(long?), long? minCount = default(long?), bool? unreadOnly = default(bool?), DateTime? before = default(DateTime?), DateTime? since = default(DateTime?));
        /// <summary>
        /// Get Inbox. Returns properties of an inbox.
        /// </summary>
        /// <remarks>
    ...
    public partial class InboxControllerApi : IInboxControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<List<EmailPreview>> localVarResponse = GetEmailsWithHttpInfo(inboxId, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit, limit, sortTheResultsByReceivedDateAndDirectionASCOrDESC, retryTimeout, delayTimeout, minCount, unreadOnly, before, since);
             return localVarResponse.Data;
        }
        ...
        /// <param name="since">Exclude emails received before this ISO 8601 date time (optional)</param>
        /// <returns>ApiResponse of List&lt;EmailPreview&gt;</returns>
        public mailslurp.Client.ApiResponse< List<EmailPreview> > GetEmailsWithHttpInfo (Guid inboxId, int? aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit = default(int?), int? limit = default(int?), string sortTheResultsByReceivedDateAndDirectionASCOrDESC = default(string), long? retryTimeout = default(long?), long? delayTimeout = default(long?), long? minCount = default(long?), bool? unreadOnly = default(bool?), DateTime? before = default(DateTime?), DateTime? since = default(DateTime?))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
             mailslurp.Client.ApiResponse<List<EmailPreview>> localVarResponse = await GetEmailsAsyncWithHttpInfo(inboxId, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit, limit, sortTheResultsByReceivedDateAndDirectionASCOrDESC, retryTimeout, delayTimeout, minCount, unreadOnly, before, since);
             return localVarResponse.Data;
        ...
        /// <param name="since">Exclude emails received before this ISO 8601 date time (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;EmailPreview&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<EmailPreview>>> GetEmailsAsyncWithHttpInfo (Guid inboxId, int? aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit = default(int?), int? limit = default(int?), string sortTheResultsByReceivedDateAndDirectionASCOrDESC = default(string), long? retryTimeout = default(long?), long? delayTimeout = default(long?), long? minCount = default(long?), bool? unreadOnly = default(bool?), DateTime? before = default(DateTime?), DateTime? since = default(DateTime?))
        {

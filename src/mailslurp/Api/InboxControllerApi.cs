...
namespace mailslurp.Api
{
    ...
    public partial class InboxControllerApi : IInboxControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<InboxDto> localVarResponse = CreateInboxWithHttpInfo(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType, virtualInbox, useShortAddress);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<InboxDto> localVarResponse = await CreateInboxWithHttpInfoAsync(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType, virtualInbox, useShortAddress, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InboxExistsDto</returns>
        public mailslurp.Client.ApiResponse<InboxExistsDto> DoesInboxExistWithHttpInfo(string emailAddress, int operationIndex = 0)
        {
        ...
        {
            mailslurp.Client.ApiResponse<InboxExistsDto> localVarResponse = await DoesInboxExistWithHttpInfoAsync(emailAddress, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InboxExistsDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<InboxExistsDto>> DoesInboxExistWithHttpInfoAsync(string emailAddress, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'emailAddress' is set
            if (emailAddress == null)
            {
        ...
        {
            mailslurp.Client.ApiResponse<PageInboxProjection> localVarResponse = await GetAllInboxesWithHttpInfoAsync(page, size, sort, favourite, search, tag, teamAccess, since, before, inboxType, domainId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of List&lt;InboxDto&gt;</returns>
        [Obsolete]
        public mailslurp.Client.ApiResponse<List<InboxDto>> GetInboxesWithHttpInfo(int? size = default(int?), string sort = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?), int operationIndex = 0)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
            mailslurp.Client.ApiResponse<List<InboxDto>> localVarResponse = await GetInboxesWithHttpInfoAsync(size, sort, since, before, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

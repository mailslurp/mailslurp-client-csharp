...
namespace mailslurp.Api
{
    ...
    public interface IInboxControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InboxDto> CreateInboxAsync (string emailAddress = default(string), List<string> tags = default(List<string>), string name = default(string), string description = default(string), bool? useDomainPool = default(bool?), bool? favourite = default(bool?), DateTime? expiresAt = default(DateTime?), long? expiresIn = default(long?), bool? allowTeamAccess = default(bool?), string inboxType = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<InboxDto>> CreateInboxAsyncWithHttpInfo (string emailAddress = default(string), List<string> tags = default(List<string>), string name = default(string), string description = default(string), bool? useDomainPool = default(bool?), bool? favourite = default(bool?), DateTime? expiresAt = default(DateTime?), long? expiresIn = default(long?), bool? allowTeamAccess = default(bool?), string inboxType = default(string));
        /// <summary>
        /// Create an inbox ruleset
        /// </summary>
        /// <remarks>
    ...
    public partial class InboxControllerApi : IInboxControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<InboxDto> localVarResponse = CreateInboxWithHttpInfo(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType);
        ...
        /// <param name="inboxType">HTTP (default) or SMTP inbox type. HTTP inboxes are default and best solution for most cases. SMTP inboxes are more reliable for public inbound email consumption (but do not support sending emails). When using custom domains the domain type must match the inbox type. HTTP inboxes are processed by AWS SES while SMTP inboxes use a custom mail server running at &#x60;mx.mailslurp.com&#x60;. (optional)</param>
        /// <returns>Task of InboxDto</returns>
        public async System.Threading.Tasks.Task<InboxDto> CreateInboxAsync (string emailAddress = default(string), List<string> tags = default(List<string>), string name = default(string), string description = default(string), bool? useDomainPool = default(bool?), bool? favourite = default(bool?), DateTime? expiresAt = default(DateTime?), long? expiresIn = default(long?), bool? allowTeamAccess = default(bool?), string inboxType = default(string))
        {
             mailslurp.Client.ApiResponse<InboxDto> localVarResponse = await CreateInboxAsyncWithHttpInfo(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType);
             return localVarResponse.Data;

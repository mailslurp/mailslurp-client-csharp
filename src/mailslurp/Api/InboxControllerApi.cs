...
namespace mailslurp.Api
{
    ...
    public partial class InboxControllerApi : IInboxControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<PageInboxProjection> localVarResponse = await GetAllInboxesWithHttpInfoAsync(page, size, sort, favourite, search, tag, teamAccess, since, before, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

...
namespace mailslurp.Api
{
    ...
    public interface IInboxControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task CreateInboxRulesetAsync (Guid inboxId, CreateInboxRulesetOptions createInboxRulesetOptions);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CreateInboxRulesetAsyncWithHttpInfo (Guid inboxId, CreateInboxRulesetOptions createInboxRulesetOptions);
        /// <summary>
        /// Create an inbox with default options. Uses MailSlurp domain pool address and is private.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ListInboxRulesetsAsync (Guid inboxId, int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string));
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> ListInboxRulesetsAsyncWithHttpInfo (Guid inboxId, int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string));
        /// <summary>
        /// Send Email
        /// </summary>
        /// <remarks>
    ...
    public partial class InboxControllerApi : IInboxControllerApi
    {
        ...
        /// <param name="createInboxRulesetOptions">createInboxRulesetOptions</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public mailslurp.Client.ApiResponse<Object> CreateInboxRulesetWithHttpInfo (Guid inboxId, CreateInboxRulesetOptions createInboxRulesetOptions)
        {
        ...
        /// <param name="createInboxRulesetOptions">createInboxRulesetOptions</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CreateInboxRulesetAsync (Guid inboxId, CreateInboxRulesetOptions createInboxRulesetOptions)
        {
             await CreateInboxRulesetAsyncWithHttpInfo(inboxId, createInboxRulesetOptions);
        ...
        /// <param name="createInboxRulesetOptions">createInboxRulesetOptions</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<Object>> CreateInboxRulesetAsyncWithHttpInfo (Guid inboxId, CreateInboxRulesetOptions createInboxRulesetOptions)
        {
            // verify the required parameter 'createInboxRulesetOptions' is set
            if (createInboxRulesetOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'createInboxRulesetOptions' when calling InboxControllerApi->CreateInboxRuleset");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/inboxes/{inboxId}/rulesets", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public mailslurp.Client.ApiResponse<Object> ListInboxRulesetsWithHttpInfo (Guid inboxId, int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ListInboxRulesetsAsync (Guid inboxId, int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {
             await ListInboxRulesetsAsyncWithHttpInfo(inboxId, page, searchFilter, size, sort);
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<Object>> ListInboxRulesetsAsyncWithHttpInfo (Guid inboxId, int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/inboxes/{inboxId}/rulesets", localVarRequestOptions, this.Configuration);

...
namespace mailslurp.Api
{
    ...
    public partial class InboxControllerApi : IInboxControllerApi
    {
        ...
        {
             ApiResponse<PageInboxProjection> localVarResponse = GetAllInboxesWithHttpInfo(favourite, page, search, size, sort, tag);
             return localVarResponse.Data;
        }
        ...
        /// <param name="tag">Optionally filter by tags (optional)</param>
        /// <returns>ApiResponse of PageInboxProjection</returns>
        public ApiResponse<PageInboxProjection> GetAllInboxesWithHttpInfo (bool favourite = default(bool), int page = default(int), string search = default(string), int size = default(int), string sort = default(string), string tag = default(string))
        {
        ...
        {
             ApiResponse<PageInboxProjection> localVarResponse = await GetAllInboxesAsyncWithHttpInfo(favourite, page, search, size, sort, tag);
             return localVarResponse.Data;
        ...
        /// <param name="tag">Optionally filter by tags (optional)</param>
        /// <returns>Task of ApiResponse (PageInboxProjection)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageInboxProjection>> GetAllInboxesAsyncWithHttpInfo (bool favourite = default(bool), int page = default(int), string search = default(string), int size = default(int), string sort = default(string), string tag = default(string))
        {
        ...
        {
             ApiResponse<List<string>> localVarResponse = GetInboxTagsWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        public ApiResponse<List<string>> GetInboxTagsWithHttpInfo ()
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetInboxTags", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        {
             ApiResponse<List<string>> localVarResponse = await GetInboxTagsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<string>>> GetInboxTagsAsyncWithHttpInfo ()
        {
        ...
        {
             ApiResponse<Inbox> localVarResponse = UpdateInboxWithHttpInfo(inboxId, updateInboxOptions);
             return localVarResponse.Data;
        }
        ...
        /// <param name="updateInboxOptions">updateInboxOptions</param>
        /// <returns>ApiResponse of Inbox</returns>
        public ApiResponse<Inbox> UpdateInboxWithHttpInfo (Guid inboxId, UpdateInboxOptions updateInboxOptions)
        {
            // verify the required parameter 'inboxId' is set
            if (inboxId == null)
                throw new ApiException(400, "Missing required parameter 'inboxId' when calling InboxControllerApi->UpdateInbox");
            // verify the required parameter 'updateInboxOptions' is set
            if (updateInboxOptions == null)
                throw new ApiException(400, "Missing required parameter 'updateInboxOptions' when calling InboxControllerApi->UpdateInbox");
            ...
            if (inboxId != null) localVarPathParams.Add("inboxId", this.Configuration.ApiClient.ParameterToString(inboxId)); // path parameter
            if (updateInboxOptions != null && updateInboxOptions.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(updateInboxOptions); // http body (model) parameter
            }
            else
            {
                localVarPostBody = updateInboxOptions; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UpdateInbox", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        {
             ApiResponse<Inbox> localVarResponse = await UpdateInboxAsyncWithHttpInfo(inboxId, updateInboxOptions);
             return localVarResponse.Data;
        ...
        /// <param name="updateInboxOptions">updateInboxOptions</param>
        /// <returns>Task of ApiResponse (Inbox)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Inbox>> UpdateInboxAsyncWithHttpInfo (Guid inboxId, UpdateInboxOptions updateInboxOptions)
        {
            // verify the required parameter 'inboxId' is set
            if (inboxId == null)
                throw new ApiException(400, "Missing required parameter 'inboxId' when calling InboxControllerApi->UpdateInbox");

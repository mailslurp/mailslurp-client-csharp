...
namespace mailslurp.Api
{
    ...
    public partial class InboxControllerApi : IInboxControllerApi
    {
        ...
        public mailslurp.Client.ApiResponse< Inbox > CreateInboxWithHttpInfo (string description = default(string), string emailAddress = default(string), DateTime? expiresAt = default(DateTime?), bool? favourite = default(bool?), string name = default(string), List<string> tags = default(List<string>))
        {
            ...
            if (description != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "description", description))
                {
            ...
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "emailAddress", emailAddress))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            if (expiresAt != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "expiresAt", expiresAt))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            if (favourite != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "favourite", favourite))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            if (name != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "name", name))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            if (tags != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("multi", "tags", tags))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
        ...
        public mailslurp.Client.ApiResponse< PageInboxProjection > GetAllInboxesWithHttpInfo (bool? favourite = default(bool?), int? page = default(int?), string search = default(string), int? size = default(int?), string sort = default(string), string tag = default(string))
        {
            ...
            if (search != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "search", search))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            if (tag != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "tag", tag))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
        ...
        public mailslurp.Client.ApiResponse< List<EmailPreview> > GetEmailsWithHttpInfo (Guid inboxId, int? limit = default(int?), long? minCount = default(long?), long? retryTimeout = default(long?), DateTime? since = default(DateTime?), string sort = default(string))
        {
            ...
            if (limit != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "limit", limit))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            if (minCount != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "minCount", minCount))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "retryTimeout", retryTimeout))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
            ...
            if (since != null)
            {
                foreach (var _kvp in mailslurp.Client.ClientUtils.ParameterToMultiMap("", "since", since))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);

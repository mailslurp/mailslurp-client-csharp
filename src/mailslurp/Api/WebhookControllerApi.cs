...
namespace mailslurp.Api
{
    ...
    public partial class WebhookControllerApi : IWebhookControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<PageWebhookProjection> localVarResponse = await GetAllWebhooksWithHttpInfoAsync(page, size, sort, searchFilter, since, before, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

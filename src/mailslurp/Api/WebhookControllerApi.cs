...
namespace mailslurp.Api
{
    ...
    public interface IWebhookControllerApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>WebhookPayload</returns>
        ...
        /// </remarks>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of WebhookPayload</returns>
        ApiResponse<WebhookPayload> GetTestWebhookPayloadWithHttpInfo ();
        /// <summary>
    ...
    public interface IWebhookControllerApiAsync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of WebhookPayload</returns>
        System.Threading.Tasks.Task<WebhookPayload> GetTestWebhookPayloadAsync ();
        ...
        /// </remarks>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (WebhookPayload)</returns>
        System.Threading.Tasks.Task<ApiResponse<WebhookPayload>> GetTestWebhookPayloadAsyncWithHttpInfo ();
        /// <summary>
        /// Get a webhook for an Inbox
        /// </summary>
        /// <remarks>
    ...
    public partial class WebhookControllerApi : IWebhookControllerApi
    {
        ...
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>WebhookPayload</returns>
        public WebhookPayload GetTestWebhookPayload ()
        {
             mailslurp.Client.ApiResponse<WebhookPayload> localVarResponse = GetTestWebhookPayloadWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of WebhookPayload</returns>
        public mailslurp.Client.ApiResponse< WebhookPayload > GetTestWebhookPayloadWithHttpInfo ()
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get< WebhookPayload >("/webhooks/test", localVarRequestOptions, this.Configuration);
        ...
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of WebhookPayload</returns>
        public async System.Threading.Tasks.Task<WebhookPayload> GetTestWebhookPayloadAsync ()
        {
             mailslurp.Client.ApiResponse<WebhookPayload> localVarResponse = await GetTestWebhookPayloadAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (WebhookPayload)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<WebhookPayload>> GetTestWebhookPayloadAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<WebhookPayload>("/webhooks/test", localVarRequestOptions, this.Configuration);

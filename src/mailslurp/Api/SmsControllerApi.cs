...
namespace mailslurp.Api
{
    ...
    public partial class SmsControllerApi : ISmsControllerApi
    {
        ...
        /// <param name="smsId"></param>
        /// <returns>ApiResponse of SmsDto</returns>
        public mailslurp.Client.ApiResponse<SmsDto> GetSmsMessageWithHttpInfo(Guid smsId)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
            mailslurp.Client.ApiResponse<SmsDto> localVarResponse = await GetSmsMessageWithHttpInfoAsync(smsId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SmsDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<SmsDto>> GetSmsMessageWithHttpInfoAsync(Guid smsId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {

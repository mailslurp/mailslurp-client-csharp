...
namespace mailslurp.Api
{
    ...
    public partial class MailServerControllerApi : IMailServerControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<DescribeMailServerDomainResult> localVarResponse = await DescribeMailServerDomainWithHttpInfoAsync(describeDomainOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DescribeMailServerDomainResult)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<DescribeMailServerDomainResult>> DescribeMailServerDomainWithHttpInfoAsync(DescribeDomainOptions describeDomainOptions, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'describeDomainOptions' is set
            if (describeDomainOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'describeDomainOptions' when calling MailServerControllerApi->DescribeMailServerDomain");
        ...
        {
            mailslurp.Client.ApiResponse<DNSLookupResults> localVarResponse = await GetDnsLookupWithHttpInfoAsync(dNSLookupOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DNSLookupResults)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<DNSLookupResults>> GetDnsLookupWithHttpInfoAsync(DNSLookupOptions dNSLookupOptions, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'dNSLookupOptions' is set
            if (dNSLookupOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'dNSLookupOptions' when calling MailServerControllerApi->GetDnsLookup");
        ...
        {
            mailslurp.Client.ApiResponse<IPAddressResult> localVarResponse = await GetIpAddressWithHttpInfoAsync(name, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (IPAddressResult)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<IPAddressResult>> GetIpAddressWithHttpInfoAsync(string name, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'name' when calling MailServerControllerApi->GetIpAddress");
        ...
        {
            mailslurp.Client.ApiResponse<EmailVerificationResult> localVarResponse = await VerifyEmailAddressWithHttpInfoAsync(verifyEmailAddressOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EmailVerificationResult)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<EmailVerificationResult>> VerifyEmailAddressWithHttpInfoAsync(VerifyEmailAddressOptions verifyEmailAddressOptions, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'verifyEmailAddressOptions' is set
            if (verifyEmailAddressOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'verifyEmailAddressOptions' when calling MailServerControllerApi->VerifyEmailAddress");

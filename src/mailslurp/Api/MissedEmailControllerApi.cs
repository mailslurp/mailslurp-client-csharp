...
namespace mailslurp.Api
{
    ...
    public partial class MissedEmailControllerApi : IMissedEmailControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<MissedEmail> localVarResponse = await GetMissedEmailWithHttpInfoAsync(missedEmailId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MissedEmail)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<MissedEmail>> GetMissedEmailWithHttpInfoAsync(Guid missedEmailId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            mailslurp.Client.ApiResponse<MissedEmail> localVarResponse = await WaitForNthMissedEmailWithHttpInfoAsync(index, inboxId, timeout, since, before, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MissedEmail)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<MissedEmail>> WaitForNthMissedEmailWithHttpInfoAsync(int index, Guid? inboxId = default(Guid?), long? timeout = default(long?), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {

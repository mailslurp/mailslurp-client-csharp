...
namespace mailslurp.Api
{
    ...
    public partial class MissedEmailControllerApi : IMissedEmailControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<PageMissedEmailProjection> localVarResponse = await GetAllMissedEmailsWithHttpInfoAsync(page, size, sort, searchFilter, since, before, inboxId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<PageUnknownMissedEmailProjection> localVarResponse = await GetAllUnknownMissedEmailsWithHttpInfoAsync(page, size, sort, searchFilter, since, before, inboxId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="missedEmailId"></param>
        /// <returns>ApiResponse of MissedEmailDto</returns>
        public mailslurp.Client.ApiResponse<MissedEmailDto> GetMissedEmailWithHttpInfo(Guid missedEmailId)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
            mailslurp.Client.ApiResponse<MissedEmailDto> localVarResponse = await GetMissedEmailWithHttpInfoAsync(missedEmailId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MissedEmailDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<MissedEmailDto>> GetMissedEmailWithHttpInfoAsync(Guid missedEmailId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<Object>> RestoreMissedEmailsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="before">Filter by created at before the given timestamp (optional)</param>
        /// <returns>ApiResponse of MissedEmailDto</returns>
        public mailslurp.Client.ApiResponse<MissedEmailDto> WaitForNthMissedEmailWithHttpInfo(int index, Guid? inboxId = default(Guid?), long? timeout = default(long?), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
            mailslurp.Client.ApiResponse<MissedEmailDto> localVarResponse = await WaitForNthMissedEmailWithHttpInfoAsync(index, inboxId, timeout, since, before, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

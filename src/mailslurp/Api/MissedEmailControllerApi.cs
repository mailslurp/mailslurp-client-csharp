...
namespace mailslurp.Api
{
    ...
    public interface IMissedEmailControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageMissedEmailProjection> GetAllMissedEmailsAsync (int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<PageMissedEmailProjection>> GetAllMissedEmailsAsyncWithHttpInfo (int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string));
        /// <summary>
        /// Get MissedEmail
        /// </summary>
        /// <remarks>
    ...
    public partial class MissedEmailControllerApi : IMissedEmailControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<PageMissedEmailProjection> localVarResponse = GetAllMissedEmailsWithHttpInfo(page, searchFilter, size, sort);
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageMissedEmailProjection</returns>
        public mailslurp.Client.ApiResponse< PageMissedEmailProjection > GetAllMissedEmailsWithHttpInfo (int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of PageMissedEmailProjection</returns>
        public async System.Threading.Tasks.Task<PageMissedEmailProjection> GetAllMissedEmailsAsync (int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {
             mailslurp.Client.ApiResponse<PageMissedEmailProjection> localVarResponse = await GetAllMissedEmailsAsyncWithHttpInfo(page, searchFilter, size, sort);
             return localVarResponse.Data;
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of ApiResponse (PageMissedEmailProjection)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<PageMissedEmailProjection>> GetAllMissedEmailsAsyncWithHttpInfo (int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {

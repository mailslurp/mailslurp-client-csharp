...
namespace mailslurp.Api
{
    ...
    public partial class InboxForwarderControllerApi : IInboxForwarderControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<PageInboxForwarderEvents> localVarResponse = GetAllInboxForwarderEventsWithHttpInfo(page, size, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PageInboxForwarderEvents</returns>
        public mailslurp.Client.ApiResponse<PageInboxForwarderEvents> GetAllInboxForwarderEventsWithHttpInfo(int? page = default(int?), int? size = default(int?), string sort = default(string), int operationIndex = 0)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
            mailslurp.Client.ApiResponse<PageInboxForwarderEvents> localVarResponse = await GetAllInboxForwarderEventsWithHttpInfoAsync(page, size, sort, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PageInboxForwarderEvents)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<PageInboxForwarderEvents>> GetAllInboxForwarderEventsWithHttpInfoAsync(int? page = default(int?), int? size = default(int?), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {

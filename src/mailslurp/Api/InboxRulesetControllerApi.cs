...
namespace mailslurp.Api
{
    ...
    public interface IInboxRulesetControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageInboxRulesetDto> GetInboxRulesetsAsync (DateTime? before = default(DateTime?), Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<PageInboxRulesetDto>> GetInboxRulesetsAsyncWithHttpInfo (DateTime? before = default(DateTime?), Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string));
        /// <summary>
        /// Test an inbox ruleset
        /// </summary>
        /// <remarks>
    ...
    public partial class InboxRulesetControllerApi : IInboxRulesetControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<PageInboxRulesetDto> localVarResponse = GetInboxRulesetsWithHttpInfo(before, inboxId, page, searchFilter, since, size, sort);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageInboxRulesetDto</returns>
        public mailslurp.Client.ApiResponse< PageInboxRulesetDto > GetInboxRulesetsWithHttpInfo (DateTime? before = default(DateTime?), Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of PageInboxRulesetDto</returns>
        public async System.Threading.Tasks.Task<PageInboxRulesetDto> GetInboxRulesetsAsync (DateTime? before = default(DateTime?), Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string))
        {
             mailslurp.Client.ApiResponse<PageInboxRulesetDto> localVarResponse = await GetInboxRulesetsAsyncWithHttpInfo(before, inboxId, page, searchFilter, since, size, sort);
             return localVarResponse.Data;

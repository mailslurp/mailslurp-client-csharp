...
namespace mailslurp.Api
{
    ...
    public interface IAIControllerApiSync : IApiAccessor
    {
        ...
        StructuredContentResult GenerateStructuredContentFromAttachment(GenerateStructuredContentAttachmentOptions generateStructuredContentAttachmentOptions, int operationIndex = 0);
        ...
        ApiResponse<StructuredContentResult> GenerateStructuredContentFromAttachmentWithHttpInfo(GenerateStructuredContentAttachmentOptions generateStructuredContentAttachmentOptions, int operationIndex = 0);
        /// <summary>
    ...
    public interface IAIControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<StructuredContentResult> GenerateStructuredContentFromAttachmentAsync(GenerateStructuredContentAttachmentOptions generateStructuredContentAttachmentOptions, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<StructuredContentResult>> GenerateStructuredContentFromAttachmentWithHttpInfoAsync(GenerateStructuredContentAttachmentOptions generateStructuredContentAttachmentOptions, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Generate structured content for an email
        /// </summary>
        /// <remarks>
    ...
    public partial class AIControllerApi : IAIControllerApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>StructuredContentResult</returns>
        public StructuredContentResult GenerateStructuredContentFromAttachment(GenerateStructuredContentAttachmentOptions generateStructuredContentAttachmentOptions, int operationIndex = 0)
        {
            mailslurp.Client.ApiResponse<StructuredContentResult> localVarResponse = GenerateStructuredContentFromAttachmentWithHttpInfo(generateStructuredContentAttachmentOptions);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of StructuredContentResult</returns>
        public mailslurp.Client.ApiResponse<StructuredContentResult> GenerateStructuredContentFromAttachmentWithHttpInfo(GenerateStructuredContentAttachmentOptions generateStructuredContentAttachmentOptions, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<StructuredContentResult>("/ai/structured-content/attachment", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StructuredContentResult</returns>
        public async System.Threading.Tasks.Task<StructuredContentResult> GenerateStructuredContentFromAttachmentAsync(GenerateStructuredContentAttachmentOptions generateStructuredContentAttachmentOptions, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            mailslurp.Client.ApiResponse<StructuredContentResult> localVarResponse = await GenerateStructuredContentFromAttachmentWithHttpInfoAsync(generateStructuredContentAttachmentOptions, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (StructuredContentResult)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<StructuredContentResult>> GenerateStructuredContentFromAttachmentWithHttpInfoAsync(GenerateStructuredContentAttachmentOptions generateStructuredContentAttachmentOptions, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'generateStructuredContentAttachmentOptions' is set
            if (generateStructuredContentAttachmentOptions == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<StructuredContentResult>("/ai/structured-content/attachment", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

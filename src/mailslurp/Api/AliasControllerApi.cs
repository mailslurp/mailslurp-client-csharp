...
namespace mailslurp.Api
{
    ...
    public interface IAliasControllerApiSync : IApiAccessor
    {
        ...
        ApiResponse<SentEmailDto> ReplyToEmailWithHttpInfo (Guid aliasId, Guid emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions);
        /// <summary>
    ...
    public interface IAliasControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageEmailProjection> GetAliasEmailsAsync (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<PageEmailProjection>> GetAliasEmailsAsyncWithHttpInfo (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string));
        /// <summary>
        /// Get threads created for an alias
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PageThreadProjection> GetAliasThreadsAsync (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<PageThreadProjection>> GetAliasThreadsAsyncWithHttpInfo (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string));
        /// <summary>
        /// Get all email aliases you have created
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<SentEmailDto> ReplyToEmailAsync (Guid aliasId, Guid emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions);
        ...
        System.Threading.Tasks.Task<ApiResponse<SentEmailDto>> ReplyToEmailAsyncWithHttpInfo (Guid aliasId, Guid emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions);
        /// <summary>
        /// Send an email from an alias inbox
        /// </summary>
        /// <remarks>
    ...
    public partial class AliasControllerApi : IAliasControllerApi
    {
        ...
        {
             mailslurp.Client.ApiResponse<PageEmailProjection> localVarResponse = GetAliasEmailsWithHttpInfo(aliasId, page, size, sort);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageEmailProjection</returns>
        public mailslurp.Client.ApiResponse< PageEmailProjection > GetAliasEmailsWithHttpInfo (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of PageEmailProjection</returns>
        public async System.Threading.Tasks.Task<PageEmailProjection> GetAliasEmailsAsync (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
             mailslurp.Client.ApiResponse<PageEmailProjection> localVarResponse = await GetAliasEmailsAsyncWithHttpInfo(aliasId, page, size, sort);
             return localVarResponse.Data;
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of ApiResponse (PageEmailProjection)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<PageEmailProjection>> GetAliasEmailsAsyncWithHttpInfo (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
        ...
        {
             mailslurp.Client.ApiResponse<PageThreadProjection> localVarResponse = GetAliasThreadsWithHttpInfo(aliasId, page, size, sort);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageThreadProjection</returns>
        public mailslurp.Client.ApiResponse< PageThreadProjection > GetAliasThreadsWithHttpInfo (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of PageThreadProjection</returns>
        public async System.Threading.Tasks.Task<PageThreadProjection> GetAliasThreadsAsync (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
             mailslurp.Client.ApiResponse<PageThreadProjection> localVarResponse = await GetAliasThreadsAsyncWithHttpInfo(aliasId, page, size, sort);
             return localVarResponse.Data;
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>Task of ApiResponse (PageThreadProjection)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<PageThreadProjection>> GetAliasThreadsAsyncWithHttpInfo (Guid aliasId, int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
        ...
        /// <param name="replyToAliasEmailOptions">replyToAliasEmailOptions</param>
        /// <returns>SentEmailDto</returns>
        public SentEmailDto ReplyToEmail (Guid aliasId, Guid emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions)
        {
             mailslurp.Client.ApiResponse<SentEmailDto> localVarResponse = ReplyToEmailWithHttpInfo(aliasId, emailId, replyToAliasEmailOptions);
             return localVarResponse.Data;
        }
        ...
        /// <param name="replyToAliasEmailOptions">replyToAliasEmailOptions</param>
        /// <returns>ApiResponse of SentEmailDto</returns>
        public mailslurp.Client.ApiResponse< SentEmailDto > ReplyToEmailWithHttpInfo (Guid aliasId, Guid emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions)
        {
            // verify the required parameter 'replyToAliasEmailOptions' is set
            if (replyToAliasEmailOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'replyToAliasEmailOptions' when calling AliasControllerApi->ReplyToEmail");
        ...
        /// <param name="replyToAliasEmailOptions">replyToAliasEmailOptions</param>
        /// <returns>Task of SentEmailDto</returns>
        public async System.Threading.Tasks.Task<SentEmailDto> ReplyToEmailAsync (Guid aliasId, Guid emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions)
        {
             mailslurp.Client.ApiResponse<SentEmailDto> localVarResponse = await ReplyToEmailAsyncWithHttpInfo(aliasId, emailId, replyToAliasEmailOptions);
             return localVarResponse.Data;
        ...
        /// <param name="replyToAliasEmailOptions">replyToAliasEmailOptions</param>
        /// <returns>Task of ApiResponse (SentEmailDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<SentEmailDto>> ReplyToEmailAsyncWithHttpInfo (Guid aliasId, Guid emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions)
        {
            // verify the required parameter 'replyToAliasEmailOptions' is set
            if (replyToAliasEmailOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'replyToAliasEmailOptions' when calling AliasControllerApi->ReplyToEmail");
        ...
        /// <summary>
        /// Send an email from an alias inbox Send an email from an alias. Replies to the email will be forwared to the alias masked email address
        /// </summary>
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="aliasId">aliasId</param>
        /// <param name="sendEmailOptions">Options for the email to be sent (optional)</param>

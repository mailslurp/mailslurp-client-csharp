...
namespace mailslurp.Api
{
    ...
    public partial class FormControllerApi : IFormControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<string> localVarResponse = await SubmitFormWithHttpInfoAsync(to, subject, redirectTo, emailAddress, successMessage, spamCheck, otherParameters, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

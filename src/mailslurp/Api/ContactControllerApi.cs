...
namespace mailslurp.Api
{
    ...
    public partial class ContactControllerApi : IContactControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<ContactDto> localVarResponse = await CreateContactWithHttpInfoAsync(createContactOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ContactDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<ContactDto>> CreateContactWithHttpInfoAsync(CreateContactOptions createContactOptions, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createContactOptions' is set
            if (createContactOptions == null)
                throw new mailslurp.Client.ApiException(400, "Missing required parameter 'createContactOptions' when calling ContactControllerApi->CreateContact");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<Object>> DeleteContactWithHttpInfoAsync(Guid contactId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            mailslurp.Client.ApiResponse<PageContactProjection> localVarResponse = GetAllContactsWithHttpInfo(page, size, sort, since, before);
            return localVarResponse.Data;
        }
        ...
        /// <param name="before">Filter by created at before the given timestamp (optional)</param>
        /// <returns>ApiResponse of PageContactProjection</returns>
        public mailslurp.Client.ApiResponse<PageContactProjection> GetAllContactsWithHttpInfo(int? page = default(int?), int? size = default(int?), string sort = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?))
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
            mailslurp.Client.ApiResponse<PageContactProjection> localVarResponse = await GetAllContactsWithHttpInfoAsync(page, size, sort, since, before, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<ContactDto> localVarResponse = await GetContactWithHttpInfoAsync(contactId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ContactDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<ContactDto>> GetContactWithHttpInfoAsync(Guid contactId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = GetContactVCardWithHttpInfo(contactId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="contactId"></param>
        /// <returns>ApiResponse of List&lt;byte[]&gt;</returns>
        public mailslurp.Client.ApiResponse<List<byte[]>> GetContactVCardWithHttpInfo(Guid contactId)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        {
            mailslurp.Client.ApiResponse<List<byte[]>> localVarResponse = await GetContactVCardWithHttpInfoAsync(contactId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;byte[]&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<byte[]>>> GetContactVCardWithHttpInfoAsync(Guid contactId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            mailslurp.Client.ApiResponse<List<ContactProjection>> localVarResponse = await GetContactsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ContactProjection&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<List<ContactProjection>>> GetContactsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {

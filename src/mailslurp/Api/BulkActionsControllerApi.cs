...
namespace mailslurp.Api
{
    ...
    public interface IBulkActionsControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<InboxDto>> BulkCreateInboxesAsync (int count);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<InboxDto>>> BulkCreateInboxesAsyncWithHttpInfo (int count);
        /// <summary>
        /// Bulk Delete Inboxes
        /// </summary>
        /// <remarks>
    ...
    public partial class BulkActionsControllerApi : IBulkActionsControllerApi
    {
        ...
        /// <param name="count">Number of inboxes to be created in bulk</param>
        /// <returns>Task of List&lt;InboxDto&gt;</returns>
        public async System.Threading.Tasks.Task<List<InboxDto>> BulkCreateInboxesAsync (int count)
        {
             mailslurp.Client.ApiResponse<List<InboxDto>> localVarResponse = await BulkCreateInboxesAsyncWithHttpInfo(count);
             return localVarResponse.Data;

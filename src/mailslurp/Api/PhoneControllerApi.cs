...
namespace mailslurp.Api
{
    ...
    public partial class PhoneControllerApi : IPhoneControllerApi
    {
        ...
        {
            mailslurp.Client.ApiResponse<PagePhoneNumberProjection> localVarResponse = GetPhoneNumbersWithHttpInfo(phoneCountry, lineType, carrierName, mobileCountryCode, mobileNetworkCode, providerLabel, page, size, sort, since, before, search, include, favourite);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp.Client.ApiResponse<PagePhoneNumberProjection> localVarResponse = await GetPhoneNumbersWithHttpInfoAsync(phoneCountry, lineType, carrierName, mobileCountryCode, mobileNetworkCode, providerLabel, page, size, sort, since, before, search, include, favourite, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

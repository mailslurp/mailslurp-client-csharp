...
namespace mailslurp.Api
{
    ...
    public interface IMFAControllerApiSync : IApiAccessor
    {
        ...
        /// <exception cref="mailslurp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id"></param>
        /// <param name="at"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TotpDeviceCodeDto</returns>
        TotpDeviceCodeDto GetTotpDeviceCode(Guid id, DateTime? at = default, int operationIndex = 0);
        ...
        ApiResponse<TotpDeviceCodeDto> GetTotpDeviceCodeWithHttpInfo(Guid id, DateTime? at = default, int operationIndex = 0);
    ...
    public interface IMFAControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TotpDeviceCodeDto> GetTotpDeviceCodeAsync(Guid id, DateTime? at = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<TotpDeviceCodeDto>> GetTotpDeviceCodeWithHttpInfoAsync(Guid id, DateTime? at = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class MFAControllerApi : IMFAControllerApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TotpDeviceCodeDto</returns>
        public TotpDeviceCodeDto GetTotpDeviceCode(Guid id, DateTime? at = default, int operationIndex = 0)
        {
            mailslurp.Client.ApiResponse<TotpDeviceCodeDto> localVarResponse = GetTotpDeviceCodeWithHttpInfo(id, at);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TotpDeviceCodeDto</returns>
        public mailslurp.Client.ApiResponse<TotpDeviceCodeDto> GetTotpDeviceCodeWithHttpInfo(Guid id, DateTime? at = default, int operationIndex = 0)
        {
            mailslurp.Client.RequestOptions localVarRequestOptions = new mailslurp.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TotpDeviceCodeDto</returns>
        public async System.Threading.Tasks.Task<TotpDeviceCodeDto> GetTotpDeviceCodeAsync(Guid id, DateTime? at = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            mailslurp.Client.ApiResponse<TotpDeviceCodeDto> localVarResponse = await GetTotpDeviceCodeWithHttpInfoAsync(id, at, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TotpDeviceCodeDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp.Client.ApiResponse<TotpDeviceCodeDto>> GetTotpDeviceCodeWithHttpInfoAsync(Guid id, DateTime? at = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {

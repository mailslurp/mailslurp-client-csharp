...
${nuget_cmd} install src/mailslurp/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/mailslurp.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/mailslurp.dll \
-recurse:'src/mailslurp/*.cs' \
-doc:bin/mailslurp.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/mailslurp.dll was created successfully"
fi

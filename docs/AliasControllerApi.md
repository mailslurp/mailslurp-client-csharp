...
# **ReplyToEmail**
> SentEmailDto ReplyToEmail (Guid aliasId, Guid emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions)
...
namespace Example
{
    public class ReplyToEmailExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AliasControllerApi.ReplyToEmail: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **aliasId** | [**Guid**](Guid.md)| ID of the alias that email belongs to | 

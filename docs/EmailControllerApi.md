...
# **ReplyToEmail1**
> SentEmailDto ReplyToEmail1 (Guid emailId, ReplyToEmailOptions replyToEmailOptions)
...
namespace Example
{
    public class ReplyToEmail1Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling EmailControllerApi.ReplyToEmail1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
